...
pub trait DataBrewClient {
    fn batch_delete_recipe_version(&self, builder: BatchDeleteRecipeVersionInputBuilder) -> impl Future<Output = Result<BatchDeleteRecipeVersionOutput, SdkError<BatchDeleteRecipeVersionError>>> + Send;
    ...
    fn create_profile_job(&self, builder: CreateProfileJobInputBuilder) -> impl Future<Output = Result<CreateProfileJobOutput, SdkError<CreateProfileJobError>>> + Send;
    ...
    fn create_recipe(&self, builder: CreateRecipeInputBuilder) -> impl Future<Output = Result<CreateRecipeOutput, SdkError<CreateRecipeError>>> + Send;
    fn create_recipe_job(&self, builder: CreateRecipeJobInputBuilder) -> impl Future<Output = Result<CreateRecipeJobOutput, SdkError<CreateRecipeJobError>>> + Send;
    fn create_ruleset(&self, builder: CreateRulesetInputBuilder) -> impl Future<Output = Result<CreateRulesetOutput, SdkError<CreateRulesetError>>> + Send;
    fn create_schedule(&self, builder: CreateScheduleInputBuilder) -> impl Future<Output = Result<CreateScheduleOutput, SdkError<CreateScheduleError>>> + Send;
    ...
    fn delete_recipe_version(&self, builder: DeleteRecipeVersionInputBuilder) -> impl Future<Output = Result<DeleteRecipeVersionOutput, SdkError<DeleteRecipeVersionError>>> + Send;
    fn delete_ruleset(&self, builder: DeleteRulesetInputBuilder) -> impl Future<Output = Result<DeleteRulesetOutput, SdkError<DeleteRulesetError>>> + Send;
    fn delete_schedule(&self, builder: DeleteScheduleInputBuilder) -> impl Future<Output = Result<DeleteScheduleOutput, SdkError<DeleteScheduleError>>> + Send;
    ...
    fn describe_job(&self, builder: DescribeJobInputBuilder) -> impl Future<Output = Result<DescribeJobOutput, SdkError<DescribeJobError>>> + Send;
    fn describe_job_run(&self, builder: DescribeJobRunInputBuilder) -> impl Future<Output = Result<DescribeJobRunOutput, SdkError<DescribeJobRunError>>> + Send;
    ...
    fn describe_recipe(&self, builder: DescribeRecipeInputBuilder) -> impl Future<Output = Result<DescribeRecipeOutput, SdkError<DescribeRecipeError>>> + Send;
    fn describe_ruleset(&self, builder: DescribeRulesetInputBuilder) -> impl Future<Output = Result<DescribeRulesetOutput, SdkError<DescribeRulesetError>>> + Send;
    fn describe_schedule(&self, builder: DescribeScheduleInputBuilder) -> impl Future<Output = Result<DescribeScheduleOutput, SdkError<DescribeScheduleError>>> + Send;
    fn list_datasets(&self, builder: ListDatasetsInputBuilder) -> impl Future<Output = Result<ListDatasetsOutput, SdkError<ListDatasetsError>>> + Send;
    fn list_job_runs(&self, builder: ListJobRunsInputBuilder) -> impl Future<Output = Result<ListJobRunsOutput, SdkError<ListJobRunsError>>> + Send;
    ...
    fn list_recipe_versions(&self, builder: ListRecipeVersionsInputBuilder) -> impl Future<Output = Result<ListRecipeVersionsOutput, SdkError<ListRecipeVersionsError>>> + Send;
    fn list_recipes(&self, builder: ListRecipesInputBuilder) -> impl Future<Output = Result<ListRecipesOutput, SdkError<ListRecipesError>>> + Send;
    fn list_rulesets(&self, builder: ListRulesetsInputBuilder) -> impl Future<Output = Result<ListRulesetsOutput, SdkError<ListRulesetsError>>> + Send;
    fn list_schedules(&self, builder: ListSchedulesInputBuilder) -> impl Future<Output = Result<ListSchedulesOutput, SdkError<ListSchedulesError>>> + Send;
    ...
    fn publish_recipe(&self, builder: PublishRecipeInputBuilder) -> impl Future<Output = Result<PublishRecipeOutput, SdkError<PublishRecipeError>>> + Send;
    fn send_project_session_action(&self, builder: SendProjectSessionActionInputBuilder) -> impl Future<Output = Result<SendProjectSessionActionOutput, SdkError<SendProjectSessionActionError>>> + Send;
    ...
    fn start_project_session(&self, builder: StartProjectSessionInputBuilder) -> impl Future<Output = Result<StartProjectSessionOutput, SdkError<StartProjectSessionError>>> + Send;
    fn stop_job_run(&self, builder: StopJobRunInputBuilder) -> impl Future<Output = Result<StopJobRunOutput, SdkError<StopJobRunError>>> + Send;
    ...
    fn update_dataset(&self, builder: UpdateDatasetInputBuilder) -> impl Future<Output = Result<UpdateDatasetOutput, SdkError<UpdateDatasetError>>> + Send;
    fn update_profile_job(&self, builder: UpdateProfileJobInputBuilder) -> impl Future<Output = Result<UpdateProfileJobOutput, SdkError<UpdateProfileJobError>>> + Send;
    ...
    fn update_recipe(&self, builder: UpdateRecipeInputBuilder) -> impl Future<Output = Result<UpdateRecipeOutput, SdkError<UpdateRecipeError>>> + Send;
    fn update_recipe_job(&self, builder: UpdateRecipeJobInputBuilder) -> impl Future<Output = Result<UpdateRecipeJobOutput, SdkError<UpdateRecipeJobError>>> + Send;
    fn update_ruleset(&self, builder: UpdateRulesetInputBuilder) -> impl Future<Output = Result<UpdateRulesetOutput, SdkError<UpdateRulesetError>>> + Send;
    fn update_schedule(&self, builder: UpdateScheduleInputBuilder) -> impl Future<Output = Result<UpdateScheduleOutput, SdkError<UpdateScheduleError>>> + Send;
}

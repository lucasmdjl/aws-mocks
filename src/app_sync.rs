...
pub trait AppSyncClient {
    fn associate_api(&self, builder: AssociateApiInputBuilder) -> impl Future<Output = Result<AssociateApiOutput, SdkError<AssociateApiError>>> + Send;
    fn associate_merged_graphql_api(&self, builder: AssociateMergedGraphqlApiInputBuilder) -> impl Future<Output = Result<AssociateMergedGraphqlApiOutput, SdkError<AssociateMergedGraphqlApiError>>> + Send;
    fn associate_source_graphql_api(&self, builder: AssociateSourceGraphqlApiInputBuilder) -> impl Future<Output = Result<AssociateSourceGraphqlApiOutput, SdkError<AssociateSourceGraphqlApiError>>> + Send;
    fn create_api_cache(&self, builder: CreateApiCacheInputBuilder) -> impl Future<Output = Result<CreateApiCacheOutput, SdkError<CreateApiCacheError>>> + Send;
    ...
    fn create_graphql_api(&self, builder: CreateGraphqlApiInputBuilder) -> impl Future<Output = Result<CreateGraphqlApiOutput, SdkError<CreateGraphqlApiError>>> + Send;
    fn create_resolver(&self, builder: CreateResolverInputBuilder) -> impl Future<Output = Result<CreateResolverOutput, SdkError<CreateResolverError>>> + Send;
    fn create_type(&self, builder: CreateTypeInputBuilder) -> impl Future<Output = Result<CreateTypeOutput, SdkError<CreateTypeError>>> + Send;
    fn delete_api_cache(&self, builder: DeleteApiCacheInputBuilder) -> impl Future<Output = Result<DeleteApiCacheOutput, SdkError<DeleteApiCacheError>>> + Send;
    ...
    fn delete_graphql_api(&self, builder: DeleteGraphqlApiInputBuilder) -> impl Future<Output = Result<DeleteGraphqlApiOutput, SdkError<DeleteGraphqlApiError>>> + Send;
    fn delete_resolver(&self, builder: DeleteResolverInputBuilder) -> impl Future<Output = Result<DeleteResolverOutput, SdkError<DeleteResolverError>>> + Send;
    fn delete_type(&self, builder: DeleteTypeInputBuilder) -> impl Future<Output = Result<DeleteTypeOutput, SdkError<DeleteTypeError>>> + Send;
    fn disassociate_api(&self, builder: DisassociateApiInputBuilder) -> impl Future<Output = Result<DisassociateApiOutput, SdkError<DisassociateApiError>>> + Send;
    fn disassociate_merged_graphql_api(&self, builder: DisassociateMergedGraphqlApiInputBuilder) -> impl Future<Output = Result<DisassociateMergedGraphqlApiOutput, SdkError<DisassociateMergedGraphqlApiError>>> + Send;
    fn disassociate_source_graphql_api(&self, builder: DisassociateSourceGraphqlApiInputBuilder) -> impl Future<Output = Result<DisassociateSourceGraphqlApiOutput, SdkError<DisassociateSourceGraphqlApiError>>> + Send;
    fn evaluate_code(&self, builder: EvaluateCodeInputBuilder) -> impl Future<Output = Result<EvaluateCodeOutput, SdkError<EvaluateCodeError>>> + Send;
    fn evaluate_mapping_template(&self, builder: EvaluateMappingTemplateInputBuilder) -> impl Future<Output = Result<EvaluateMappingTemplateOutput, SdkError<EvaluateMappingTemplateError>>> + Send;
    fn flush_api_cache(&self, builder: FlushApiCacheInputBuilder) -> impl Future<Output = Result<FlushApiCacheOutput, SdkError<FlushApiCacheError>>> + Send;
    fn get_api_association(&self, builder: GetApiAssociationInputBuilder) -> impl Future<Output = Result<GetApiAssociationOutput, SdkError<GetApiAssociationError>>> + Send;
    fn get_api_cache(&self, builder: GetApiCacheInputBuilder) -> impl Future<Output = Result<GetApiCacheOutput, SdkError<GetApiCacheError>>> + Send;
    ...
    fn get_data_source_introspection(&self, builder: GetDataSourceIntrospectionInputBuilder) -> impl Future<Output = Result<GetDataSourceIntrospectionOutput, SdkError<GetDataSourceIntrospectionError>>> + Send;
    ...
    fn get_graphql_api(&self, builder: GetGraphqlApiInputBuilder) -> impl Future<Output = Result<GetGraphqlApiOutput, SdkError<GetGraphqlApiError>>> + Send;
    fn get_graphql_api_environment_variables(&self, builder: GetGraphqlApiEnvironmentVariablesInputBuilder) -> impl Future<Output = Result<GetGraphqlApiEnvironmentVariablesOutput, SdkError<GetGraphqlApiEnvironmentVariablesError>>> + Send;
    fn get_introspection_schema(&self, builder: GetIntrospectionSchemaInputBuilder) -> impl Future<Output = Result<GetIntrospectionSchemaOutput, SdkError<GetIntrospectionSchemaError>>> + Send;
    fn get_resolver(&self, builder: GetResolverInputBuilder) -> impl Future<Output = Result<GetResolverOutput, SdkError<GetResolverError>>> + Send;
    fn get_schema_creation_status(&self, builder: GetSchemaCreationStatusInputBuilder) -> impl Future<Output = Result<GetSchemaCreationStatusOutput, SdkError<GetSchemaCreationStatusError>>> + Send;
    fn get_source_api_association(&self, builder: GetSourceApiAssociationInputBuilder) -> impl Future<Output = Result<GetSourceApiAssociationOutput, SdkError<GetSourceApiAssociationError>>> + Send;
    fn get_type(&self, builder: GetTypeInputBuilder) -> impl Future<Output = Result<GetTypeOutput, SdkError<GetTypeError>>> + Send;
    fn list_api_keys(&self, builder: ListApiKeysInputBuilder) -> impl Future<Output = Result<ListApiKeysOutput, SdkError<ListApiKeysError>>> + Send;
    ...
    fn list_graphql_apis(&self, builder: ListGraphqlApisInputBuilder) -> impl Future<Output = Result<ListGraphqlApisOutput, SdkError<ListGraphqlApisError>>> + Send;
    fn list_resolvers(&self, builder: ListResolversInputBuilder) -> impl Future<Output = Result<ListResolversOutput, SdkError<ListResolversError>>> + Send;
    fn list_resolvers_by_function(&self, builder: ListResolversByFunctionInputBuilder) -> impl Future<Output = Result<ListResolversByFunctionOutput, SdkError<ListResolversByFunctionError>>> + Send;
    fn list_source_api_associations(&self, builder: ListSourceApiAssociationsInputBuilder) -> impl Future<Output = Result<ListSourceApiAssociationsOutput, SdkError<ListSourceApiAssociationsError>>> + Send;
    ...
    fn list_types_by_association(&self, builder: ListTypesByAssociationInputBuilder) -> impl Future<Output = Result<ListTypesByAssociationOutput, SdkError<ListTypesByAssociationError>>> + Send;
    fn put_graphql_api_environment_variables(&self, builder: PutGraphqlApiEnvironmentVariablesInputBuilder) -> impl Future<Output = Result<PutGraphqlApiEnvironmentVariablesOutput, SdkError<PutGraphqlApiEnvironmentVariablesError>>> + Send;
    fn start_data_source_introspection(&self, builder: StartDataSourceIntrospectionInputBuilder) -> impl Future<Output = Result<StartDataSourceIntrospectionOutput, SdkError<StartDataSourceIntrospectionError>>> + Send;
    fn start_schema_creation(&self, builder: StartSchemaCreationInputBuilder) -> impl Future<Output = Result<StartSchemaCreationOutput, SdkError<StartSchemaCreationError>>> + Send;
    fn start_schema_merge(&self, builder: StartSchemaMergeInputBuilder) -> impl Future<Output = Result<StartSchemaMergeOutput, SdkError<StartSchemaMergeError>>> + Send;
    ...
    fn update_api_cache(&self, builder: UpdateApiCacheInputBuilder) -> impl Future<Output = Result<UpdateApiCacheOutput, SdkError<UpdateApiCacheError>>> + Send;
    ...
    fn update_graphql_api(&self, builder: UpdateGraphqlApiInputBuilder) -> impl Future<Output = Result<UpdateGraphqlApiOutput, SdkError<UpdateGraphqlApiError>>> + Send;
    fn update_resolver(&self, builder: UpdateResolverInputBuilder) -> impl Future<Output = Result<UpdateResolverOutput, SdkError<UpdateResolverError>>> + Send;
    fn update_source_api_association(&self, builder: UpdateSourceApiAssociationInputBuilder) -> impl Future<Output = Result<UpdateSourceApiAssociationOutput, SdkError<UpdateSourceApiAssociationError>>> + Send;
    fn update_type(&self, builder: UpdateTypeInputBuilder) -> impl Future<Output = Result<UpdateTypeOutput, SdkError<UpdateTypeError>>> + Send;
}

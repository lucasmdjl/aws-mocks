...
pub trait AppMeshClient {
    fn create_gateway_route(&self, builder: CreateGatewayRouteInputBuilder) -> impl Future<Output = Result<CreateGatewayRouteOutput, SdkError<CreateGatewayRouteError>>> + Send;
    fn create_mesh(&self, builder: CreateMeshInputBuilder) -> impl Future<Output = Result<CreateMeshOutput, SdkError<CreateMeshError>>> + Send;
    ...
    fn create_virtual_gateway(&self, builder: CreateVirtualGatewayInputBuilder) -> impl Future<Output = Result<CreateVirtualGatewayOutput, SdkError<CreateVirtualGatewayError>>> + Send;
    fn create_virtual_node(&self, builder: CreateVirtualNodeInputBuilder) -> impl Future<Output = Result<CreateVirtualNodeOutput, SdkError<CreateVirtualNodeError>>> + Send;
    fn create_virtual_router(&self, builder: CreateVirtualRouterInputBuilder) -> impl Future<Output = Result<CreateVirtualRouterOutput, SdkError<CreateVirtualRouterError>>> + Send;
    fn create_virtual_service(&self, builder: CreateVirtualServiceInputBuilder) -> impl Future<Output = Result<CreateVirtualServiceOutput, SdkError<CreateVirtualServiceError>>> + Send;
    fn delete_gateway_route(&self, builder: DeleteGatewayRouteInputBuilder) -> impl Future<Output = Result<DeleteGatewayRouteOutput, SdkError<DeleteGatewayRouteError>>> + Send;
    fn delete_mesh(&self, builder: DeleteMeshInputBuilder) -> impl Future<Output = Result<DeleteMeshOutput, SdkError<DeleteMeshError>>> + Send;
    ...
    fn delete_virtual_gateway(&self, builder: DeleteVirtualGatewayInputBuilder) -> impl Future<Output = Result<DeleteVirtualGatewayOutput, SdkError<DeleteVirtualGatewayError>>> + Send;
    fn delete_virtual_node(&self, builder: DeleteVirtualNodeInputBuilder) -> impl Future<Output = Result<DeleteVirtualNodeOutput, SdkError<DeleteVirtualNodeError>>> + Send;
    fn delete_virtual_router(&self, builder: DeleteVirtualRouterInputBuilder) -> impl Future<Output = Result<DeleteVirtualRouterOutput, SdkError<DeleteVirtualRouterError>>> + Send;
    fn delete_virtual_service(&self, builder: DeleteVirtualServiceInputBuilder) -> impl Future<Output = Result<DeleteVirtualServiceOutput, SdkError<DeleteVirtualServiceError>>> + Send;
    fn describe_gateway_route(&self, builder: DescribeGatewayRouteInputBuilder) -> impl Future<Output = Result<DescribeGatewayRouteOutput, SdkError<DescribeGatewayRouteError>>> + Send;
    fn describe_mesh(&self, builder: DescribeMeshInputBuilder) -> impl Future<Output = Result<DescribeMeshOutput, SdkError<DescribeMeshError>>> + Send;
    fn describe_route(&self, builder: DescribeRouteInputBuilder) -> impl Future<Output = Result<DescribeRouteOutput, SdkError<DescribeRouteError>>> + Send;
    fn describe_virtual_gateway(&self, builder: DescribeVirtualGatewayInputBuilder) -> impl Future<Output = Result<DescribeVirtualGatewayOutput, SdkError<DescribeVirtualGatewayError>>> + Send;
    fn describe_virtual_node(&self, builder: DescribeVirtualNodeInputBuilder) -> impl Future<Output = Result<DescribeVirtualNodeOutput, SdkError<DescribeVirtualNodeError>>> + Send;
    fn describe_virtual_router(&self, builder: DescribeVirtualRouterInputBuilder) -> impl Future<Output = Result<DescribeVirtualRouterOutput, SdkError<DescribeVirtualRouterError>>> + Send;
    fn describe_virtual_service(&self, builder: DescribeVirtualServiceInputBuilder) -> impl Future<Output = Result<DescribeVirtualServiceOutput, SdkError<DescribeVirtualServiceError>>> + Send;
    fn list_gateway_routes(&self, builder: ListGatewayRoutesInputBuilder) -> impl Future<Output = Result<ListGatewayRoutesOutput, SdkError<ListGatewayRoutesError>>> + Send;
    fn list_meshes(&self, builder: ListMeshesInputBuilder) -> impl Future<Output = Result<ListMeshesOutput, SdkError<ListMeshesError>>> + Send;
    fn list_routes(&self, builder: ListRoutesInputBuilder) -> impl Future<Output = Result<ListRoutesOutput, SdkError<ListRoutesError>>> + Send;
    ...
    fn list_virtual_gateways(&self, builder: ListVirtualGatewaysInputBuilder) -> impl Future<Output = Result<ListVirtualGatewaysOutput, SdkError<ListVirtualGatewaysError>>> + Send;
    fn list_virtual_nodes(&self, builder: ListVirtualNodesInputBuilder) -> impl Future<Output = Result<ListVirtualNodesOutput, SdkError<ListVirtualNodesError>>> + Send;
    fn list_virtual_routers(&self, builder: ListVirtualRoutersInputBuilder) -> impl Future<Output = Result<ListVirtualRoutersOutput, SdkError<ListVirtualRoutersError>>> + Send;
    fn list_virtual_services(&self, builder: ListVirtualServicesInputBuilder) -> impl Future<Output = Result<ListVirtualServicesOutput, SdkError<ListVirtualServicesError>>> + Send;
    ...
    fn update_gateway_route(&self, builder: UpdateGatewayRouteInputBuilder) -> impl Future<Output = Result<UpdateGatewayRouteOutput, SdkError<UpdateGatewayRouteError>>> + Send;
    fn update_mesh(&self, builder: UpdateMeshInputBuilder) -> impl Future<Output = Result<UpdateMeshOutput, SdkError<UpdateMeshError>>> + Send;
    ...
    fn update_virtual_gateway(&self, builder: UpdateVirtualGatewayInputBuilder) -> impl Future<Output = Result<UpdateVirtualGatewayOutput, SdkError<UpdateVirtualGatewayError>>> + Send;
    fn update_virtual_node(&self, builder: UpdateVirtualNodeInputBuilder) -> impl Future<Output = Result<UpdateVirtualNodeOutput, SdkError<UpdateVirtualNodeError>>> + Send;
    fn update_virtual_router(&self, builder: UpdateVirtualRouterInputBuilder) -> impl Future<Output = Result<UpdateVirtualRouterOutput, SdkError<UpdateVirtualRouterError>>> + Send;
    fn update_virtual_service(&self, builder: UpdateVirtualServiceInputBuilder) -> impl Future<Output = Result<UpdateVirtualServiceOutput, SdkError<UpdateVirtualServiceError>>> + Send;
}

...
pub trait CodeCommitClient {
    fn associate_approval_rule_template_with_repository(&self, builder: AssociateApprovalRuleTemplateWithRepositoryInputBuilder) -> impl Future<Output = Result<AssociateApprovalRuleTemplateWithRepositoryOutput, SdkError<AssociateApprovalRuleTemplateWithRepositoryError>>> + Send;
    fn batch_associate_approval_rule_template_with_repositories(&self, builder: BatchAssociateApprovalRuleTemplateWithRepositoriesInputBuilder) -> impl Future<Output = Result<BatchAssociateApprovalRuleTemplateWithRepositoriesOutput, SdkError<BatchAssociateApprovalRuleTemplateWithRepositoriesError>>> + Send;
    fn batch_describe_merge_conflicts(&self, builder: BatchDescribeMergeConflictsInputBuilder) -> impl Future<Output = Result<BatchDescribeMergeConflictsOutput, SdkError<BatchDescribeMergeConflictsError>>> + Send;
    fn batch_disassociate_approval_rule_template_from_repositories(&self, builder: BatchDisassociateApprovalRuleTemplateFromRepositoriesInputBuilder) -> impl Future<Output = Result<BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput, SdkError<BatchDisassociateApprovalRuleTemplateFromRepositoriesError>>> + Send;
    fn batch_get_commits(&self, builder: BatchGetCommitsInputBuilder) -> impl Future<Output = Result<BatchGetCommitsOutput, SdkError<BatchGetCommitsError>>> + Send;
    fn batch_get_repositories(&self, builder: BatchGetRepositoriesInputBuilder) -> impl Future<Output = Result<BatchGetRepositoriesOutput, SdkError<BatchGetRepositoriesError>>> + Send;
    fn create_approval_rule_template(&self, builder: CreateApprovalRuleTemplateInputBuilder) -> impl Future<Output = Result<CreateApprovalRuleTemplateOutput, SdkError<CreateApprovalRuleTemplateError>>> + Send;
    fn create_branch(&self, builder: CreateBranchInputBuilder) -> impl Future<Output = Result<CreateBranchOutput, SdkError<CreateBranchError>>> + Send;
    fn create_commit(&self, builder: CreateCommitInputBuilder) -> impl Future<Output = Result<CreateCommitOutput, SdkError<CreateCommitError>>> + Send;
    fn create_pull_request(&self, builder: CreatePullRequestInputBuilder) -> impl Future<Output = Result<CreatePullRequestOutput, SdkError<CreatePullRequestError>>> + Send;
    fn create_pull_request_approval_rule(&self, builder: CreatePullRequestApprovalRuleInputBuilder) -> impl Future<Output = Result<CreatePullRequestApprovalRuleOutput, SdkError<CreatePullRequestApprovalRuleError>>> + Send;
    fn create_repository(&self, builder: CreateRepositoryInputBuilder) -> impl Future<Output = Result<CreateRepositoryOutput, SdkError<CreateRepositoryError>>> + Send;
    fn create_unreferenced_merge_commit(&self, builder: CreateUnreferencedMergeCommitInputBuilder) -> impl Future<Output = Result<CreateUnreferencedMergeCommitOutput, SdkError<CreateUnreferencedMergeCommitError>>> + Send;
    fn delete_approval_rule_template(&self, builder: DeleteApprovalRuleTemplateInputBuilder) -> impl Future<Output = Result<DeleteApprovalRuleTemplateOutput, SdkError<DeleteApprovalRuleTemplateError>>> + Send;
    fn delete_branch(&self, builder: DeleteBranchInputBuilder) -> impl Future<Output = Result<DeleteBranchOutput, SdkError<DeleteBranchError>>> + Send;
    fn delete_comment_content(&self, builder: DeleteCommentContentInputBuilder) -> impl Future<Output = Result<DeleteCommentContentOutput, SdkError<DeleteCommentContentError>>> + Send;
    fn delete_file(&self, builder: DeleteFileInputBuilder) -> impl Future<Output = Result<DeleteFileOutput, SdkError<DeleteFileError>>> + Send;
    fn delete_pull_request_approval_rule(&self, builder: DeletePullRequestApprovalRuleInputBuilder) -> impl Future<Output = Result<DeletePullRequestApprovalRuleOutput, SdkError<DeletePullRequestApprovalRuleError>>> + Send;
    fn delete_repository(&self, builder: DeleteRepositoryInputBuilder) -> impl Future<Output = Result<DeleteRepositoryOutput, SdkError<DeleteRepositoryError>>> + Send;
    fn describe_merge_conflicts(&self, builder: DescribeMergeConflictsInputBuilder) -> impl Future<Output = Result<DescribeMergeConflictsOutput, SdkError<DescribeMergeConflictsError>>> + Send;
    fn describe_pull_request_events(&self, builder: DescribePullRequestEventsInputBuilder) -> impl Future<Output = Result<DescribePullRequestEventsOutput, SdkError<DescribePullRequestEventsError>>> + Send;
    fn disassociate_approval_rule_template_from_repository(&self, builder: DisassociateApprovalRuleTemplateFromRepositoryInputBuilder) -> impl Future<Output = Result<DisassociateApprovalRuleTemplateFromRepositoryOutput, SdkError<DisassociateApprovalRuleTemplateFromRepositoryError>>> + Send;
    fn evaluate_pull_request_approval_rules(&self, builder: EvaluatePullRequestApprovalRulesInputBuilder) -> impl Future<Output = Result<EvaluatePullRequestApprovalRulesOutput, SdkError<EvaluatePullRequestApprovalRulesError>>> + Send;
    fn get_approval_rule_template(&self, builder: GetApprovalRuleTemplateInputBuilder) -> impl Future<Output = Result<GetApprovalRuleTemplateOutput, SdkError<GetApprovalRuleTemplateError>>> + Send;
    fn get_blob(&self, builder: GetBlobInputBuilder) -> impl Future<Output = Result<GetBlobOutput, SdkError<GetBlobError>>> + Send;
    fn get_branch(&self, builder: GetBranchInputBuilder) -> impl Future<Output = Result<GetBranchOutput, SdkError<GetBranchError>>> + Send;
    fn get_comment(&self, builder: GetCommentInputBuilder) -> impl Future<Output = Result<GetCommentOutput, SdkError<GetCommentError>>> + Send;
    fn get_comment_reactions(&self, builder: GetCommentReactionsInputBuilder) -> impl Future<Output = Result<GetCommentReactionsOutput, SdkError<GetCommentReactionsError>>> + Send;
    fn get_comments_for_compared_commit(&self, builder: GetCommentsForComparedCommitInputBuilder) -> impl Future<Output = Result<GetCommentsForComparedCommitOutput, SdkError<GetCommentsForComparedCommitError>>> + Send;
    fn get_comments_for_pull_request(&self, builder: GetCommentsForPullRequestInputBuilder) -> impl Future<Output = Result<GetCommentsForPullRequestOutput, SdkError<GetCommentsForPullRequestError>>> + Send;
    fn get_commit(&self, builder: GetCommitInputBuilder) -> impl Future<Output = Result<GetCommitOutput, SdkError<GetCommitError>>> + Send;
    fn get_differences(&self, builder: GetDifferencesInputBuilder) -> impl Future<Output = Result<GetDifferencesOutput, SdkError<GetDifferencesError>>> + Send;
    fn get_file(&self, builder: GetFileInputBuilder) -> impl Future<Output = Result<GetFileOutput, SdkError<GetFileError>>> + Send;
    fn get_folder(&self, builder: GetFolderInputBuilder) -> impl Future<Output = Result<GetFolderOutput, SdkError<GetFolderError>>> + Send;
    fn get_merge_commit(&self, builder: GetMergeCommitInputBuilder) -> impl Future<Output = Result<GetMergeCommitOutput, SdkError<GetMergeCommitError>>> + Send;
    fn get_merge_conflicts(&self, builder: GetMergeConflictsInputBuilder) -> impl Future<Output = Result<GetMergeConflictsOutput, SdkError<GetMergeConflictsError>>> + Send;
    fn get_merge_options(&self, builder: GetMergeOptionsInputBuilder) -> impl Future<Output = Result<GetMergeOptionsOutput, SdkError<GetMergeOptionsError>>> + Send;
    fn get_pull_request(&self, builder: GetPullRequestInputBuilder) -> impl Future<Output = Result<GetPullRequestOutput, SdkError<GetPullRequestError>>> + Send;
    fn get_pull_request_approval_states(&self, builder: GetPullRequestApprovalStatesInputBuilder) -> impl Future<Output = Result<GetPullRequestApprovalStatesOutput, SdkError<GetPullRequestApprovalStatesError>>> + Send;
    fn get_pull_request_override_state(&self, builder: GetPullRequestOverrideStateInputBuilder) -> impl Future<Output = Result<GetPullRequestOverrideStateOutput, SdkError<GetPullRequestOverrideStateError>>> + Send;
    fn get_repository(&self, builder: GetRepositoryInputBuilder) -> impl Future<Output = Result<GetRepositoryOutput, SdkError<GetRepositoryError>>> + Send;
    fn get_repository_triggers(&self, builder: GetRepositoryTriggersInputBuilder) -> impl Future<Output = Result<GetRepositoryTriggersOutput, SdkError<GetRepositoryTriggersError>>> + Send;
    fn list_approval_rule_templates(&self, builder: ListApprovalRuleTemplatesInputBuilder) -> impl Future<Output = Result<ListApprovalRuleTemplatesOutput, SdkError<ListApprovalRuleTemplatesError>>> + Send;
    fn list_associated_approval_rule_templates_for_repository(&self, builder: ListAssociatedApprovalRuleTemplatesForRepositoryInputBuilder) -> impl Future<Output = Result<ListAssociatedApprovalRuleTemplatesForRepositoryOutput, SdkError<ListAssociatedApprovalRuleTemplatesForRepositoryError>>> + Send;
    fn list_branches(&self, builder: ListBranchesInputBuilder) -> impl Future<Output = Result<ListBranchesOutput, SdkError<ListBranchesError>>> + Send;
    fn list_file_commit_history(&self, builder: ListFileCommitHistoryInputBuilder) -> impl Future<Output = Result<ListFileCommitHistoryOutput, SdkError<ListFileCommitHistoryError>>> + Send;
    fn list_pull_requests(&self, builder: ListPullRequestsInputBuilder) -> impl Future<Output = Result<ListPullRequestsOutput, SdkError<ListPullRequestsError>>> + Send;
    fn list_repositories(&self, builder: ListRepositoriesInputBuilder) -> impl Future<Output = Result<ListRepositoriesOutput, SdkError<ListRepositoriesError>>> + Send;
    fn list_repositories_for_approval_rule_template(&self, builder: ListRepositoriesForApprovalRuleTemplateInputBuilder) -> impl Future<Output = Result<ListRepositoriesForApprovalRuleTemplateOutput, SdkError<ListRepositoriesForApprovalRuleTemplateError>>> + Send;
    ...
    fn merge_branches_by_fast_forward(&self, builder: MergeBranchesByFastForwardInputBuilder) -> impl Future<Output = Result<MergeBranchesByFastForwardOutput, SdkError<MergeBranchesByFastForwardError>>> + Send;
    fn merge_branches_by_squash(&self, builder: MergeBranchesBySquashInputBuilder) -> impl Future<Output = Result<MergeBranchesBySquashOutput, SdkError<MergeBranchesBySquashError>>> + Send;
    fn merge_branches_by_three_way(&self, builder: MergeBranchesByThreeWayInputBuilder) -> impl Future<Output = Result<MergeBranchesByThreeWayOutput, SdkError<MergeBranchesByThreeWayError>>> + Send;
    fn merge_pull_request_by_fast_forward(&self, builder: MergePullRequestByFastForwardInputBuilder) -> impl Future<Output = Result<MergePullRequestByFastForwardOutput, SdkError<MergePullRequestByFastForwardError>>> + Send;
    fn merge_pull_request_by_squash(&self, builder: MergePullRequestBySquashInputBuilder) -> impl Future<Output = Result<MergePullRequestBySquashOutput, SdkError<MergePullRequestBySquashError>>> + Send;
    fn merge_pull_request_by_three_way(&self, builder: MergePullRequestByThreeWayInputBuilder) -> impl Future<Output = Result<MergePullRequestByThreeWayOutput, SdkError<MergePullRequestByThreeWayError>>> + Send;
    fn override_pull_request_approval_rules(&self, builder: OverridePullRequestApprovalRulesInputBuilder) -> impl Future<Output = Result<OverridePullRequestApprovalRulesOutput, SdkError<OverridePullRequestApprovalRulesError>>> + Send;
    fn post_comment_for_compared_commit(&self, builder: PostCommentForComparedCommitInputBuilder) -> impl Future<Output = Result<PostCommentForComparedCommitOutput, SdkError<PostCommentForComparedCommitError>>> + Send;
    fn post_comment_for_pull_request(&self, builder: PostCommentForPullRequestInputBuilder) -> impl Future<Output = Result<PostCommentForPullRequestOutput, SdkError<PostCommentForPullRequestError>>> + Send;
    fn post_comment_reply(&self, builder: PostCommentReplyInputBuilder) -> impl Future<Output = Result<PostCommentReplyOutput, SdkError<PostCommentReplyError>>> + Send;
    fn put_comment_reaction(&self, builder: PutCommentReactionInputBuilder) -> impl Future<Output = Result<PutCommentReactionOutput, SdkError<PutCommentReactionError>>> + Send;
    fn put_file(&self, builder: PutFileInputBuilder) -> impl Future<Output = Result<PutFileOutput, SdkError<PutFileError>>> + Send;
    fn put_repository_triggers(&self, builder: PutRepositoryTriggersInputBuilder) -> impl Future<Output = Result<PutRepositoryTriggersOutput, SdkError<PutRepositoryTriggersError>>> + Send;
    ...
    fn test_repository_triggers(&self, builder: TestRepositoryTriggersInputBuilder) -> impl Future<Output = Result<TestRepositoryTriggersOutput, SdkError<TestRepositoryTriggersError>>> + Send;
    ...
    fn update_approval_rule_template_content(&self, builder: UpdateApprovalRuleTemplateContentInputBuilder) -> impl Future<Output = Result<UpdateApprovalRuleTemplateContentOutput, SdkError<UpdateApprovalRuleTemplateContentError>>> + Send;
    fn update_approval_rule_template_description(&self, builder: UpdateApprovalRuleTemplateDescriptionInputBuilder) -> impl Future<Output = Result<UpdateApprovalRuleTemplateDescriptionOutput, SdkError<UpdateApprovalRuleTemplateDescriptionError>>> + Send;
    fn update_approval_rule_template_name(&self, builder: UpdateApprovalRuleTemplateNameInputBuilder) -> impl Future<Output = Result<UpdateApprovalRuleTemplateNameOutput, SdkError<UpdateApprovalRuleTemplateNameError>>> + Send;
    fn update_comment(&self, builder: UpdateCommentInputBuilder) -> impl Future<Output = Result<UpdateCommentOutput, SdkError<UpdateCommentError>>> + Send;
    fn update_default_branch(&self, builder: UpdateDefaultBranchInputBuilder) -> impl Future<Output = Result<UpdateDefaultBranchOutput, SdkError<UpdateDefaultBranchError>>> + Send;
    fn update_pull_request_approval_rule_content(&self, builder: UpdatePullRequestApprovalRuleContentInputBuilder) -> impl Future<Output = Result<UpdatePullRequestApprovalRuleContentOutput, SdkError<UpdatePullRequestApprovalRuleContentError>>> + Send;
    fn update_pull_request_approval_state(&self, builder: UpdatePullRequestApprovalStateInputBuilder) -> impl Future<Output = Result<UpdatePullRequestApprovalStateOutput, SdkError<UpdatePullRequestApprovalStateError>>> + Send;
    fn update_pull_request_description(&self, builder: UpdatePullRequestDescriptionInputBuilder) -> impl Future<Output = Result<UpdatePullRequestDescriptionOutput, SdkError<UpdatePullRequestDescriptionError>>> + Send;
    fn update_pull_request_status(&self, builder: UpdatePullRequestStatusInputBuilder) -> impl Future<Output = Result<UpdatePullRequestStatusOutput, SdkError<UpdatePullRequestStatusError>>> + Send;
    fn update_pull_request_title(&self, builder: UpdatePullRequestTitleInputBuilder) -> impl Future<Output = Result<UpdatePullRequestTitleOutput, SdkError<UpdatePullRequestTitleError>>> + Send;
    fn update_repository_description(&self, builder: UpdateRepositoryDescriptionInputBuilder) -> impl Future<Output = Result<UpdateRepositoryDescriptionOutput, SdkError<UpdateRepositoryDescriptionError>>> + Send;
    fn update_repository_encryption_key(&self, builder: UpdateRepositoryEncryptionKeyInputBuilder) -> impl Future<Output = Result<UpdateRepositoryEncryptionKeyOutput, SdkError<UpdateRepositoryEncryptionKeyError>>> + Send;
    fn update_repository_name(&self, builder: UpdateRepositoryNameInputBuilder) -> impl Future<Output = Result<UpdateRepositoryNameOutput, SdkError<UpdateRepositoryNameError>>> + Send;
}

...
pub trait AppStreamClient {
    fn associate_app_block_builder_app_block(&self, builder: AssociateAppBlockBuilderAppBlockInputBuilder) -> impl Future<Output = Result<AssociateAppBlockBuilderAppBlockOutput, SdkError<AssociateAppBlockBuilderAppBlockError>>> + Send;
    fn associate_application_fleet(&self, builder: AssociateApplicationFleetInputBuilder) -> impl Future<Output = Result<AssociateApplicationFleetOutput, SdkError<AssociateApplicationFleetError>>> + Send;
    fn associate_application_to_entitlement(&self, builder: AssociateApplicationToEntitlementInputBuilder) -> impl Future<Output = Result<AssociateApplicationToEntitlementOutput, SdkError<AssociateApplicationToEntitlementError>>> + Send;
    fn associate_fleet(&self, builder: AssociateFleetInputBuilder) -> impl Future<Output = Result<AssociateFleetOutput, SdkError<AssociateFleetError>>> + Send;
    fn batch_associate_user_stack(&self, builder: BatchAssociateUserStackInputBuilder) -> impl Future<Output = Result<BatchAssociateUserStackOutput, SdkError<BatchAssociateUserStackError>>> + Send;
    fn batch_disassociate_user_stack(&self, builder: BatchDisassociateUserStackInputBuilder) -> impl Future<Output = Result<BatchDisassociateUserStackOutput, SdkError<BatchDisassociateUserStackError>>> + Send;
    fn copy_image(&self, builder: CopyImageInputBuilder) -> impl Future<Output = Result<CopyImageOutput, SdkError<CopyImageError>>> + Send;
    fn create_app_block(&self, builder: CreateAppBlockInputBuilder) -> impl Future<Output = Result<CreateAppBlockOutput, SdkError<CreateAppBlockError>>> + Send;
    fn create_app_block_builder(&self, builder: CreateAppBlockBuilderInputBuilder) -> impl Future<Output = Result<CreateAppBlockBuilderOutput, SdkError<CreateAppBlockBuilderError>>> + Send;
    fn create_app_block_builder_streaming_url(&self, builder: CreateAppBlockBuilderStreamingUrlInputBuilder) -> impl Future<Output = Result<CreateAppBlockBuilderStreamingUrlOutput, SdkError<CreateAppBlockBuilderStreamingURLError>>> + Send;
    ...
    fn create_directory_config(&self, builder: CreateDirectoryConfigInputBuilder) -> impl Future<Output = Result<CreateDirectoryConfigOutput, SdkError<CreateDirectoryConfigError>>> + Send;
    fn create_entitlement(&self, builder: CreateEntitlementInputBuilder) -> impl Future<Output = Result<CreateEntitlementOutput, SdkError<CreateEntitlementError>>> + Send;
    ...
    fn create_image_builder(&self, builder: CreateImageBuilderInputBuilder) -> impl Future<Output = Result<CreateImageBuilderOutput, SdkError<CreateImageBuilderError>>> + Send;
    fn create_image_builder_streaming_url(&self, builder: CreateImageBuilderStreamingUrlInputBuilder) -> impl Future<Output = Result<CreateImageBuilderStreamingUrlOutput, SdkError<CreateImageBuilderStreamingURLError>>> + Send;
    ...
    fn create_streaming_url(&self, builder: CreateStreamingUrlInputBuilder) -> impl Future<Output = Result<CreateStreamingUrlOutput, SdkError<CreateStreamingURLError>>> + Send;
    fn create_updated_image(&self, builder: CreateUpdatedImageInputBuilder) -> impl Future<Output = Result<CreateUpdatedImageOutput, SdkError<CreateUpdatedImageError>>> + Send;
    fn create_usage_report_subscription(&self, builder: CreateUsageReportSubscriptionInputBuilder) -> impl Future<Output = Result<CreateUsageReportSubscriptionOutput, SdkError<CreateUsageReportSubscriptionError>>> + Send;
    ...
    fn delete_app_block(&self, builder: DeleteAppBlockInputBuilder) -> impl Future<Output = Result<DeleteAppBlockOutput, SdkError<DeleteAppBlockError>>> + Send;
    fn delete_app_block_builder(&self, builder: DeleteAppBlockBuilderInputBuilder) -> impl Future<Output = Result<DeleteAppBlockBuilderOutput, SdkError<DeleteAppBlockBuilderError>>> + Send;
    ...
    fn delete_directory_config(&self, builder: DeleteDirectoryConfigInputBuilder) -> impl Future<Output = Result<DeleteDirectoryConfigOutput, SdkError<DeleteDirectoryConfigError>>> + Send;
    fn delete_entitlement(&self, builder: DeleteEntitlementInputBuilder) -> impl Future<Output = Result<DeleteEntitlementOutput, SdkError<DeleteEntitlementError>>> + Send;
    fn delete_fleet(&self, builder: DeleteFleetInputBuilder) -> impl Future<Output = Result<DeleteFleetOutput, SdkError<DeleteFleetError>>> + Send;
    ...
    fn delete_image_builder(&self, builder: DeleteImageBuilderInputBuilder) -> impl Future<Output = Result<DeleteImageBuilderOutput, SdkError<DeleteImageBuilderError>>> + Send;
    fn delete_image_permissions(&self, builder: DeleteImagePermissionsInputBuilder) -> impl Future<Output = Result<DeleteImagePermissionsOutput, SdkError<DeleteImagePermissionsError>>> + Send;
    ...
    fn delete_usage_report_subscription(&self, builder: DeleteUsageReportSubscriptionInputBuilder) -> impl Future<Output = Result<DeleteUsageReportSubscriptionOutput, SdkError<DeleteUsageReportSubscriptionError>>> + Send;
    ...
    fn describe_app_block_builder_app_block_associations(&self, builder: DescribeAppBlockBuilderAppBlockAssociationsInputBuilder) -> impl Future<Output = Result<DescribeAppBlockBuilderAppBlockAssociationsOutput, SdkError<DescribeAppBlockBuilderAppBlockAssociationsError>>> + Send;
    fn describe_app_block_builders(&self, builder: DescribeAppBlockBuildersInputBuilder) -> impl Future<Output = Result<DescribeAppBlockBuildersOutput, SdkError<DescribeAppBlockBuildersError>>> + Send;
    fn describe_app_blocks(&self, builder: DescribeAppBlocksInputBuilder) -> impl Future<Output = Result<DescribeAppBlocksOutput, SdkError<DescribeAppBlocksError>>> + Send;
    fn describe_application_fleet_associations(&self, builder: DescribeApplicationFleetAssociationsInputBuilder) -> impl Future<Output = Result<DescribeApplicationFleetAssociationsOutput, SdkError<DescribeApplicationFleetAssociationsError>>> + Send;
    ...
    fn describe_directory_configs(&self, builder: DescribeDirectoryConfigsInputBuilder) -> impl Future<Output = Result<DescribeDirectoryConfigsOutput, SdkError<DescribeDirectoryConfigsError>>> + Send;
    fn describe_entitlements(&self, builder: DescribeEntitlementsInputBuilder) -> impl Future<Output = Result<DescribeEntitlementsOutput, SdkError<DescribeEntitlementsError>>> + Send;
    ...
    fn describe_image_builders(&self, builder: DescribeImageBuildersInputBuilder) -> impl Future<Output = Result<DescribeImageBuildersOutput, SdkError<DescribeImageBuildersError>>> + Send;
    fn describe_image_permissions(&self, builder: DescribeImagePermissionsInputBuilder) -> impl Future<Output = Result<DescribeImagePermissionsOutput, SdkError<DescribeImagePermissionsError>>> + Send;
    ...
    fn describe_usage_report_subscriptions(&self, builder: DescribeUsageReportSubscriptionsInputBuilder) -> impl Future<Output = Result<DescribeUsageReportSubscriptionsOutput, SdkError<DescribeUsageReportSubscriptionsError>>> + Send;
    fn describe_user_stack_associations(&self, builder: DescribeUserStackAssociationsInputBuilder) -> impl Future<Output = Result<DescribeUserStackAssociationsOutput, SdkError<DescribeUserStackAssociationsError>>> + Send;
    ...
    fn disable_user(&self, builder: DisableUserInputBuilder) -> impl Future<Output = Result<DisableUserOutput, SdkError<DisableUserError>>> + Send;
    fn disassociate_app_block_builder_app_block(&self, builder: DisassociateAppBlockBuilderAppBlockInputBuilder) -> impl Future<Output = Result<DisassociateAppBlockBuilderAppBlockOutput, SdkError<DisassociateAppBlockBuilderAppBlockError>>> + Send;
    fn disassociate_application_fleet(&self, builder: DisassociateApplicationFleetInputBuilder) -> impl Future<Output = Result<DisassociateApplicationFleetOutput, SdkError<DisassociateApplicationFleetError>>> + Send;
    fn disassociate_application_from_entitlement(&self, builder: DisassociateApplicationFromEntitlementInputBuilder) -> impl Future<Output = Result<DisassociateApplicationFromEntitlementOutput, SdkError<DisassociateApplicationFromEntitlementError>>> + Send;
    fn disassociate_fleet(&self, builder: DisassociateFleetInputBuilder) -> impl Future<Output = Result<DisassociateFleetOutput, SdkError<DisassociateFleetError>>> + Send;
    fn enable_user(&self, builder: EnableUserInputBuilder) -> impl Future<Output = Result<EnableUserOutput, SdkError<EnableUserError>>> + Send;
    fn expire_session(&self, builder: ExpireSessionInputBuilder) -> impl Future<Output = Result<ExpireSessionOutput, SdkError<ExpireSessionError>>> + Send;
    fn list_associated_fleets(&self, builder: ListAssociatedFleetsInputBuilder) -> impl Future<Output = Result<ListAssociatedFleetsOutput, SdkError<ListAssociatedFleetsError>>> + Send;
    fn list_associated_stacks(&self, builder: ListAssociatedStacksInputBuilder) -> impl Future<Output = Result<ListAssociatedStacksOutput, SdkError<ListAssociatedStacksError>>> + Send;
    fn list_entitled_applications(&self, builder: ListEntitledApplicationsInputBuilder) -> impl Future<Output = Result<ListEntitledApplicationsOutput, SdkError<ListEntitledApplicationsError>>> + Send;
    ...
    fn start_app_block_builder(&self, builder: StartAppBlockBuilderInputBuilder) -> impl Future<Output = Result<StartAppBlockBuilderOutput, SdkError<StartAppBlockBuilderError>>> + Send;
    fn start_fleet(&self, builder: StartFleetInputBuilder) -> impl Future<Output = Result<StartFleetOutput, SdkError<StartFleetError>>> + Send;
    fn start_image_builder(&self, builder: StartImageBuilderInputBuilder) -> impl Future<Output = Result<StartImageBuilderOutput, SdkError<StartImageBuilderError>>> + Send;
    fn stop_app_block_builder(&self, builder: StopAppBlockBuilderInputBuilder) -> impl Future<Output = Result<StopAppBlockBuilderOutput, SdkError<StopAppBlockBuilderError>>> + Send;
    fn stop_fleet(&self, builder: StopFleetInputBuilder) -> impl Future<Output = Result<StopFleetOutput, SdkError<StopFleetError>>> + Send;
    fn stop_image_builder(&self, builder: StopImageBuilderInputBuilder) -> impl Future<Output = Result<StopImageBuilderOutput, SdkError<StopImageBuilderError>>> + Send;
    ...
    fn update_app_block_builder(&self, builder: UpdateAppBlockBuilderInputBuilder) -> impl Future<Output = Result<UpdateAppBlockBuilderOutput, SdkError<UpdateAppBlockBuilderError>>> + Send;
    ...
    fn update_directory_config(&self, builder: UpdateDirectoryConfigInputBuilder) -> impl Future<Output = Result<UpdateDirectoryConfigOutput, SdkError<UpdateDirectoryConfigError>>> + Send;
    fn update_entitlement(&self, builder: UpdateEntitlementInputBuilder) -> impl Future<Output = Result<UpdateEntitlementOutput, SdkError<UpdateEntitlementError>>> + Send;
    fn update_fleet(&self, builder: UpdateFleetInputBuilder) -> impl Future<Output = Result<UpdateFleetOutput, SdkError<UpdateFleetError>>> + Send;
    fn update_image_permissions(&self, builder: UpdateImagePermissionsInputBuilder) -> impl Future<Output = Result<UpdateImagePermissionsOutput, SdkError<UpdateImagePermissionsError>>> + Send;

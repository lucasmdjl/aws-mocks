...
pub trait GlueClient {
    fn batch_create_partition(&self, builder: BatchCreatePartitionInputBuilder) -> impl Future<Output = Result<BatchCreatePartitionOutput, SdkError<BatchCreatePartitionError>>> + Send;
    fn batch_delete_connection(&self, builder: BatchDeleteConnectionInputBuilder) -> impl Future<Output = Result<BatchDeleteConnectionOutput, SdkError<BatchDeleteConnectionError>>> + Send;
    fn batch_delete_partition(&self, builder: BatchDeletePartitionInputBuilder) -> impl Future<Output = Result<BatchDeletePartitionOutput, SdkError<BatchDeletePartitionError>>> + Send;
    fn batch_delete_table(&self, builder: BatchDeleteTableInputBuilder) -> impl Future<Output = Result<BatchDeleteTableOutput, SdkError<BatchDeleteTableError>>> + Send;
    fn batch_delete_table_version(&self, builder: BatchDeleteTableVersionInputBuilder) -> impl Future<Output = Result<BatchDeleteTableVersionOutput, SdkError<BatchDeleteTableVersionError>>> + Send;
    fn batch_get_blueprints(&self, builder: BatchGetBlueprintsInputBuilder) -> impl Future<Output = Result<BatchGetBlueprintsOutput, SdkError<BatchGetBlueprintsError>>> + Send;
    fn batch_get_crawlers(&self, builder: BatchGetCrawlersInputBuilder) -> impl Future<Output = Result<BatchGetCrawlersOutput, SdkError<BatchGetCrawlersError>>> + Send;
    fn batch_get_custom_entity_types(&self, builder: BatchGetCustomEntityTypesInputBuilder) -> impl Future<Output = Result<BatchGetCustomEntityTypesOutput, SdkError<BatchGetCustomEntityTypesError>>> + Send;
    fn batch_get_data_quality_result(&self, builder: BatchGetDataQualityResultInputBuilder) -> impl Future<Output = Result<BatchGetDataQualityResultOutput, SdkError<BatchGetDataQualityResultError>>> + Send;
    fn batch_get_dev_endpoints(&self, builder: BatchGetDevEndpointsInputBuilder) -> impl Future<Output = Result<BatchGetDevEndpointsOutput, SdkError<BatchGetDevEndpointsError>>> + Send;
    fn batch_get_jobs(&self, builder: BatchGetJobsInputBuilder) -> impl Future<Output = Result<BatchGetJobsOutput, SdkError<BatchGetJobsError>>> + Send;
    fn batch_get_partition(&self, builder: BatchGetPartitionInputBuilder) -> impl Future<Output = Result<BatchGetPartitionOutput, SdkError<BatchGetPartitionError>>> + Send;
    fn batch_get_table_optimizer(&self, builder: BatchGetTableOptimizerInputBuilder) -> impl Future<Output = Result<BatchGetTableOptimizerOutput, SdkError<BatchGetTableOptimizerError>>> + Send;
    fn batch_get_triggers(&self, builder: BatchGetTriggersInputBuilder) -> impl Future<Output = Result<BatchGetTriggersOutput, SdkError<BatchGetTriggersError>>> + Send;
    fn batch_get_workflows(&self, builder: BatchGetWorkflowsInputBuilder) -> impl Future<Output = Result<BatchGetWorkflowsOutput, SdkError<BatchGetWorkflowsError>>> + Send;
    fn batch_stop_job_run(&self, builder: BatchStopJobRunInputBuilder) -> impl Future<Output = Result<BatchStopJobRunOutput, SdkError<BatchStopJobRunError>>> + Send;
    fn batch_update_partition(&self, builder: BatchUpdatePartitionInputBuilder) -> impl Future<Output = Result<BatchUpdatePartitionOutput, SdkError<BatchUpdatePartitionError>>> + Send;
    fn cancel_data_quality_rule_recommendation_run(&self, builder: CancelDataQualityRuleRecommendationRunInputBuilder) -> impl Future<Output = Result<CancelDataQualityRuleRecommendationRunOutput, SdkError<CancelDataQualityRuleRecommendationRunError>>> + Send;
    fn cancel_data_quality_ruleset_evaluation_run(&self, builder: CancelDataQualityRulesetEvaluationRunInputBuilder) -> impl Future<Output = Result<CancelDataQualityRulesetEvaluationRunOutput, SdkError<CancelDataQualityRulesetEvaluationRunError>>> + Send;
    fn cancel_ml_task_run(&self, builder: CancelMlTaskRunInputBuilder) -> impl Future<Output = Result<CancelMlTaskRunOutput, SdkError<CancelMLTaskRunError>>> + Send;
    fn cancel_statement(&self, builder: CancelStatementInputBuilder) -> impl Future<Output = Result<CancelStatementOutput, SdkError<CancelStatementError>>> + Send;
    fn check_schema_version_validity(&self, builder: CheckSchemaVersionValidityInputBuilder) -> impl Future<Output = Result<CheckSchemaVersionValidityOutput, SdkError<CheckSchemaVersionValidityError>>> + Send;
    fn create_blueprint(&self, builder: CreateBlueprintInputBuilder) -> impl Future<Output = Result<CreateBlueprintOutput, SdkError<CreateBlueprintError>>> + Send;
    fn create_classifier(&self, builder: CreateClassifierInputBuilder) -> impl Future<Output = Result<CreateClassifierOutput, SdkError<CreateClassifierError>>> + Send;
    ...
    fn create_crawler(&self, builder: CreateCrawlerInputBuilder) -> impl Future<Output = Result<CreateCrawlerOutput, SdkError<CreateCrawlerError>>> + Send;
    fn create_custom_entity_type(&self, builder: CreateCustomEntityTypeInputBuilder) -> impl Future<Output = Result<CreateCustomEntityTypeOutput, SdkError<CreateCustomEntityTypeError>>> + Send;
    fn create_data_quality_ruleset(&self, builder: CreateDataQualityRulesetInputBuilder) -> impl Future<Output = Result<CreateDataQualityRulesetOutput, SdkError<CreateDataQualityRulesetError>>> + Send;
    fn create_database(&self, builder: CreateDatabaseInputBuilder) -> impl Future<Output = Result<CreateDatabaseOutput, SdkError<CreateDatabaseError>>> + Send;
    fn create_dev_endpoint(&self, builder: CreateDevEndpointInputBuilder) -> impl Future<Output = Result<CreateDevEndpointOutput, SdkError<CreateDevEndpointError>>> + Send;
    fn create_job(&self, builder: CreateJobInputBuilder) -> impl Future<Output = Result<CreateJobOutput, SdkError<CreateJobError>>> + Send;
    fn create_ml_transform(&self, builder: CreateMlTransformInputBuilder) -> impl Future<Output = Result<CreateMlTransformOutput, SdkError<CreateMLTransformError>>> + Send;
    fn create_partition(&self, builder: CreatePartitionInputBuilder) -> impl Future<Output = Result<CreatePartitionOutput, SdkError<CreatePartitionError>>> + Send;
    fn create_partition_index(&self, builder: CreatePartitionIndexInputBuilder) -> impl Future<Output = Result<CreatePartitionIndexOutput, SdkError<CreatePartitionIndexError>>> + Send;
    fn create_registry(&self, builder: CreateRegistryInputBuilder) -> impl Future<Output = Result<CreateRegistryOutput, SdkError<CreateRegistryError>>> + Send;
    fn create_schema(&self, builder: CreateSchemaInputBuilder) -> impl Future<Output = Result<CreateSchemaOutput, SdkError<CreateSchemaError>>> + Send;
    fn create_script(&self, builder: CreateScriptInputBuilder) -> impl Future<Output = Result<CreateScriptOutput, SdkError<CreateScriptError>>> + Send;
    ...
    fn create_table(&self, builder: CreateTableInputBuilder) -> impl Future<Output = Result<CreateTableOutput, SdkError<CreateTableError>>> + Send;
    fn create_table_optimizer(&self, builder: CreateTableOptimizerInputBuilder) -> impl Future<Output = Result<CreateTableOptimizerOutput, SdkError<CreateTableOptimizerError>>> + Send;
    fn create_trigger(&self, builder: CreateTriggerInputBuilder) -> impl Future<Output = Result<CreateTriggerOutput, SdkError<CreateTriggerError>>> + Send;
    fn create_usage_profile(&self, builder: CreateUsageProfileInputBuilder) -> impl Future<Output = Result<CreateUsageProfileOutput, SdkError<CreateUsageProfileError>>> + Send;
    fn create_user_defined_function(&self, builder: CreateUserDefinedFunctionInputBuilder) -> impl Future<Output = Result<CreateUserDefinedFunctionOutput, SdkError<CreateUserDefinedFunctionError>>> + Send;
    fn create_workflow(&self, builder: CreateWorkflowInputBuilder) -> impl Future<Output = Result<CreateWorkflowOutput, SdkError<CreateWorkflowError>>> + Send;
    fn delete_blueprint(&self, builder: DeleteBlueprintInputBuilder) -> impl Future<Output = Result<DeleteBlueprintOutput, SdkError<DeleteBlueprintError>>> + Send;
    fn delete_classifier(&self, builder: DeleteClassifierInputBuilder) -> impl Future<Output = Result<DeleteClassifierOutput, SdkError<DeleteClassifierError>>> + Send;
    fn delete_column_statistics_for_partition(&self, builder: DeleteColumnStatisticsForPartitionInputBuilder) -> impl Future<Output = Result<DeleteColumnStatisticsForPartitionOutput, SdkError<DeleteColumnStatisticsForPartitionError>>> + Send;
    fn delete_column_statistics_for_table(&self, builder: DeleteColumnStatisticsForTableInputBuilder) -> impl Future<Output = Result<DeleteColumnStatisticsForTableOutput, SdkError<DeleteColumnStatisticsForTableError>>> + Send;
    ...
    fn delete_crawler(&self, builder: DeleteCrawlerInputBuilder) -> impl Future<Output = Result<DeleteCrawlerOutput, SdkError<DeleteCrawlerError>>> + Send;
    fn delete_custom_entity_type(&self, builder: DeleteCustomEntityTypeInputBuilder) -> impl Future<Output = Result<DeleteCustomEntityTypeOutput, SdkError<DeleteCustomEntityTypeError>>> + Send;
    fn delete_data_quality_ruleset(&self, builder: DeleteDataQualityRulesetInputBuilder) -> impl Future<Output = Result<DeleteDataQualityRulesetOutput, SdkError<DeleteDataQualityRulesetError>>> + Send;
    fn delete_database(&self, builder: DeleteDatabaseInputBuilder) -> impl Future<Output = Result<DeleteDatabaseOutput, SdkError<DeleteDatabaseError>>> + Send;
    fn delete_dev_endpoint(&self, builder: DeleteDevEndpointInputBuilder) -> impl Future<Output = Result<DeleteDevEndpointOutput, SdkError<DeleteDevEndpointError>>> + Send;
    fn delete_job(&self, builder: DeleteJobInputBuilder) -> impl Future<Output = Result<DeleteJobOutput, SdkError<DeleteJobError>>> + Send;
    fn delete_ml_transform(&self, builder: DeleteMlTransformInputBuilder) -> impl Future<Output = Result<DeleteMlTransformOutput, SdkError<DeleteMLTransformError>>> + Send;
    fn delete_partition(&self, builder: DeletePartitionInputBuilder) -> impl Future<Output = Result<DeletePartitionOutput, SdkError<DeletePartitionError>>> + Send;
    fn delete_partition_index(&self, builder: DeletePartitionIndexInputBuilder) -> impl Future<Output = Result<DeletePartitionIndexOutput, SdkError<DeletePartitionIndexError>>> + Send;
    fn delete_registry(&self, builder: DeleteRegistryInputBuilder) -> impl Future<Output = Result<DeleteRegistryOutput, SdkError<DeleteRegistryError>>> + Send;
    ...
    fn delete_schema(&self, builder: DeleteSchemaInputBuilder) -> impl Future<Output = Result<DeleteSchemaOutput, SdkError<DeleteSchemaError>>> + Send;
    fn delete_schema_versions(&self, builder: DeleteSchemaVersionsInputBuilder) -> impl Future<Output = Result<DeleteSchemaVersionsOutput, SdkError<DeleteSchemaVersionsError>>> + Send;
    ...
    fn delete_session(&self, builder: DeleteSessionInputBuilder) -> impl Future<Output = Result<DeleteSessionOutput, SdkError<DeleteSessionError>>> + Send;
    fn delete_table(&self, builder: DeleteTableInputBuilder) -> impl Future<Output = Result<DeleteTableOutput, SdkError<DeleteTableError>>> + Send;
    fn delete_table_optimizer(&self, builder: DeleteTableOptimizerInputBuilder) -> impl Future<Output = Result<DeleteTableOptimizerOutput, SdkError<DeleteTableOptimizerError>>> + Send;
    fn delete_table_version(&self, builder: DeleteTableVersionInputBuilder) -> impl Future<Output = Result<DeleteTableVersionOutput, SdkError<DeleteTableVersionError>>> + Send;
    fn delete_trigger(&self, builder: DeleteTriggerInputBuilder) -> impl Future<Output = Result<DeleteTriggerOutput, SdkError<DeleteTriggerError>>> + Send;
    fn delete_usage_profile(&self, builder: DeleteUsageProfileInputBuilder) -> impl Future<Output = Result<DeleteUsageProfileOutput, SdkError<DeleteUsageProfileError>>> + Send;
    fn delete_user_defined_function(&self, builder: DeleteUserDefinedFunctionInputBuilder) -> impl Future<Output = Result<DeleteUserDefinedFunctionOutput, SdkError<DeleteUserDefinedFunctionError>>> + Send;
    fn delete_workflow(&self, builder: DeleteWorkflowInputBuilder) -> impl Future<Output = Result<DeleteWorkflowOutput, SdkError<DeleteWorkflowError>>> + Send;
    fn get_blueprint(&self, builder: GetBlueprintInputBuilder) -> impl Future<Output = Result<GetBlueprintOutput, SdkError<GetBlueprintError>>> + Send;
    fn get_blueprint_run(&self, builder: GetBlueprintRunInputBuilder) -> impl Future<Output = Result<GetBlueprintRunOutput, SdkError<GetBlueprintRunError>>> + Send;
    fn get_blueprint_runs(&self, builder: GetBlueprintRunsInputBuilder) -> impl Future<Output = Result<GetBlueprintRunsOutput, SdkError<GetBlueprintRunsError>>> + Send;
    fn get_catalog_import_status(&self, builder: GetCatalogImportStatusInputBuilder) -> impl Future<Output = Result<GetCatalogImportStatusOutput, SdkError<GetCatalogImportStatusError>>> + Send;
    fn get_classifier(&self, builder: GetClassifierInputBuilder) -> impl Future<Output = Result<GetClassifierOutput, SdkError<GetClassifierError>>> + Send;
    fn get_classifiers(&self, builder: GetClassifiersInputBuilder) -> impl Future<Output = Result<GetClassifiersOutput, SdkError<GetClassifiersError>>> + Send;
    fn get_column_statistics_for_partition(&self, builder: GetColumnStatisticsForPartitionInputBuilder) -> impl Future<Output = Result<GetColumnStatisticsForPartitionOutput, SdkError<GetColumnStatisticsForPartitionError>>> + Send;
    fn get_column_statistics_for_table(&self, builder: GetColumnStatisticsForTableInputBuilder) -> impl Future<Output = Result<GetColumnStatisticsForTableOutput, SdkError<GetColumnStatisticsForTableError>>> + Send;
    fn get_column_statistics_task_run(&self, builder: GetColumnStatisticsTaskRunInputBuilder) -> impl Future<Output = Result<GetColumnStatisticsTaskRunOutput, SdkError<GetColumnStatisticsTaskRunError>>> + Send;
    fn get_column_statistics_task_runs(&self, builder: GetColumnStatisticsTaskRunsInputBuilder) -> impl Future<Output = Result<GetColumnStatisticsTaskRunsOutput, SdkError<GetColumnStatisticsTaskRunsError>>> + Send;
    ...
    fn get_connections(&self, builder: GetConnectionsInputBuilder) -> impl Future<Output = Result<GetConnectionsOutput, SdkError<GetConnectionsError>>> + Send;
    fn get_crawler(&self, builder: GetCrawlerInputBuilder) -> impl Future<Output = Result<GetCrawlerOutput, SdkError<GetCrawlerError>>> + Send;
    fn get_crawler_metrics(&self, builder: GetCrawlerMetricsInputBuilder) -> impl Future<Output = Result<GetCrawlerMetricsOutput, SdkError<GetCrawlerMetricsError>>> + Send;
    fn get_crawlers(&self, builder: GetCrawlersInputBuilder) -> impl Future<Output = Result<GetCrawlersOutput, SdkError<GetCrawlersError>>> + Send;
    fn get_custom_entity_type(&self, builder: GetCustomEntityTypeInputBuilder) -> impl Future<Output = Result<GetCustomEntityTypeOutput, SdkError<GetCustomEntityTypeError>>> + Send;
    fn get_data_catalog_encryption_settings(&self, builder: GetDataCatalogEncryptionSettingsInputBuilder) -> impl Future<Output = Result<GetDataCatalogEncryptionSettingsOutput, SdkError<GetDataCatalogEncryptionSettingsError>>> + Send;
    fn get_data_quality_result(&self, builder: GetDataQualityResultInputBuilder) -> impl Future<Output = Result<GetDataQualityResultOutput, SdkError<GetDataQualityResultError>>> + Send;
    fn get_data_quality_rule_recommendation_run(&self, builder: GetDataQualityRuleRecommendationRunInputBuilder) -> impl Future<Output = Result<GetDataQualityRuleRecommendationRunOutput, SdkError<GetDataQualityRuleRecommendationRunError>>> + Send;
    fn get_data_quality_ruleset(&self, builder: GetDataQualityRulesetInputBuilder) -> impl Future<Output = Result<GetDataQualityRulesetOutput, SdkError<GetDataQualityRulesetError>>> + Send;
    fn get_data_quality_ruleset_evaluation_run(&self, builder: GetDataQualityRulesetEvaluationRunInputBuilder) -> impl Future<Output = Result<GetDataQualityRulesetEvaluationRunOutput, SdkError<GetDataQualityRulesetEvaluationRunError>>> + Send;
    ...
    fn get_databases(&self, builder: GetDatabasesInputBuilder) -> impl Future<Output = Result<GetDatabasesOutput, SdkError<GetDatabasesError>>> + Send;
    fn get_dataflow_graph(&self, builder: GetDataflowGraphInputBuilder) -> impl Future<Output = Result<GetDataflowGraphOutput, SdkError<GetDataflowGraphError>>> + Send;
    fn get_dev_endpoint(&self, builder: GetDevEndpointInputBuilder) -> impl Future<Output = Result<GetDevEndpointOutput, SdkError<GetDevEndpointError>>> + Send;
    fn get_dev_endpoints(&self, builder: GetDevEndpointsInputBuilder) -> impl Future<Output = Result<GetDevEndpointsOutput, SdkError<GetDevEndpointsError>>> + Send;
    fn get_job(&self, builder: GetJobInputBuilder) -> impl Future<Output = Result<GetJobOutput, SdkError<GetJobError>>> + Send;
    fn get_job_bookmark(&self, builder: GetJobBookmarkInputBuilder) -> impl Future<Output = Result<GetJobBookmarkOutput, SdkError<GetJobBookmarkError>>> + Send;
    fn get_job_run(&self, builder: GetJobRunInputBuilder) -> impl Future<Output = Result<GetJobRunOutput, SdkError<GetJobRunError>>> + Send;
    fn get_job_runs(&self, builder: GetJobRunsInputBuilder) -> impl Future<Output = Result<GetJobRunsOutput, SdkError<GetJobRunsError>>> + Send;
    fn get_jobs(&self, builder: GetJobsInputBuilder) -> impl Future<Output = Result<GetJobsOutput, SdkError<GetJobsError>>> + Send;
    fn get_mapping(&self, builder: GetMappingInputBuilder) -> impl Future<Output = Result<GetMappingOutput, SdkError<GetMappingError>>> + Send;
    fn get_ml_task_run(&self, builder: GetMlTaskRunInputBuilder) -> impl Future<Output = Result<GetMlTaskRunOutput, SdkError<GetMLTaskRunError>>> + Send;
    fn get_ml_task_runs(&self, builder: GetMlTaskRunsInputBuilder) -> impl Future<Output = Result<GetMlTaskRunsOutput, SdkError<GetMLTaskRunsError>>> + Send;
    fn get_ml_transform(&self, builder: GetMlTransformInputBuilder) -> impl Future<Output = Result<GetMlTransformOutput, SdkError<GetMLTransformError>>> + Send;
    fn get_ml_transforms(&self, builder: GetMlTransformsInputBuilder) -> impl Future<Output = Result<GetMlTransformsOutput, SdkError<GetMLTransformsError>>> + Send;
    fn get_partition(&self, builder: GetPartitionInputBuilder) -> impl Future<Output = Result<GetPartitionOutput, SdkError<GetPartitionError>>> + Send;
    fn get_partition_indexes(&self, builder: GetPartitionIndexesInputBuilder) -> impl Future<Output = Result<GetPartitionIndexesOutput, SdkError<GetPartitionIndexesError>>> + Send;
    fn get_partitions(&self, builder: GetPartitionsInputBuilder) -> impl Future<Output = Result<GetPartitionsOutput, SdkError<GetPartitionsError>>> + Send;
    fn get_plan(&self, builder: GetPlanInputBuilder) -> impl Future<Output = Result<GetPlanOutput, SdkError<GetPlanError>>> + Send;
    fn get_registry(&self, builder: GetRegistryInputBuilder) -> impl Future<Output = Result<GetRegistryOutput, SdkError<GetRegistryError>>> + Send;
    ...
    fn get_schema(&self, builder: GetSchemaInputBuilder) -> impl Future<Output = Result<GetSchemaOutput, SdkError<GetSchemaError>>> + Send;
    fn get_schema_by_definition(&self, builder: GetSchemaByDefinitionInputBuilder) -> impl Future<Output = Result<GetSchemaByDefinitionOutput, SdkError<GetSchemaByDefinitionError>>> + Send;
    fn get_schema_version(&self, builder: GetSchemaVersionInputBuilder) -> impl Future<Output = Result<GetSchemaVersionOutput, SdkError<GetSchemaVersionError>>> + Send;
    fn get_schema_versions_diff(&self, builder: GetSchemaVersionsDiffInputBuilder) -> impl Future<Output = Result<GetSchemaVersionsDiffOutput, SdkError<GetSchemaVersionsDiffError>>> + Send;
    fn get_security_configuration(&self, builder: GetSecurityConfigurationInputBuilder) -> impl Future<Output = Result<GetSecurityConfigurationOutput, SdkError<GetSecurityConfigurationError>>> + Send;
    fn get_security_configurations(&self, builder: GetSecurityConfigurationsInputBuilder) -> impl Future<Output = Result<GetSecurityConfigurationsOutput, SdkError<GetSecurityConfigurationsError>>> + Send;
    ...
    fn get_statement(&self, builder: GetStatementInputBuilder) -> impl Future<Output = Result<GetStatementOutput, SdkError<GetStatementError>>> + Send;
    fn get_table(&self, builder: GetTableInputBuilder) -> impl Future<Output = Result<GetTableOutput, SdkError<GetTableError>>> + Send;
    fn get_table_optimizer(&self, builder: GetTableOptimizerInputBuilder) -> impl Future<Output = Result<GetTableOptimizerOutput, SdkError<GetTableOptimizerError>>> + Send;
    fn get_table_version(&self, builder: GetTableVersionInputBuilder) -> impl Future<Output = Result<GetTableVersionOutput, SdkError<GetTableVersionError>>> + Send;
    fn get_table_versions(&self, builder: GetTableVersionsInputBuilder) -> impl Future<Output = Result<GetTableVersionsOutput, SdkError<GetTableVersionsError>>> + Send;
    fn get_tables(&self, builder: GetTablesInputBuilder) -> impl Future<Output = Result<GetTablesOutput, SdkError<GetTablesError>>> + Send;
    fn get_tags(&self, builder: GetTagsInputBuilder) -> impl Future<Output = Result<GetTagsOutput, SdkError<GetTagsError>>> + Send;
    fn get_trigger(&self, builder: GetTriggerInputBuilder) -> impl Future<Output = Result<GetTriggerOutput, SdkError<GetTriggerError>>> + Send;
    fn get_triggers(&self, builder: GetTriggersInputBuilder) -> impl Future<Output = Result<GetTriggersOutput, SdkError<GetTriggersError>>> + Send;
    fn get_unfiltered_partition_metadata(&self, builder: GetUnfilteredPartitionMetadataInputBuilder) -> impl Future<Output = Result<GetUnfilteredPartitionMetadataOutput, SdkError<GetUnfilteredPartitionMetadataError>>> + Send;
    fn get_unfiltered_partitions_metadata(&self, builder: GetUnfilteredPartitionsMetadataInputBuilder) -> impl Future<Output = Result<GetUnfilteredPartitionsMetadataOutput, SdkError<GetUnfilteredPartitionsMetadataError>>> + Send;
    fn get_unfiltered_table_metadata(&self, builder: GetUnfilteredTableMetadataInputBuilder) -> impl Future<Output = Result<GetUnfilteredTableMetadataOutput, SdkError<GetUnfilteredTableMetadataError>>> + Send;
    fn get_usage_profile(&self, builder: GetUsageProfileInputBuilder) -> impl Future<Output = Result<GetUsageProfileOutput, SdkError<GetUsageProfileError>>> + Send;
    fn get_user_defined_function(&self, builder: GetUserDefinedFunctionInputBuilder) -> impl Future<Output = Result<GetUserDefinedFunctionOutput, SdkError<GetUserDefinedFunctionError>>> + Send;
    fn get_user_defined_functions(&self, builder: GetUserDefinedFunctionsInputBuilder) -> impl Future<Output = Result<GetUserDefinedFunctionsOutput, SdkError<GetUserDefinedFunctionsError>>> + Send;
    fn get_workflow(&self, builder: GetWorkflowInputBuilder) -> impl Future<Output = Result<GetWorkflowOutput, SdkError<GetWorkflowError>>> + Send;
    fn get_workflow_run(&self, builder: GetWorkflowRunInputBuilder) -> impl Future<Output = Result<GetWorkflowRunOutput, SdkError<GetWorkflowRunError>>> + Send;
    fn get_workflow_run_properties(&self, builder: GetWorkflowRunPropertiesInputBuilder) -> impl Future<Output = Result<GetWorkflowRunPropertiesOutput, SdkError<GetWorkflowRunPropertiesError>>> + Send;
    fn get_workflow_runs(&self, builder: GetWorkflowRunsInputBuilder) -> impl Future<Output = Result<GetWorkflowRunsOutput, SdkError<GetWorkflowRunsError>>> + Send;
    fn import_catalog_to_glue(&self, builder: ImportCatalogToGlueInputBuilder) -> impl Future<Output = Result<ImportCatalogToGlueOutput, SdkError<ImportCatalogToGlueError>>> + Send;
    fn list_blueprints(&self, builder: ListBlueprintsInputBuilder) -> impl Future<Output = Result<ListBlueprintsOutput, SdkError<ListBlueprintsError>>> + Send;
    fn list_column_statistics_task_runs(&self, builder: ListColumnStatisticsTaskRunsInputBuilder) -> impl Future<Output = Result<ListColumnStatisticsTaskRunsOutput, SdkError<ListColumnStatisticsTaskRunsError>>> + Send;
    fn list_crawlers(&self, builder: ListCrawlersInputBuilder) -> impl Future<Output = Result<ListCrawlersOutput, SdkError<ListCrawlersError>>> + Send;
    fn list_crawls(&self, builder: ListCrawlsInputBuilder) -> impl Future<Output = Result<ListCrawlsOutput, SdkError<ListCrawlsError>>> + Send;
    fn list_custom_entity_types(&self, builder: ListCustomEntityTypesInputBuilder) -> impl Future<Output = Result<ListCustomEntityTypesOutput, SdkError<ListCustomEntityTypesError>>> + Send;
    fn list_data_quality_results(&self, builder: ListDataQualityResultsInputBuilder) -> impl Future<Output = Result<ListDataQualityResultsOutput, SdkError<ListDataQualityResultsError>>> + Send;
    fn list_data_quality_rule_recommendation_runs(&self, builder: ListDataQualityRuleRecommendationRunsInputBuilder) -> impl Future<Output = Result<ListDataQualityRuleRecommendationRunsOutput, SdkError<ListDataQualityRuleRecommendationRunsError>>> + Send;
    fn list_data_quality_ruleset_evaluation_runs(&self, builder: ListDataQualityRulesetEvaluationRunsInputBuilder) -> impl Future<Output = Result<ListDataQualityRulesetEvaluationRunsOutput, SdkError<ListDataQualityRulesetEvaluationRunsError>>> + Send;
    fn list_data_quality_rulesets(&self, builder: ListDataQualityRulesetsInputBuilder) -> impl Future<Output = Result<ListDataQualityRulesetsOutput, SdkError<ListDataQualityRulesetsError>>> + Send;
    fn list_dev_endpoints(&self, builder: ListDevEndpointsInputBuilder) -> impl Future<Output = Result<ListDevEndpointsOutput, SdkError<ListDevEndpointsError>>> + Send;
    fn list_jobs(&self, builder: ListJobsInputBuilder) -> impl Future<Output = Result<ListJobsOutput, SdkError<ListJobsError>>> + Send;
    fn list_ml_transforms(&self, builder: ListMlTransformsInputBuilder) -> impl Future<Output = Result<ListMlTransformsOutput, SdkError<ListMLTransformsError>>> + Send;
    fn list_registries(&self, builder: ListRegistriesInputBuilder) -> impl Future<Output = Result<ListRegistriesOutput, SdkError<ListRegistriesError>>> + Send;
    fn list_schema_versions(&self, builder: ListSchemaVersionsInputBuilder) -> impl Future<Output = Result<ListSchemaVersionsOutput, SdkError<ListSchemaVersionsError>>> + Send;
    fn list_schemas(&self, builder: ListSchemasInputBuilder) -> impl Future<Output = Result<ListSchemasOutput, SdkError<ListSchemasError>>> + Send;
    ...
    fn list_statements(&self, builder: ListStatementsInputBuilder) -> impl Future<Output = Result<ListStatementsOutput, SdkError<ListStatementsError>>> + Send;
    fn list_table_optimizer_runs(&self, builder: ListTableOptimizerRunsInputBuilder) -> impl Future<Output = Result<ListTableOptimizerRunsOutput, SdkError<ListTableOptimizerRunsError>>> + Send;
    fn list_triggers(&self, builder: ListTriggersInputBuilder) -> impl Future<Output = Result<ListTriggersOutput, SdkError<ListTriggersError>>> + Send;
    fn list_usage_profiles(&self, builder: ListUsageProfilesInputBuilder) -> impl Future<Output = Result<ListUsageProfilesOutput, SdkError<ListUsageProfilesError>>> + Send;
    fn list_workflows(&self, builder: ListWorkflowsInputBuilder) -> impl Future<Output = Result<ListWorkflowsOutput, SdkError<ListWorkflowsError>>> + Send;
    fn put_data_catalog_encryption_settings(&self, builder: PutDataCatalogEncryptionSettingsInputBuilder) -> impl Future<Output = Result<PutDataCatalogEncryptionSettingsOutput, SdkError<PutDataCatalogEncryptionSettingsError>>> + Send;
    ...
    fn put_schema_version_metadata(&self, builder: PutSchemaVersionMetadataInputBuilder) -> impl Future<Output = Result<PutSchemaVersionMetadataOutput, SdkError<PutSchemaVersionMetadataError>>> + Send;
    fn put_workflow_run_properties(&self, builder: PutWorkflowRunPropertiesInputBuilder) -> impl Future<Output = Result<PutWorkflowRunPropertiesOutput, SdkError<PutWorkflowRunPropertiesError>>> + Send;
    fn query_schema_version_metadata(&self, builder: QuerySchemaVersionMetadataInputBuilder) -> impl Future<Output = Result<QuerySchemaVersionMetadataOutput, SdkError<QuerySchemaVersionMetadataError>>> + Send;
    fn register_schema_version(&self, builder: RegisterSchemaVersionInputBuilder) -> impl Future<Output = Result<RegisterSchemaVersionOutput, SdkError<RegisterSchemaVersionError>>> + Send;
    fn remove_schema_version_metadata(&self, builder: RemoveSchemaVersionMetadataInputBuilder) -> impl Future<Output = Result<RemoveSchemaVersionMetadataOutput, SdkError<RemoveSchemaVersionMetadataError>>> + Send;
    fn reset_job_bookmark(&self, builder: ResetJobBookmarkInputBuilder) -> impl Future<Output = Result<ResetJobBookmarkOutput, SdkError<ResetJobBookmarkError>>> + Send;
    fn resume_workflow_run(&self, builder: ResumeWorkflowRunInputBuilder) -> impl Future<Output = Result<ResumeWorkflowRunOutput, SdkError<ResumeWorkflowRunError>>> + Send;
    fn run_statement(&self, builder: RunStatementInputBuilder) -> impl Future<Output = Result<RunStatementOutput, SdkError<RunStatementError>>> + Send;
    fn search_tables(&self, builder: SearchTablesInputBuilder) -> impl Future<Output = Result<SearchTablesOutput, SdkError<SearchTablesError>>> + Send;
    fn start_blueprint_run(&self, builder: StartBlueprintRunInputBuilder) -> impl Future<Output = Result<StartBlueprintRunOutput, SdkError<StartBlueprintRunError>>> + Send;
    fn start_column_statistics_task_run(&self, builder: StartColumnStatisticsTaskRunInputBuilder) -> impl Future<Output = Result<StartColumnStatisticsTaskRunOutput, SdkError<StartColumnStatisticsTaskRunError>>> + Send;
    fn start_crawler(&self, builder: StartCrawlerInputBuilder) -> impl Future<Output = Result<StartCrawlerOutput, SdkError<StartCrawlerError>>> + Send;
    fn start_crawler_schedule(&self, builder: StartCrawlerScheduleInputBuilder) -> impl Future<Output = Result<StartCrawlerScheduleOutput, SdkError<StartCrawlerScheduleError>>> + Send;
    fn start_data_quality_rule_recommendation_run(&self, builder: StartDataQualityRuleRecommendationRunInputBuilder) -> impl Future<Output = Result<StartDataQualityRuleRecommendationRunOutput, SdkError<StartDataQualityRuleRecommendationRunError>>> + Send;
    fn start_data_quality_ruleset_evaluation_run(&self, builder: StartDataQualityRulesetEvaluationRunInputBuilder) -> impl Future<Output = Result<StartDataQualityRulesetEvaluationRunOutput, SdkError<StartDataQualityRulesetEvaluationRunError>>> + Send;
    fn start_export_labels_task_run(&self, builder: StartExportLabelsTaskRunInputBuilder) -> impl Future<Output = Result<StartExportLabelsTaskRunOutput, SdkError<StartExportLabelsTaskRunError>>> + Send;
    fn start_import_labels_task_run(&self, builder: StartImportLabelsTaskRunInputBuilder) -> impl Future<Output = Result<StartImportLabelsTaskRunOutput, SdkError<StartImportLabelsTaskRunError>>> + Send;
    fn start_job_run(&self, builder: StartJobRunInputBuilder) -> impl Future<Output = Result<StartJobRunOutput, SdkError<StartJobRunError>>> + Send;
    fn start_ml_evaluation_task_run(&self, builder: StartMlEvaluationTaskRunInputBuilder) -> impl Future<Output = Result<StartMlEvaluationTaskRunOutput, SdkError<StartMLEvaluationTaskRunError>>> + Send;
    fn start_ml_labeling_set_generation_task_run(&self, builder: StartMlLabelingSetGenerationTaskRunInputBuilder) -> impl Future<Output = Result<StartMlLabelingSetGenerationTaskRunOutput, SdkError<StartMLLabelingSetGenerationTaskRunError>>> + Send;
    fn start_trigger(&self, builder: StartTriggerInputBuilder) -> impl Future<Output = Result<StartTriggerOutput, SdkError<StartTriggerError>>> + Send;
    fn start_workflow_run(&self, builder: StartWorkflowRunInputBuilder) -> impl Future<Output = Result<StartWorkflowRunOutput, SdkError<StartWorkflowRunError>>> + Send;
    fn stop_column_statistics_task_run(&self, builder: StopColumnStatisticsTaskRunInputBuilder) -> impl Future<Output = Result<StopColumnStatisticsTaskRunOutput, SdkError<StopColumnStatisticsTaskRunError>>> + Send;
    fn stop_crawler(&self, builder: StopCrawlerInputBuilder) -> impl Future<Output = Result<StopCrawlerOutput, SdkError<StopCrawlerError>>> + Send;
    fn stop_crawler_schedule(&self, builder: StopCrawlerScheduleInputBuilder) -> impl Future<Output = Result<StopCrawlerScheduleOutput, SdkError<StopCrawlerScheduleError>>> + Send;
    fn stop_session(&self, builder: StopSessionInputBuilder) -> impl Future<Output = Result<StopSessionOutput, SdkError<StopSessionError>>> + Send;
    fn stop_trigger(&self, builder: StopTriggerInputBuilder) -> impl Future<Output = Result<StopTriggerOutput, SdkError<StopTriggerError>>> + Send;
    fn stop_workflow_run(&self, builder: StopWorkflowRunInputBuilder) -> impl Future<Output = Result<StopWorkflowRunOutput, SdkError<StopWorkflowRunError>>> + Send;
    ...
    fn update_blueprint(&self, builder: UpdateBlueprintInputBuilder) -> impl Future<Output = Result<UpdateBlueprintOutput, SdkError<UpdateBlueprintError>>> + Send;
    fn update_classifier(&self, builder: UpdateClassifierInputBuilder) -> impl Future<Output = Result<UpdateClassifierOutput, SdkError<UpdateClassifierError>>> + Send;
    fn update_column_statistics_for_partition(&self, builder: UpdateColumnStatisticsForPartitionInputBuilder) -> impl Future<Output = Result<UpdateColumnStatisticsForPartitionOutput, SdkError<UpdateColumnStatisticsForPartitionError>>> + Send;
    fn update_column_statistics_for_table(&self, builder: UpdateColumnStatisticsForTableInputBuilder) -> impl Future<Output = Result<UpdateColumnStatisticsForTableOutput, SdkError<UpdateColumnStatisticsForTableError>>> + Send;
    ...
    fn update_crawler(&self, builder: UpdateCrawlerInputBuilder) -> impl Future<Output = Result<UpdateCrawlerOutput, SdkError<UpdateCrawlerError>>> + Send;
    fn update_crawler_schedule(&self, builder: UpdateCrawlerScheduleInputBuilder) -> impl Future<Output = Result<UpdateCrawlerScheduleOutput, SdkError<UpdateCrawlerScheduleError>>> + Send;
    fn update_data_quality_ruleset(&self, builder: UpdateDataQualityRulesetInputBuilder) -> impl Future<Output = Result<UpdateDataQualityRulesetOutput, SdkError<UpdateDataQualityRulesetError>>> + Send;
    fn update_database(&self, builder: UpdateDatabaseInputBuilder) -> impl Future<Output = Result<UpdateDatabaseOutput, SdkError<UpdateDatabaseError>>> + Send;
    fn update_dev_endpoint(&self, builder: UpdateDevEndpointInputBuilder) -> impl Future<Output = Result<UpdateDevEndpointOutput, SdkError<UpdateDevEndpointError>>> + Send;
    fn update_job(&self, builder: UpdateJobInputBuilder) -> impl Future<Output = Result<UpdateJobOutput, SdkError<UpdateJobError>>> + Send;
    fn update_job_from_source_control(&self, builder: UpdateJobFromSourceControlInputBuilder) -> impl Future<Output = Result<UpdateJobFromSourceControlOutput, SdkError<UpdateJobFromSourceControlError>>> + Send;
    fn update_ml_transform(&self, builder: UpdateMlTransformInputBuilder) -> impl Future<Output = Result<UpdateMlTransformOutput, SdkError<UpdateMLTransformError>>> + Send;
    fn update_partition(&self, builder: UpdatePartitionInputBuilder) -> impl Future<Output = Result<UpdatePartitionOutput, SdkError<UpdatePartitionError>>> + Send;
    fn update_registry(&self, builder: UpdateRegistryInputBuilder) -> impl Future<Output = Result<UpdateRegistryOutput, SdkError<UpdateRegistryError>>> + Send;
    fn update_schema(&self, builder: UpdateSchemaInputBuilder) -> impl Future<Output = Result<UpdateSchemaOutput, SdkError<UpdateSchemaError>>> + Send;
    fn update_source_control_from_job(&self, builder: UpdateSourceControlFromJobInputBuilder) -> impl Future<Output = Result<UpdateSourceControlFromJobOutput, SdkError<UpdateSourceControlFromJobError>>> + Send;
    fn update_table(&self, builder: UpdateTableInputBuilder) -> impl Future<Output = Result<UpdateTableOutput, SdkError<UpdateTableError>>> + Send;
    fn update_table_optimizer(&self, builder: UpdateTableOptimizerInputBuilder) -> impl Future<Output = Result<UpdateTableOptimizerOutput, SdkError<UpdateTableOptimizerError>>> + Send;
    fn update_trigger(&self, builder: UpdateTriggerInputBuilder) -> impl Future<Output = Result<UpdateTriggerOutput, SdkError<UpdateTriggerError>>> + Send;
    fn update_usage_profile(&self, builder: UpdateUsageProfileInputBuilder) -> impl Future<Output = Result<UpdateUsageProfileOutput, SdkError<UpdateUsageProfileError>>> + Send;
    fn update_user_defined_function(&self, builder: UpdateUserDefinedFunctionInputBuilder) -> impl Future<Output = Result<UpdateUserDefinedFunctionOutput, SdkError<UpdateUserDefinedFunctionError>>> + Send;
    fn update_workflow(&self, builder: UpdateWorkflowInputBuilder) -> impl Future<Output = Result<UpdateWorkflowOutput, SdkError<UpdateWorkflowError>>> + Send;
}

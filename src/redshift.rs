...
pub trait RedshiftClient {
    fn accept_reserved_node_exchange(&self, builder: AcceptReservedNodeExchangeInputBuilder) -> impl Future<Output = Result<AcceptReservedNodeExchangeOutput, SdkError<AcceptReservedNodeExchangeError>>> + Send;
    fn add_partner(&self, builder: AddPartnerInputBuilder) -> impl Future<Output = Result<AddPartnerOutput, SdkError<AddPartnerError>>> + Send;
    fn associate_data_share_consumer(&self, builder: AssociateDataShareConsumerInputBuilder) -> impl Future<Output = Result<AssociateDataShareConsumerOutput, SdkError<AssociateDataShareConsumerError>>> + Send;
    fn authorize_cluster_security_group_ingress(&self, builder: AuthorizeClusterSecurityGroupIngressInputBuilder) -> impl Future<Output = Result<AuthorizeClusterSecurityGroupIngressOutput, SdkError<AuthorizeClusterSecurityGroupIngressError>>> + Send;
    fn authorize_data_share(&self, builder: AuthorizeDataShareInputBuilder) -> impl Future<Output = Result<AuthorizeDataShareOutput, SdkError<AuthorizeDataShareError>>> + Send;
    fn authorize_endpoint_access(&self, builder: AuthorizeEndpointAccessInputBuilder) -> impl Future<Output = Result<AuthorizeEndpointAccessOutput, SdkError<AuthorizeEndpointAccessError>>> + Send;
    fn authorize_snapshot_access(&self, builder: AuthorizeSnapshotAccessInputBuilder) -> impl Future<Output = Result<AuthorizeSnapshotAccessOutput, SdkError<AuthorizeSnapshotAccessError>>> + Send;
    fn batch_delete_cluster_snapshots(&self, builder: BatchDeleteClusterSnapshotsInputBuilder) -> impl Future<Output = Result<BatchDeleteClusterSnapshotsOutput, SdkError<BatchDeleteClusterSnapshotsError>>> + Send;
    fn batch_modify_cluster_snapshots(&self, builder: BatchModifyClusterSnapshotsInputBuilder) -> impl Future<Output = Result<BatchModifyClusterSnapshotsOutput, SdkError<BatchModifyClusterSnapshotsError>>> + Send;
    fn cancel_resize(&self, builder: CancelResizeInputBuilder) -> impl Future<Output = Result<CancelResizeOutput, SdkError<CancelResizeError>>> + Send;
    fn copy_cluster_snapshot(&self, builder: CopyClusterSnapshotInputBuilder) -> impl Future<Output = Result<CopyClusterSnapshotOutput, SdkError<CopyClusterSnapshotError>>> + Send;
    fn create_authentication_profile(&self, builder: CreateAuthenticationProfileInputBuilder) -> impl Future<Output = Result<CreateAuthenticationProfileOutput, SdkError<CreateAuthenticationProfileError>>> + Send;
    ...
    fn create_cluster_parameter_group(&self, builder: CreateClusterParameterGroupInputBuilder) -> impl Future<Output = Result<CreateClusterParameterGroupOutput, SdkError<CreateClusterParameterGroupError>>> + Send;
    fn create_cluster_security_group(&self, builder: CreateClusterSecurityGroupInputBuilder) -> impl Future<Output = Result<CreateClusterSecurityGroupOutput, SdkError<CreateClusterSecurityGroupError>>> + Send;
    fn create_cluster_snapshot(&self, builder: CreateClusterSnapshotInputBuilder) -> impl Future<Output = Result<CreateClusterSnapshotOutput, SdkError<CreateClusterSnapshotError>>> + Send;
    fn create_cluster_subnet_group(&self, builder: CreateClusterSubnetGroupInputBuilder) -> impl Future<Output = Result<CreateClusterSubnetGroupOutput, SdkError<CreateClusterSubnetGroupError>>> + Send;
    fn create_custom_domain_association(&self, builder: CreateCustomDomainAssociationInputBuilder) -> impl Future<Output = Result<CreateCustomDomainAssociationOutput, SdkError<CreateCustomDomainAssociationError>>> + Send;
    fn create_endpoint_access(&self, builder: CreateEndpointAccessInputBuilder) -> impl Future<Output = Result<CreateEndpointAccessOutput, SdkError<CreateEndpointAccessError>>> + Send;
    ...
    fn create_hsm_client_certificate(&self, builder: CreateHsmClientCertificateInputBuilder) -> impl Future<Output = Result<CreateHsmClientCertificateOutput, SdkError<CreateHsmClientCertificateError>>> + Send;
    fn create_hsm_configuration(&self, builder: CreateHsmConfigurationInputBuilder) -> impl Future<Output = Result<CreateHsmConfigurationOutput, SdkError<CreateHsmConfigurationError>>> + Send;
    fn create_redshift_idc_application(&self, builder: CreateRedshiftIdcApplicationInputBuilder) -> impl Future<Output = Result<CreateRedshiftIdcApplicationOutput, SdkError<CreateRedshiftIdcApplicationError>>> + Send;
    fn create_scheduled_action(&self, builder: CreateScheduledActionInputBuilder) -> impl Future<Output = Result<CreateScheduledActionOutput, SdkError<CreateScheduledActionError>>> + Send;
    fn create_snapshot_copy_grant(&self, builder: CreateSnapshotCopyGrantInputBuilder) -> impl Future<Output = Result<CreateSnapshotCopyGrantOutput, SdkError<CreateSnapshotCopyGrantError>>> + Send;
    fn create_snapshot_schedule(&self, builder: CreateSnapshotScheduleInputBuilder) -> impl Future<Output = Result<CreateSnapshotScheduleOutput, SdkError<CreateSnapshotScheduleError>>> + Send;
    ...
    fn create_usage_limit(&self, builder: CreateUsageLimitInputBuilder) -> impl Future<Output = Result<CreateUsageLimitOutput, SdkError<CreateUsageLimitError>>> + Send;
    fn deauthorize_data_share(&self, builder: DeauthorizeDataShareInputBuilder) -> impl Future<Output = Result<DeauthorizeDataShareOutput, SdkError<DeauthorizeDataShareError>>> + Send;
    fn delete_authentication_profile(&self, builder: DeleteAuthenticationProfileInputBuilder) -> impl Future<Output = Result<DeleteAuthenticationProfileOutput, SdkError<DeleteAuthenticationProfileError>>> + Send;
    ...
    fn delete_cluster_parameter_group(&self, builder: DeleteClusterParameterGroupInputBuilder) -> impl Future<Output = Result<DeleteClusterParameterGroupOutput, SdkError<DeleteClusterParameterGroupError>>> + Send;
    fn delete_cluster_security_group(&self, builder: DeleteClusterSecurityGroupInputBuilder) -> impl Future<Output = Result<DeleteClusterSecurityGroupOutput, SdkError<DeleteClusterSecurityGroupError>>> + Send;
    fn delete_cluster_snapshot(&self, builder: DeleteClusterSnapshotInputBuilder) -> impl Future<Output = Result<DeleteClusterSnapshotOutput, SdkError<DeleteClusterSnapshotError>>> + Send;
    fn delete_cluster_subnet_group(&self, builder: DeleteClusterSubnetGroupInputBuilder) -> impl Future<Output = Result<DeleteClusterSubnetGroupOutput, SdkError<DeleteClusterSubnetGroupError>>> + Send;
    fn delete_custom_domain_association(&self, builder: DeleteCustomDomainAssociationInputBuilder) -> impl Future<Output = Result<DeleteCustomDomainAssociationOutput, SdkError<DeleteCustomDomainAssociationError>>> + Send;
    fn delete_endpoint_access(&self, builder: DeleteEndpointAccessInputBuilder) -> impl Future<Output = Result<DeleteEndpointAccessOutput, SdkError<DeleteEndpointAccessError>>> + Send;
    ...
    fn delete_hsm_client_certificate(&self, builder: DeleteHsmClientCertificateInputBuilder) -> impl Future<Output = Result<DeleteHsmClientCertificateOutput, SdkError<DeleteHsmClientCertificateError>>> + Send;
    fn delete_hsm_configuration(&self, builder: DeleteHsmConfigurationInputBuilder) -> impl Future<Output = Result<DeleteHsmConfigurationOutput, SdkError<DeleteHsmConfigurationError>>> + Send;
    fn delete_partner(&self, builder: DeletePartnerInputBuilder) -> impl Future<Output = Result<DeletePartnerOutput, SdkError<DeletePartnerError>>> + Send;
    fn delete_redshift_idc_application(&self, builder: DeleteRedshiftIdcApplicationInputBuilder) -> impl Future<Output = Result<DeleteRedshiftIdcApplicationOutput, SdkError<DeleteRedshiftIdcApplicationError>>> + Send;
    ...
    fn delete_scheduled_action(&self, builder: DeleteScheduledActionInputBuilder) -> impl Future<Output = Result<DeleteScheduledActionOutput, SdkError<DeleteScheduledActionError>>> + Send;
    fn delete_snapshot_copy_grant(&self, builder: DeleteSnapshotCopyGrantInputBuilder) -> impl Future<Output = Result<DeleteSnapshotCopyGrantOutput, SdkError<DeleteSnapshotCopyGrantError>>> + Send;
    fn delete_snapshot_schedule(&self, builder: DeleteSnapshotScheduleInputBuilder) -> impl Future<Output = Result<DeleteSnapshotScheduleOutput, SdkError<DeleteSnapshotScheduleError>>> + Send;
    ...
    fn delete_usage_limit(&self, builder: DeleteUsageLimitInputBuilder) -> impl Future<Output = Result<DeleteUsageLimitOutput, SdkError<DeleteUsageLimitError>>> + Send;
    ...
    fn describe_authentication_profiles(&self, builder: DescribeAuthenticationProfilesInputBuilder) -> impl Future<Output = Result<DescribeAuthenticationProfilesOutput, SdkError<DescribeAuthenticationProfilesError>>> + Send;
    fn describe_cluster_db_revisions(&self, builder: DescribeClusterDbRevisionsInputBuilder) -> impl Future<Output = Result<DescribeClusterDbRevisionsOutput, SdkError<DescribeClusterDbRevisionsError>>> + Send;
    fn describe_cluster_parameter_groups(&self, builder: DescribeClusterParameterGroupsInputBuilder) -> impl Future<Output = Result<DescribeClusterParameterGroupsOutput, SdkError<DescribeClusterParameterGroupsError>>> + Send;
    fn describe_cluster_parameters(&self, builder: DescribeClusterParametersInputBuilder) -> impl Future<Output = Result<DescribeClusterParametersOutput, SdkError<DescribeClusterParametersError>>> + Send;
    fn describe_cluster_security_groups(&self, builder: DescribeClusterSecurityGroupsInputBuilder) -> impl Future<Output = Result<DescribeClusterSecurityGroupsOutput, SdkError<DescribeClusterSecurityGroupsError>>> + Send;
    fn describe_cluster_snapshots(&self, builder: DescribeClusterSnapshotsInputBuilder) -> impl Future<Output = Result<DescribeClusterSnapshotsOutput, SdkError<DescribeClusterSnapshotsError>>> + Send;
    fn describe_cluster_subnet_groups(&self, builder: DescribeClusterSubnetGroupsInputBuilder) -> impl Future<Output = Result<DescribeClusterSubnetGroupsOutput, SdkError<DescribeClusterSubnetGroupsError>>> + Send;
    fn describe_cluster_tracks(&self, builder: DescribeClusterTracksInputBuilder) -> impl Future<Output = Result<DescribeClusterTracksOutput, SdkError<DescribeClusterTracksError>>> + Send;
    fn describe_cluster_versions(&self, builder: DescribeClusterVersionsInputBuilder) -> impl Future<Output = Result<DescribeClusterVersionsOutput, SdkError<DescribeClusterVersionsError>>> + Send;
    fn describe_clusters(&self, builder: DescribeClustersInputBuilder) -> impl Future<Output = Result<DescribeClustersOutput, SdkError<DescribeClustersError>>> + Send;
    fn describe_custom_domain_associations(&self, builder: DescribeCustomDomainAssociationsInputBuilder) -> impl Future<Output = Result<DescribeCustomDomainAssociationsOutput, SdkError<DescribeCustomDomainAssociationsError>>> + Send;
    fn describe_data_shares(&self, builder: DescribeDataSharesInputBuilder) -> impl Future<Output = Result<DescribeDataSharesOutput, SdkError<DescribeDataSharesError>>> + Send;
    fn describe_data_shares_for_consumer(&self, builder: DescribeDataSharesForConsumerInputBuilder) -> impl Future<Output = Result<DescribeDataSharesForConsumerOutput, SdkError<DescribeDataSharesForConsumerError>>> + Send;
    fn describe_data_shares_for_producer(&self, builder: DescribeDataSharesForProducerInputBuilder) -> impl Future<Output = Result<DescribeDataSharesForProducerOutput, SdkError<DescribeDataSharesForProducerError>>> + Send;
    fn describe_default_cluster_parameters(&self, builder: DescribeDefaultClusterParametersInputBuilder) -> impl Future<Output = Result<DescribeDefaultClusterParametersOutput, SdkError<DescribeDefaultClusterParametersError>>> + Send;
    fn describe_endpoint_access(&self, builder: DescribeEndpointAccessInputBuilder) -> impl Future<Output = Result<DescribeEndpointAccessOutput, SdkError<DescribeEndpointAccessError>>> + Send;
    fn describe_endpoint_authorization(&self, builder: DescribeEndpointAuthorizationInputBuilder) -> impl Future<Output = Result<DescribeEndpointAuthorizationOutput, SdkError<DescribeEndpointAuthorizationError>>> + Send;
    ...
    fn describe_hsm_client_certificates(&self, builder: DescribeHsmClientCertificatesInputBuilder) -> impl Future<Output = Result<DescribeHsmClientCertificatesOutput, SdkError<DescribeHsmClientCertificatesError>>> + Send;
    fn describe_hsm_configurations(&self, builder: DescribeHsmConfigurationsInputBuilder) -> impl Future<Output = Result<DescribeHsmConfigurationsOutput, SdkError<DescribeHsmConfigurationsError>>> + Send;
    fn describe_inbound_integrations(&self, builder: DescribeInboundIntegrationsInputBuilder) -> impl Future<Output = Result<DescribeInboundIntegrationsOutput, SdkError<DescribeInboundIntegrationsError>>> + Send;
    fn describe_logging_status(&self, builder: DescribeLoggingStatusInputBuilder) -> impl Future<Output = Result<DescribeLoggingStatusOutput, SdkError<DescribeLoggingStatusError>>> + Send;
    fn describe_node_configuration_options(&self, builder: DescribeNodeConfigurationOptionsInputBuilder) -> impl Future<Output = Result<DescribeNodeConfigurationOptionsOutput, SdkError<DescribeNodeConfigurationOptionsError>>> + Send;
    fn describe_orderable_cluster_options(&self, builder: DescribeOrderableClusterOptionsInputBuilder) -> impl Future<Output = Result<DescribeOrderableClusterOptionsOutput, SdkError<DescribeOrderableClusterOptionsError>>> + Send;
    fn describe_partners(&self, builder: DescribePartnersInputBuilder) -> impl Future<Output = Result<DescribePartnersOutput, SdkError<DescribePartnersError>>> + Send;
    fn describe_redshift_idc_applications(&self, builder: DescribeRedshiftIdcApplicationsInputBuilder) -> impl Future<Output = Result<DescribeRedshiftIdcApplicationsOutput, SdkError<DescribeRedshiftIdcApplicationsError>>> + Send;
    fn describe_reserved_node_exchange_status(&self, builder: DescribeReservedNodeExchangeStatusInputBuilder) -> impl Future<Output = Result<DescribeReservedNodeExchangeStatusOutput, SdkError<DescribeReservedNodeExchangeStatusError>>> + Send;
    fn describe_reserved_node_offerings(&self, builder: DescribeReservedNodeOfferingsInputBuilder) -> impl Future<Output = Result<DescribeReservedNodeOfferingsOutput, SdkError<DescribeReservedNodeOfferingsError>>> + Send;
    fn describe_reserved_nodes(&self, builder: DescribeReservedNodesInputBuilder) -> impl Future<Output = Result<DescribeReservedNodesOutput, SdkError<DescribeReservedNodesError>>> + Send;
    fn describe_resize(&self, builder: DescribeResizeInputBuilder) -> impl Future<Output = Result<DescribeResizeOutput, SdkError<DescribeResizeError>>> + Send;
    fn describe_scheduled_actions(&self, builder: DescribeScheduledActionsInputBuilder) -> impl Future<Output = Result<DescribeScheduledActionsOutput, SdkError<DescribeScheduledActionsError>>> + Send;
    fn describe_snapshot_copy_grants(&self, builder: DescribeSnapshotCopyGrantsInputBuilder) -> impl Future<Output = Result<DescribeSnapshotCopyGrantsOutput, SdkError<DescribeSnapshotCopyGrantsError>>> + Send;
    fn describe_snapshot_schedules(&self, builder: DescribeSnapshotSchedulesInputBuilder) -> impl Future<Output = Result<DescribeSnapshotSchedulesOutput, SdkError<DescribeSnapshotSchedulesError>>> + Send;
    fn describe_storage(&self, builder: DescribeStorageInputBuilder) -> impl Future<Output = Result<DescribeStorageOutput, SdkError<DescribeStorageError>>> + Send;
    fn describe_table_restore_status(&self, builder: DescribeTableRestoreStatusInputBuilder) -> impl Future<Output = Result<DescribeTableRestoreStatusOutput, SdkError<DescribeTableRestoreStatusError>>> + Send;
    ...
    fn describe_usage_limits(&self, builder: DescribeUsageLimitsInputBuilder) -> impl Future<Output = Result<DescribeUsageLimitsOutput, SdkError<DescribeUsageLimitsError>>> + Send;
    fn disable_logging(&self, builder: DisableLoggingInputBuilder) -> impl Future<Output = Result<DisableLoggingOutput, SdkError<DisableLoggingError>>> + Send;
    fn disable_snapshot_copy(&self, builder: DisableSnapshotCopyInputBuilder) -> impl Future<Output = Result<DisableSnapshotCopyOutput, SdkError<DisableSnapshotCopyError>>> + Send;
    fn disassociate_data_share_consumer(&self, builder: DisassociateDataShareConsumerInputBuilder) -> impl Future<Output = Result<DisassociateDataShareConsumerOutput, SdkError<DisassociateDataShareConsumerError>>> + Send;
    fn enable_logging(&self, builder: EnableLoggingInputBuilder) -> impl Future<Output = Result<EnableLoggingOutput, SdkError<EnableLoggingError>>> + Send;
    fn enable_snapshot_copy(&self, builder: EnableSnapshotCopyInputBuilder) -> impl Future<Output = Result<EnableSnapshotCopyOutput, SdkError<EnableSnapshotCopyError>>> + Send;
    fn failover_primary_compute(&self, builder: FailoverPrimaryComputeInputBuilder) -> impl Future<Output = Result<FailoverPrimaryComputeOutput, SdkError<FailoverPrimaryComputeError>>> + Send;
    fn get_cluster_credentials(&self, builder: GetClusterCredentialsInputBuilder) -> impl Future<Output = Result<GetClusterCredentialsOutput, SdkError<GetClusterCredentialsError>>> + Send;
    fn get_cluster_credentials_with_iam(&self, builder: GetClusterCredentialsWithIamInputBuilder) -> impl Future<Output = Result<GetClusterCredentialsWithIamOutput, SdkError<GetClusterCredentialsWithIAMError>>> + Send;
    fn get_reserved_node_exchange_configuration_options(&self, builder: GetReservedNodeExchangeConfigurationOptionsInputBuilder) -> impl Future<Output = Result<GetReservedNodeExchangeConfigurationOptionsOutput, SdkError<GetReservedNodeExchangeConfigurationOptionsError>>> + Send;
    fn get_reserved_node_exchange_offerings(&self, builder: GetReservedNodeExchangeOfferingsInputBuilder) -> impl Future<Output = Result<GetReservedNodeExchangeOfferingsOutput, SdkError<GetReservedNodeExchangeOfferingsError>>> + Send;
    ...
    fn list_recommendations(&self, builder: ListRecommendationsInputBuilder) -> impl Future<Output = Result<ListRecommendationsOutput, SdkError<ListRecommendationsError>>> + Send;
    fn modify_aqua_configuration(&self, builder: ModifyAquaConfigurationInputBuilder) -> impl Future<Output = Result<ModifyAquaConfigurationOutput, SdkError<ModifyAquaConfigurationError>>> + Send;
    fn modify_authentication_profile(&self, builder: ModifyAuthenticationProfileInputBuilder) -> impl Future<Output = Result<ModifyAuthenticationProfileOutput, SdkError<ModifyAuthenticationProfileError>>> + Send;
    ...
    fn modify_cluster_db_revision(&self, builder: ModifyClusterDbRevisionInputBuilder) -> impl Future<Output = Result<ModifyClusterDbRevisionOutput, SdkError<ModifyClusterDbRevisionError>>> + Send;
    fn modify_cluster_iam_roles(&self, builder: ModifyClusterIamRolesInputBuilder) -> impl Future<Output = Result<ModifyClusterIamRolesOutput, SdkError<ModifyClusterIamRolesError>>> + Send;
    fn modify_cluster_maintenance(&self, builder: ModifyClusterMaintenanceInputBuilder) -> impl Future<Output = Result<ModifyClusterMaintenanceOutput, SdkError<ModifyClusterMaintenanceError>>> + Send;
    fn modify_cluster_parameter_group(&self, builder: ModifyClusterParameterGroupInputBuilder) -> impl Future<Output = Result<ModifyClusterParameterGroupOutput, SdkError<ModifyClusterParameterGroupError>>> + Send;
    fn modify_cluster_snapshot(&self, builder: ModifyClusterSnapshotInputBuilder) -> impl Future<Output = Result<ModifyClusterSnapshotOutput, SdkError<ModifyClusterSnapshotError>>> + Send;
    fn modify_cluster_snapshot_schedule(&self, builder: ModifyClusterSnapshotScheduleInputBuilder) -> impl Future<Output = Result<ModifyClusterSnapshotScheduleOutput, SdkError<ModifyClusterSnapshotScheduleError>>> + Send;
    fn modify_cluster_subnet_group(&self, builder: ModifyClusterSubnetGroupInputBuilder) -> impl Future<Output = Result<ModifyClusterSubnetGroupOutput, SdkError<ModifyClusterSubnetGroupError>>> + Send;
    fn modify_custom_domain_association(&self, builder: ModifyCustomDomainAssociationInputBuilder) -> impl Future<Output = Result<ModifyCustomDomainAssociationOutput, SdkError<ModifyCustomDomainAssociationError>>> + Send;
    fn modify_endpoint_access(&self, builder: ModifyEndpointAccessInputBuilder) -> impl Future<Output = Result<ModifyEndpointAccessOutput, SdkError<ModifyEndpointAccessError>>> + Send;
    ...
    fn modify_redshift_idc_application(&self, builder: ModifyRedshiftIdcApplicationInputBuilder) -> impl Future<Output = Result<ModifyRedshiftIdcApplicationOutput, SdkError<ModifyRedshiftIdcApplicationError>>> + Send;
    fn modify_scheduled_action(&self, builder: ModifyScheduledActionInputBuilder) -> impl Future<Output = Result<ModifyScheduledActionOutput, SdkError<ModifyScheduledActionError>>> + Send;
    fn modify_snapshot_copy_retention_period(&self, builder: ModifySnapshotCopyRetentionPeriodInputBuilder) -> impl Future<Output = Result<ModifySnapshotCopyRetentionPeriodOutput, SdkError<ModifySnapshotCopyRetentionPeriodError>>> + Send;
    fn modify_snapshot_schedule(&self, builder: ModifySnapshotScheduleInputBuilder) -> impl Future<Output = Result<ModifySnapshotScheduleOutput, SdkError<ModifySnapshotScheduleError>>> + Send;
    fn modify_usage_limit(&self, builder: ModifyUsageLimitInputBuilder) -> impl Future<Output = Result<ModifyUsageLimitOutput, SdkError<ModifyUsageLimitError>>> + Send;
    fn pause_cluster(&self, builder: PauseClusterInputBuilder) -> impl Future<Output = Result<PauseClusterOutput, SdkError<PauseClusterError>>> + Send;
    fn purchase_reserved_node_offering(&self, builder: PurchaseReservedNodeOfferingInputBuilder) -> impl Future<Output = Result<PurchaseReservedNodeOfferingOutput, SdkError<PurchaseReservedNodeOfferingError>>> + Send;
    ...
    fn reboot_cluster(&self, builder: RebootClusterInputBuilder) -> impl Future<Output = Result<RebootClusterOutput, SdkError<RebootClusterError>>> + Send;
    fn reject_data_share(&self, builder: RejectDataShareInputBuilder) -> impl Future<Output = Result<RejectDataShareOutput, SdkError<RejectDataShareError>>> + Send;
    fn reset_cluster_parameter_group(&self, builder: ResetClusterParameterGroupInputBuilder) -> impl Future<Output = Result<ResetClusterParameterGroupOutput, SdkError<ResetClusterParameterGroupError>>> + Send;
    fn resize_cluster(&self, builder: ResizeClusterInputBuilder) -> impl Future<Output = Result<ResizeClusterOutput, SdkError<ResizeClusterError>>> + Send;
    fn restore_from_cluster_snapshot(&self, builder: RestoreFromClusterSnapshotInputBuilder) -> impl Future<Output = Result<RestoreFromClusterSnapshotOutput, SdkError<RestoreFromClusterSnapshotError>>> + Send;
    fn restore_table_from_cluster_snapshot(&self, builder: RestoreTableFromClusterSnapshotInputBuilder) -> impl Future<Output = Result<RestoreTableFromClusterSnapshotOutput, SdkError<RestoreTableFromClusterSnapshotError>>> + Send;
    fn resume_cluster(&self, builder: ResumeClusterInputBuilder) -> impl Future<Output = Result<ResumeClusterOutput, SdkError<ResumeClusterError>>> + Send;
    fn revoke_cluster_security_group_ingress(&self, builder: RevokeClusterSecurityGroupIngressInputBuilder) -> impl Future<Output = Result<RevokeClusterSecurityGroupIngressOutput, SdkError<RevokeClusterSecurityGroupIngressError>>> + Send;
    fn revoke_endpoint_access(&self, builder: RevokeEndpointAccessInputBuilder) -> impl Future<Output = Result<RevokeEndpointAccessOutput, SdkError<RevokeEndpointAccessError>>> + Send;
    fn revoke_snapshot_access(&self, builder: RevokeSnapshotAccessInputBuilder) -> impl Future<Output = Result<RevokeSnapshotAccessOutput, SdkError<RevokeSnapshotAccessError>>> + Send;
    fn rotate_encryption_key(&self, builder: RotateEncryptionKeyInputBuilder) -> impl Future<Output = Result<RotateEncryptionKeyOutput, SdkError<RotateEncryptionKeyError>>> + Send;
    fn update_partner_status(&self, builder: UpdatePartnerStatusInputBuilder) -> impl Future<Output = Result<UpdatePartnerStatusOutput, SdkError<UpdatePartnerStatusError>>> + Send;
}

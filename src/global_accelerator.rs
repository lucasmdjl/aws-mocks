...
pub trait GlobalAcceleratorClient {
    fn add_custom_routing_endpoints(&self, builder: AddCustomRoutingEndpointsInputBuilder) -> impl Future<Output = Result<AddCustomRoutingEndpointsOutput, SdkError<AddCustomRoutingEndpointsError>>> + Send;
    fn add_endpoints(&self, builder: AddEndpointsInputBuilder) -> impl Future<Output = Result<AddEndpointsOutput, SdkError<AddEndpointsError>>> + Send;
    ...
    fn allow_custom_routing_traffic(&self, builder: AllowCustomRoutingTrafficInputBuilder) -> impl Future<Output = Result<AllowCustomRoutingTrafficOutput, SdkError<AllowCustomRoutingTrafficError>>> + Send;
    fn create_accelerator(&self, builder: CreateAcceleratorInputBuilder) -> impl Future<Output = Result<CreateAcceleratorOutput, SdkError<CreateAcceleratorError>>> + Send;
    fn create_cross_account_attachment(&self, builder: CreateCrossAccountAttachmentInputBuilder) -> impl Future<Output = Result<CreateCrossAccountAttachmentOutput, SdkError<CreateCrossAccountAttachmentError>>> + Send;
    fn create_custom_routing_accelerator(&self, builder: CreateCustomRoutingAcceleratorInputBuilder) -> impl Future<Output = Result<CreateCustomRoutingAcceleratorOutput, SdkError<CreateCustomRoutingAcceleratorError>>> + Send;
    fn create_custom_routing_endpoint_group(&self, builder: CreateCustomRoutingEndpointGroupInputBuilder) -> impl Future<Output = Result<CreateCustomRoutingEndpointGroupOutput, SdkError<CreateCustomRoutingEndpointGroupError>>> + Send;
    fn create_custom_routing_listener(&self, builder: CreateCustomRoutingListenerInputBuilder) -> impl Future<Output = Result<CreateCustomRoutingListenerOutput, SdkError<CreateCustomRoutingListenerError>>> + Send;
    fn create_endpoint_group(&self, builder: CreateEndpointGroupInputBuilder) -> impl Future<Output = Result<CreateEndpointGroupOutput, SdkError<CreateEndpointGroupError>>> + Send;
    fn create_listener(&self, builder: CreateListenerInputBuilder) -> impl Future<Output = Result<CreateListenerOutput, SdkError<CreateListenerError>>> + Send;
    fn delete_accelerator(&self, builder: DeleteAcceleratorInputBuilder) -> impl Future<Output = Result<DeleteAcceleratorOutput, SdkError<DeleteAcceleratorError>>> + Send;
    fn delete_cross_account_attachment(&self, builder: DeleteCrossAccountAttachmentInputBuilder) -> impl Future<Output = Result<DeleteCrossAccountAttachmentOutput, SdkError<DeleteCrossAccountAttachmentError>>> + Send;
    fn delete_custom_routing_accelerator(&self, builder: DeleteCustomRoutingAcceleratorInputBuilder) -> impl Future<Output = Result<DeleteCustomRoutingAcceleratorOutput, SdkError<DeleteCustomRoutingAcceleratorError>>> + Send;
    fn delete_custom_routing_endpoint_group(&self, builder: DeleteCustomRoutingEndpointGroupInputBuilder) -> impl Future<Output = Result<DeleteCustomRoutingEndpointGroupOutput, SdkError<DeleteCustomRoutingEndpointGroupError>>> + Send;
    fn delete_custom_routing_listener(&self, builder: DeleteCustomRoutingListenerInputBuilder) -> impl Future<Output = Result<DeleteCustomRoutingListenerOutput, SdkError<DeleteCustomRoutingListenerError>>> + Send;
    fn delete_endpoint_group(&self, builder: DeleteEndpointGroupInputBuilder) -> impl Future<Output = Result<DeleteEndpointGroupOutput, SdkError<DeleteEndpointGroupError>>> + Send;
    fn delete_listener(&self, builder: DeleteListenerInputBuilder) -> impl Future<Output = Result<DeleteListenerOutput, SdkError<DeleteListenerError>>> + Send;
    fn deny_custom_routing_traffic(&self, builder: DenyCustomRoutingTrafficInputBuilder) -> impl Future<Output = Result<DenyCustomRoutingTrafficOutput, SdkError<DenyCustomRoutingTrafficError>>> + Send;
    ...
    fn describe_accelerator(&self, builder: DescribeAcceleratorInputBuilder) -> impl Future<Output = Result<DescribeAcceleratorOutput, SdkError<DescribeAcceleratorError>>> + Send;
    fn describe_accelerator_attributes(&self, builder: DescribeAcceleratorAttributesInputBuilder) -> impl Future<Output = Result<DescribeAcceleratorAttributesOutput, SdkError<DescribeAcceleratorAttributesError>>> + Send;
    fn describe_cross_account_attachment(&self, builder: DescribeCrossAccountAttachmentInputBuilder) -> impl Future<Output = Result<DescribeCrossAccountAttachmentOutput, SdkError<DescribeCrossAccountAttachmentError>>> + Send;
    fn describe_custom_routing_accelerator(&self, builder: DescribeCustomRoutingAcceleratorInputBuilder) -> impl Future<Output = Result<DescribeCustomRoutingAcceleratorOutput, SdkError<DescribeCustomRoutingAcceleratorError>>> + Send;
    fn describe_custom_routing_accelerator_attributes(&self, builder: DescribeCustomRoutingAcceleratorAttributesInputBuilder) -> impl Future<Output = Result<DescribeCustomRoutingAcceleratorAttributesOutput, SdkError<DescribeCustomRoutingAcceleratorAttributesError>>> + Send;
    fn describe_custom_routing_endpoint_group(&self, builder: DescribeCustomRoutingEndpointGroupInputBuilder) -> impl Future<Output = Result<DescribeCustomRoutingEndpointGroupOutput, SdkError<DescribeCustomRoutingEndpointGroupError>>> + Send;
    fn describe_custom_routing_listener(&self, builder: DescribeCustomRoutingListenerInputBuilder) -> impl Future<Output = Result<DescribeCustomRoutingListenerOutput, SdkError<DescribeCustomRoutingListenerError>>> + Send;
    fn describe_endpoint_group(&self, builder: DescribeEndpointGroupInputBuilder) -> impl Future<Output = Result<DescribeEndpointGroupOutput, SdkError<DescribeEndpointGroupError>>> + Send;
    fn describe_listener(&self, builder: DescribeListenerInputBuilder) -> impl Future<Output = Result<DescribeListenerOutput, SdkError<DescribeListenerError>>> + Send;
    fn list_accelerators(&self, builder: ListAcceleratorsInputBuilder) -> impl Future<Output = Result<ListAcceleratorsOutput, SdkError<ListAcceleratorsError>>> + Send;
    fn list_byoip_cidrs(&self, builder: ListByoipCidrsInputBuilder) -> impl Future<Output = Result<ListByoipCidrsOutput, SdkError<ListByoipCidrsError>>> + Send;
    fn list_cross_account_attachments(&self, builder: ListCrossAccountAttachmentsInputBuilder) -> impl Future<Output = Result<ListCrossAccountAttachmentsOutput, SdkError<ListCrossAccountAttachmentsError>>> + Send;
    fn list_cross_account_resource_accounts(&self, builder: ListCrossAccountResourceAccountsInputBuilder) -> impl Future<Output = Result<ListCrossAccountResourceAccountsOutput, SdkError<ListCrossAccountResourceAccountsError>>> + Send;
    fn list_cross_account_resources(&self, builder: ListCrossAccountResourcesInputBuilder) -> impl Future<Output = Result<ListCrossAccountResourcesOutput, SdkError<ListCrossAccountResourcesError>>> + Send;
    fn list_custom_routing_accelerators(&self, builder: ListCustomRoutingAcceleratorsInputBuilder) -> impl Future<Output = Result<ListCustomRoutingAcceleratorsOutput, SdkError<ListCustomRoutingAcceleratorsError>>> + Send;
    fn list_custom_routing_endpoint_groups(&self, builder: ListCustomRoutingEndpointGroupsInputBuilder) -> impl Future<Output = Result<ListCustomRoutingEndpointGroupsOutput, SdkError<ListCustomRoutingEndpointGroupsError>>> + Send;
    fn list_custom_routing_listeners(&self, builder: ListCustomRoutingListenersInputBuilder) -> impl Future<Output = Result<ListCustomRoutingListenersOutput, SdkError<ListCustomRoutingListenersError>>> + Send;
    fn list_custom_routing_port_mappings(&self, builder: ListCustomRoutingPortMappingsInputBuilder) -> impl Future<Output = Result<ListCustomRoutingPortMappingsOutput, SdkError<ListCustomRoutingPortMappingsError>>> + Send;
    fn list_custom_routing_port_mappings_by_destination(&self, builder: ListCustomRoutingPortMappingsByDestinationInputBuilder) -> impl Future<Output = Result<ListCustomRoutingPortMappingsByDestinationOutput, SdkError<ListCustomRoutingPortMappingsByDestinationError>>> + Send;
    fn list_endpoint_groups(&self, builder: ListEndpointGroupsInputBuilder) -> impl Future<Output = Result<ListEndpointGroupsOutput, SdkError<ListEndpointGroupsError>>> + Send;
    fn list_listeners(&self, builder: ListListenersInputBuilder) -> impl Future<Output = Result<ListListenersOutput, SdkError<ListListenersError>>> + Send;
    ...
    fn remove_custom_routing_endpoints(&self, builder: RemoveCustomRoutingEndpointsInputBuilder) -> impl Future<Output = Result<RemoveCustomRoutingEndpointsOutput, SdkError<RemoveCustomRoutingEndpointsError>>> + Send;
    fn remove_endpoints(&self, builder: RemoveEndpointsInputBuilder) -> impl Future<Output = Result<RemoveEndpointsOutput, SdkError<RemoveEndpointsError>>> + Send;
    ...
    fn update_accelerator(&self, builder: UpdateAcceleratorInputBuilder) -> impl Future<Output = Result<UpdateAcceleratorOutput, SdkError<UpdateAcceleratorError>>> + Send;
    fn update_accelerator_attributes(&self, builder: UpdateAcceleratorAttributesInputBuilder) -> impl Future<Output = Result<UpdateAcceleratorAttributesOutput, SdkError<UpdateAcceleratorAttributesError>>> + Send;
    fn update_cross_account_attachment(&self, builder: UpdateCrossAccountAttachmentInputBuilder) -> impl Future<Output = Result<UpdateCrossAccountAttachmentOutput, SdkError<UpdateCrossAccountAttachmentError>>> + Send;
    fn update_custom_routing_accelerator(&self, builder: UpdateCustomRoutingAcceleratorInputBuilder) -> impl Future<Output = Result<UpdateCustomRoutingAcceleratorOutput, SdkError<UpdateCustomRoutingAcceleratorError>>> + Send;
    fn update_custom_routing_accelerator_attributes(&self, builder: UpdateCustomRoutingAcceleratorAttributesInputBuilder) -> impl Future<Output = Result<UpdateCustomRoutingAcceleratorAttributesOutput, SdkError<UpdateCustomRoutingAcceleratorAttributesError>>> + Send;
    fn update_custom_routing_listener(&self, builder: UpdateCustomRoutingListenerInputBuilder) -> impl Future<Output = Result<UpdateCustomRoutingListenerOutput, SdkError<UpdateCustomRoutingListenerError>>> + Send;
    fn update_endpoint_group(&self, builder: UpdateEndpointGroupInputBuilder) -> impl Future<Output = Result<UpdateEndpointGroupOutput, SdkError<UpdateEndpointGroupError>>> + Send;
    fn update_listener(&self, builder: UpdateListenerInputBuilder) -> impl Future<Output = Result<UpdateListenerOutput, SdkError<UpdateListenerError>>> + Send;

...
pub trait ElastiCacheClient {
    ...
    fn authorize_cache_security_group_ingress(&self, builder: AuthorizeCacheSecurityGroupIngressInputBuilder) -> impl Future<Output = Result<AuthorizeCacheSecurityGroupIngressOutput, SdkError<AuthorizeCacheSecurityGroupIngressError>>> + Send;
    fn batch_apply_update_action(&self, builder: BatchApplyUpdateActionInputBuilder) -> impl Future<Output = Result<BatchApplyUpdateActionOutput, SdkError<BatchApplyUpdateActionError>>> + Send;
    fn batch_stop_update_action(&self, builder: BatchStopUpdateActionInputBuilder) -> impl Future<Output = Result<BatchStopUpdateActionOutput, SdkError<BatchStopUpdateActionError>>> + Send;
    fn complete_migration(&self, builder: CompleteMigrationInputBuilder) -> impl Future<Output = Result<CompleteMigrationOutput, SdkError<CompleteMigrationError>>> + Send;
    fn copy_serverless_cache_snapshot(&self, builder: CopyServerlessCacheSnapshotInputBuilder) -> impl Future<Output = Result<CopyServerlessCacheSnapshotOutput, SdkError<CopyServerlessCacheSnapshotError>>> + Send;
    ...
    fn create_cache_cluster(&self, builder: CreateCacheClusterInputBuilder) -> impl Future<Output = Result<CreateCacheClusterOutput, SdkError<CreateCacheClusterError>>> + Send;
    fn create_cache_parameter_group(&self, builder: CreateCacheParameterGroupInputBuilder) -> impl Future<Output = Result<CreateCacheParameterGroupOutput, SdkError<CreateCacheParameterGroupError>>> + Send;
    fn create_cache_security_group(&self, builder: CreateCacheSecurityGroupInputBuilder) -> impl Future<Output = Result<CreateCacheSecurityGroupOutput, SdkError<CreateCacheSecurityGroupError>>> + Send;
    fn create_cache_subnet_group(&self, builder: CreateCacheSubnetGroupInputBuilder) -> impl Future<Output = Result<CreateCacheSubnetGroupOutput, SdkError<CreateCacheSubnetGroupError>>> + Send;
    fn create_global_replication_group(&self, builder: CreateGlobalReplicationGroupInputBuilder) -> impl Future<Output = Result<CreateGlobalReplicationGroupOutput, SdkError<CreateGlobalReplicationGroupError>>> + Send;
    fn create_replication_group(&self, builder: CreateReplicationGroupInputBuilder) -> impl Future<Output = Result<CreateReplicationGroupOutput, SdkError<CreateReplicationGroupError>>> + Send;
    fn create_serverless_cache(&self, builder: CreateServerlessCacheInputBuilder) -> impl Future<Output = Result<CreateServerlessCacheOutput, SdkError<CreateServerlessCacheError>>> + Send;
    fn create_serverless_cache_snapshot(&self, builder: CreateServerlessCacheSnapshotInputBuilder) -> impl Future<Output = Result<CreateServerlessCacheSnapshotOutput, SdkError<CreateServerlessCacheSnapshotError>>> + Send;
    ...
    fn create_user_group(&self, builder: CreateUserGroupInputBuilder) -> impl Future<Output = Result<CreateUserGroupOutput, SdkError<CreateUserGroupError>>> + Send;
    fn decrease_node_groups_in_global_replication_group(&self, builder: DecreaseNodeGroupsInGlobalReplicationGroupInputBuilder) -> impl Future<Output = Result<DecreaseNodeGroupsInGlobalReplicationGroupOutput, SdkError<DecreaseNodeGroupsInGlobalReplicationGroupError>>> + Send;
    fn decrease_replica_count(&self, builder: DecreaseReplicaCountInputBuilder) -> impl Future<Output = Result<DecreaseReplicaCountOutput, SdkError<DecreaseReplicaCountError>>> + Send;
    fn delete_cache_cluster(&self, builder: DeleteCacheClusterInputBuilder) -> impl Future<Output = Result<DeleteCacheClusterOutput, SdkError<DeleteCacheClusterError>>> + Send;
    fn delete_cache_parameter_group(&self, builder: DeleteCacheParameterGroupInputBuilder) -> impl Future<Output = Result<DeleteCacheParameterGroupOutput, SdkError<DeleteCacheParameterGroupError>>> + Send;
    fn delete_cache_security_group(&self, builder: DeleteCacheSecurityGroupInputBuilder) -> impl Future<Output = Result<DeleteCacheSecurityGroupOutput, SdkError<DeleteCacheSecurityGroupError>>> + Send;
    fn delete_cache_subnet_group(&self, builder: DeleteCacheSubnetGroupInputBuilder) -> impl Future<Output = Result<DeleteCacheSubnetGroupOutput, SdkError<DeleteCacheSubnetGroupError>>> + Send;
    fn delete_global_replication_group(&self, builder: DeleteGlobalReplicationGroupInputBuilder) -> impl Future<Output = Result<DeleteGlobalReplicationGroupOutput, SdkError<DeleteGlobalReplicationGroupError>>> + Send;
    fn delete_replication_group(&self, builder: DeleteReplicationGroupInputBuilder) -> impl Future<Output = Result<DeleteReplicationGroupOutput, SdkError<DeleteReplicationGroupError>>> + Send;
    fn delete_serverless_cache(&self, builder: DeleteServerlessCacheInputBuilder) -> impl Future<Output = Result<DeleteServerlessCacheOutput, SdkError<DeleteServerlessCacheError>>> + Send;
    fn delete_serverless_cache_snapshot(&self, builder: DeleteServerlessCacheSnapshotInputBuilder) -> impl Future<Output = Result<DeleteServerlessCacheSnapshotOutput, SdkError<DeleteServerlessCacheSnapshotError>>> + Send;
    ...
    fn delete_user_group(&self, builder: DeleteUserGroupInputBuilder) -> impl Future<Output = Result<DeleteUserGroupOutput, SdkError<DeleteUserGroupError>>> + Send;
    fn describe_cache_clusters(&self, builder: DescribeCacheClustersInputBuilder) -> impl Future<Output = Result<DescribeCacheClustersOutput, SdkError<DescribeCacheClustersError>>> + Send;
    fn describe_cache_engine_versions(&self, builder: DescribeCacheEngineVersionsInputBuilder) -> impl Future<Output = Result<DescribeCacheEngineVersionsOutput, SdkError<DescribeCacheEngineVersionsError>>> + Send;
    fn describe_cache_parameter_groups(&self, builder: DescribeCacheParameterGroupsInputBuilder) -> impl Future<Output = Result<DescribeCacheParameterGroupsOutput, SdkError<DescribeCacheParameterGroupsError>>> + Send;
    fn describe_cache_parameters(&self, builder: DescribeCacheParametersInputBuilder) -> impl Future<Output = Result<DescribeCacheParametersOutput, SdkError<DescribeCacheParametersError>>> + Send;
    fn describe_cache_security_groups(&self, builder: DescribeCacheSecurityGroupsInputBuilder) -> impl Future<Output = Result<DescribeCacheSecurityGroupsOutput, SdkError<DescribeCacheSecurityGroupsError>>> + Send;
    fn describe_cache_subnet_groups(&self, builder: DescribeCacheSubnetGroupsInputBuilder) -> impl Future<Output = Result<DescribeCacheSubnetGroupsOutput, SdkError<DescribeCacheSubnetGroupsError>>> + Send;
    ...
    fn describe_global_replication_groups(&self, builder: DescribeGlobalReplicationGroupsInputBuilder) -> impl Future<Output = Result<DescribeGlobalReplicationGroupsOutput, SdkError<DescribeGlobalReplicationGroupsError>>> + Send;
    fn describe_replication_groups(&self, builder: DescribeReplicationGroupsInputBuilder) -> impl Future<Output = Result<DescribeReplicationGroupsOutput, SdkError<DescribeReplicationGroupsError>>> + Send;
    fn describe_reserved_cache_nodes(&self, builder: DescribeReservedCacheNodesInputBuilder) -> impl Future<Output = Result<DescribeReservedCacheNodesOutput, SdkError<DescribeReservedCacheNodesError>>> + Send;
    fn describe_reserved_cache_nodes_offerings(&self, builder: DescribeReservedCacheNodesOfferingsInputBuilder) -> impl Future<Output = Result<DescribeReservedCacheNodesOfferingsOutput, SdkError<DescribeReservedCacheNodesOfferingsError>>> + Send;
    fn describe_serverless_cache_snapshots(&self, builder: DescribeServerlessCacheSnapshotsInputBuilder) -> impl Future<Output = Result<DescribeServerlessCacheSnapshotsOutput, SdkError<DescribeServerlessCacheSnapshotsError>>> + Send;
    fn describe_serverless_caches(&self, builder: DescribeServerlessCachesInputBuilder) -> impl Future<Output = Result<DescribeServerlessCachesOutput, SdkError<DescribeServerlessCachesError>>> + Send;
    fn describe_service_updates(&self, builder: DescribeServiceUpdatesInputBuilder) -> impl Future<Output = Result<DescribeServiceUpdatesOutput, SdkError<DescribeServiceUpdatesError>>> + Send;
    ...
    fn describe_update_actions(&self, builder: DescribeUpdateActionsInputBuilder) -> impl Future<Output = Result<DescribeUpdateActionsOutput, SdkError<DescribeUpdateActionsError>>> + Send;
    fn describe_user_groups(&self, builder: DescribeUserGroupsInputBuilder) -> impl Future<Output = Result<DescribeUserGroupsOutput, SdkError<DescribeUserGroupsError>>> + Send;
    fn describe_users(&self, builder: DescribeUsersInputBuilder) -> impl Future<Output = Result<DescribeUsersOutput, SdkError<DescribeUsersError>>> + Send;
    fn disassociate_global_replication_group(&self, builder: DisassociateGlobalReplicationGroupInputBuilder) -> impl Future<Output = Result<DisassociateGlobalReplicationGroupOutput, SdkError<DisassociateGlobalReplicationGroupError>>> + Send;
    fn export_serverless_cache_snapshot(&self, builder: ExportServerlessCacheSnapshotInputBuilder) -> impl Future<Output = Result<ExportServerlessCacheSnapshotOutput, SdkError<ExportServerlessCacheSnapshotError>>> + Send;
    fn failover_global_replication_group(&self, builder: FailoverGlobalReplicationGroupInputBuilder) -> impl Future<Output = Result<FailoverGlobalReplicationGroupOutput, SdkError<FailoverGlobalReplicationGroupError>>> + Send;
    fn increase_node_groups_in_global_replication_group(&self, builder: IncreaseNodeGroupsInGlobalReplicationGroupInputBuilder) -> impl Future<Output = Result<IncreaseNodeGroupsInGlobalReplicationGroupOutput, SdkError<IncreaseNodeGroupsInGlobalReplicationGroupError>>> + Send;
    fn increase_replica_count(&self, builder: IncreaseReplicaCountInputBuilder) -> impl Future<Output = Result<IncreaseReplicaCountOutput, SdkError<IncreaseReplicaCountError>>> + Send;
    fn list_allowed_node_type_modifications(&self, builder: ListAllowedNodeTypeModificationsInputBuilder) -> impl Future<Output = Result<ListAllowedNodeTypeModificationsOutput, SdkError<ListAllowedNodeTypeModificationsError>>> + Send;
    ...
    fn modify_cache_cluster(&self, builder: ModifyCacheClusterInputBuilder) -> impl Future<Output = Result<ModifyCacheClusterOutput, SdkError<ModifyCacheClusterError>>> + Send;
    fn modify_cache_parameter_group(&self, builder: ModifyCacheParameterGroupInputBuilder) -> impl Future<Output = Result<ModifyCacheParameterGroupOutput, SdkError<ModifyCacheParameterGroupError>>> + Send;
    fn modify_cache_subnet_group(&self, builder: ModifyCacheSubnetGroupInputBuilder) -> impl Future<Output = Result<ModifyCacheSubnetGroupOutput, SdkError<ModifyCacheSubnetGroupError>>> + Send;
    fn modify_global_replication_group(&self, builder: ModifyGlobalReplicationGroupInputBuilder) -> impl Future<Output = Result<ModifyGlobalReplicationGroupOutput, SdkError<ModifyGlobalReplicationGroupError>>> + Send;
    fn modify_replication_group(&self, builder: ModifyReplicationGroupInputBuilder) -> impl Future<Output = Result<ModifyReplicationGroupOutput, SdkError<ModifyReplicationGroupError>>> + Send;
    fn modify_replication_group_shard_configuration(&self, builder: ModifyReplicationGroupShardConfigurationInputBuilder) -> impl Future<Output = Result<ModifyReplicationGroupShardConfigurationOutput, SdkError<ModifyReplicationGroupShardConfigurationError>>> + Send;
    fn modify_serverless_cache(&self, builder: ModifyServerlessCacheInputBuilder) -> impl Future<Output = Result<ModifyServerlessCacheOutput, SdkError<ModifyServerlessCacheError>>> + Send;
    fn modify_user(&self, builder: ModifyUserInputBuilder) -> impl Future<Output = Result<ModifyUserOutput, SdkError<ModifyUserError>>> + Send;
    fn modify_user_group(&self, builder: ModifyUserGroupInputBuilder) -> impl Future<Output = Result<ModifyUserGroupOutput, SdkError<ModifyUserGroupError>>> + Send;
    fn purchase_reserved_cache_nodes_offering(&self, builder: PurchaseReservedCacheNodesOfferingInputBuilder) -> impl Future<Output = Result<PurchaseReservedCacheNodesOfferingOutput, SdkError<PurchaseReservedCacheNodesOfferingError>>> + Send;
    fn rebalance_slots_in_global_replication_group(&self, builder: RebalanceSlotsInGlobalReplicationGroupInputBuilder) -> impl Future<Output = Result<RebalanceSlotsInGlobalReplicationGroupOutput, SdkError<RebalanceSlotsInGlobalReplicationGroupError>>> + Send;
    fn reboot_cache_cluster(&self, builder: RebootCacheClusterInputBuilder) -> impl Future<Output = Result<RebootCacheClusterOutput, SdkError<RebootCacheClusterError>>> + Send;
    ...
    fn reset_cache_parameter_group(&self, builder: ResetCacheParameterGroupInputBuilder) -> impl Future<Output = Result<ResetCacheParameterGroupOutput, SdkError<ResetCacheParameterGroupError>>> + Send;
    fn revoke_cache_security_group_ingress(&self, builder: RevokeCacheSecurityGroupIngressInputBuilder) -> impl Future<Output = Result<RevokeCacheSecurityGroupIngressOutput, SdkError<RevokeCacheSecurityGroupIngressError>>> + Send;
    fn start_migration(&self, builder: StartMigrationInputBuilder) -> impl Future<Output = Result<StartMigrationOutput, SdkError<StartMigrationError>>> + Send;
    fn test_failover(&self, builder: TestFailoverInputBuilder) -> impl Future<Output = Result<TestFailoverOutput, SdkError<TestFailoverError>>> + Send;
    fn test_migration(&self, builder: TestMigrationInputBuilder) -> impl Future<Output = Result<TestMigrationOutput, SdkError<TestMigrationError>>> + Send;
}

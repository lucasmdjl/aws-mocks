...
pub trait CodeBuildClient {
    fn batch_delete_builds(&self, builder: BatchDeleteBuildsInputBuilder) -> impl Future<Output = Result<BatchDeleteBuildsOutput, SdkError<BatchDeleteBuildsError>>> + Send;
    fn batch_get_build_batches(&self, builder: BatchGetBuildBatchesInputBuilder) -> impl Future<Output = Result<BatchGetBuildBatchesOutput, SdkError<BatchGetBuildBatchesError>>> + Send;
    fn batch_get_builds(&self, builder: BatchGetBuildsInputBuilder) -> impl Future<Output = Result<BatchGetBuildsOutput, SdkError<BatchGetBuildsError>>> + Send;
    fn batch_get_fleets(&self, builder: BatchGetFleetsInputBuilder) -> impl Future<Output = Result<BatchGetFleetsOutput, SdkError<BatchGetFleetsError>>> + Send;
    fn batch_get_projects(&self, builder: BatchGetProjectsInputBuilder) -> impl Future<Output = Result<BatchGetProjectsOutput, SdkError<BatchGetProjectsError>>> + Send;
    fn batch_get_report_groups(&self, builder: BatchGetReportGroupsInputBuilder) -> impl Future<Output = Result<BatchGetReportGroupsOutput, SdkError<BatchGetReportGroupsError>>> + Send;
    fn batch_get_reports(&self, builder: BatchGetReportsInputBuilder) -> impl Future<Output = Result<BatchGetReportsOutput, SdkError<BatchGetReportsError>>> + Send;
    ...
    fn create_report_group(&self, builder: CreateReportGroupInputBuilder) -> impl Future<Output = Result<CreateReportGroupOutput, SdkError<CreateReportGroupError>>> + Send;
    fn create_webhook(&self, builder: CreateWebhookInputBuilder) -> impl Future<Output = Result<CreateWebhookOutput, SdkError<CreateWebhookError>>> + Send;
    fn delete_build_batch(&self, builder: DeleteBuildBatchInputBuilder) -> impl Future<Output = Result<DeleteBuildBatchOutput, SdkError<DeleteBuildBatchError>>> + Send;
    ...
    fn delete_report(&self, builder: DeleteReportInputBuilder) -> impl Future<Output = Result<DeleteReportOutput, SdkError<DeleteReportError>>> + Send;
    fn delete_report_group(&self, builder: DeleteReportGroupInputBuilder) -> impl Future<Output = Result<DeleteReportGroupOutput, SdkError<DeleteReportGroupError>>> + Send;
    ...
    fn delete_source_credentials(&self, builder: DeleteSourceCredentialsInputBuilder) -> impl Future<Output = Result<DeleteSourceCredentialsOutput, SdkError<DeleteSourceCredentialsError>>> + Send;
    ...
    fn describe_code_coverages(&self, builder: DescribeCodeCoveragesInputBuilder) -> impl Future<Output = Result<DescribeCodeCoveragesOutput, SdkError<DescribeCodeCoveragesError>>> + Send;
    fn describe_test_cases(&self, builder: DescribeTestCasesInputBuilder) -> impl Future<Output = Result<DescribeTestCasesOutput, SdkError<DescribeTestCasesError>>> + Send;
    fn get_report_group_trend(&self, builder: GetReportGroupTrendInputBuilder) -> impl Future<Output = Result<GetReportGroupTrendOutput, SdkError<GetReportGroupTrendError>>> + Send;
    ...
    fn import_source_credentials(&self, builder: ImportSourceCredentialsInputBuilder) -> impl Future<Output = Result<ImportSourceCredentialsOutput, SdkError<ImportSourceCredentialsError>>> + Send;
    fn invalidate_project_cache(&self, builder: InvalidateProjectCacheInputBuilder) -> impl Future<Output = Result<InvalidateProjectCacheOutput, SdkError<InvalidateProjectCacheError>>> + Send;
    fn list_build_batches(&self, builder: ListBuildBatchesInputBuilder) -> impl Future<Output = Result<ListBuildBatchesOutput, SdkError<ListBuildBatchesError>>> + Send;
    fn list_build_batches_for_project(&self, builder: ListBuildBatchesForProjectInputBuilder) -> impl Future<Output = Result<ListBuildBatchesForProjectOutput, SdkError<ListBuildBatchesForProjectError>>> + Send;
    fn list_builds(&self, builder: ListBuildsInputBuilder) -> impl Future<Output = Result<ListBuildsOutput, SdkError<ListBuildsError>>> + Send;
    fn list_builds_for_project(&self, builder: ListBuildsForProjectInputBuilder) -> impl Future<Output = Result<ListBuildsForProjectOutput, SdkError<ListBuildsForProjectError>>> + Send;
    fn list_curated_environment_images(&self, builder: ListCuratedEnvironmentImagesInputBuilder) -> impl Future<Output = Result<ListCuratedEnvironmentImagesOutput, SdkError<ListCuratedEnvironmentImagesError>>> + Send;
    fn list_fleets(&self, builder: ListFleetsInputBuilder) -> impl Future<Output = Result<ListFleetsOutput, SdkError<ListFleetsError>>> + Send;
    ...
    fn list_report_groups(&self, builder: ListReportGroupsInputBuilder) -> impl Future<Output = Result<ListReportGroupsOutput, SdkError<ListReportGroupsError>>> + Send;
    fn list_reports(&self, builder: ListReportsInputBuilder) -> impl Future<Output = Result<ListReportsOutput, SdkError<ListReportsError>>> + Send;
    fn list_reports_for_report_group(&self, builder: ListReportsForReportGroupInputBuilder) -> impl Future<Output = Result<ListReportsForReportGroupOutput, SdkError<ListReportsForReportGroupError>>> + Send;
    fn list_shared_projects(&self, builder: ListSharedProjectsInputBuilder) -> impl Future<Output = Result<ListSharedProjectsOutput, SdkError<ListSharedProjectsError>>> + Send;
    fn list_shared_report_groups(&self, builder: ListSharedReportGroupsInputBuilder) -> impl Future<Output = Result<ListSharedReportGroupsOutput, SdkError<ListSharedReportGroupsError>>> + Send;
    fn list_source_credentials(&self, builder: ListSourceCredentialsInputBuilder) -> impl Future<Output = Result<ListSourceCredentialsOutput, SdkError<ListSourceCredentialsError>>> + Send;
    ...
    fn retry_build(&self, builder: RetryBuildInputBuilder) -> impl Future<Output = Result<RetryBuildOutput, SdkError<RetryBuildError>>> + Send;
    fn retry_build_batch(&self, builder: RetryBuildBatchInputBuilder) -> impl Future<Output = Result<RetryBuildBatchOutput, SdkError<RetryBuildBatchError>>> + Send;
    fn start_build(&self, builder: StartBuildInputBuilder) -> impl Future<Output = Result<StartBuildOutput, SdkError<StartBuildError>>> + Send;
    fn start_build_batch(&self, builder: StartBuildBatchInputBuilder) -> impl Future<Output = Result<StartBuildBatchOutput, SdkError<StartBuildBatchError>>> + Send;
    fn stop_build(&self, builder: StopBuildInputBuilder) -> impl Future<Output = Result<StopBuildOutput, SdkError<StopBuildError>>> + Send;
    fn stop_build_batch(&self, builder: StopBuildBatchInputBuilder) -> impl Future<Output = Result<StopBuildBatchOutput, SdkError<StopBuildBatchError>>> + Send;
    ...
    fn update_project_visibility(&self, builder: UpdateProjectVisibilityInputBuilder) -> impl Future<Output = Result<UpdateProjectVisibilityOutput, SdkError<UpdateProjectVisibilityError>>> + Send;
    fn update_report_group(&self, builder: UpdateReportGroupInputBuilder) -> impl Future<Output = Result<UpdateReportGroupOutput, SdkError<UpdateReportGroupError>>> + Send;
    fn update_webhook(&self, builder: UpdateWebhookInputBuilder) -> impl Future<Output = Result<UpdateWebhookOutput, SdkError<UpdateWebhookError>>> + Send;
}

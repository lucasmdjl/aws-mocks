...
pub trait AmplifyClient {
    ...
    fn create_backend_environment(&self, builder: CreateBackendEnvironmentInputBuilder) -> impl Future<Output = Result<CreateBackendEnvironmentOutput, SdkError<CreateBackendEnvironmentError>>> + Send;
    ...
    fn create_domain_association(&self, builder: CreateDomainAssociationInputBuilder) -> impl Future<Output = Result<CreateDomainAssociationOutput, SdkError<CreateDomainAssociationError>>> + Send;
    ...
    fn delete_backend_environment(&self, builder: DeleteBackendEnvironmentInputBuilder) -> impl Future<Output = Result<DeleteBackendEnvironmentOutput, SdkError<DeleteBackendEnvironmentError>>> + Send;
    ...
    fn delete_domain_association(&self, builder: DeleteDomainAssociationInputBuilder) -> impl Future<Output = Result<DeleteDomainAssociationOutput, SdkError<DeleteDomainAssociationError>>> + Send;
    ...
    fn generate_access_logs(&self, builder: GenerateAccessLogsInputBuilder) -> impl Future<Output = Result<GenerateAccessLogsOutput, SdkError<GenerateAccessLogsError>>> + Send;
    fn get_app(&self, builder: GetAppInputBuilder) -> impl Future<Output = Result<GetAppOutput, SdkError<GetAppError>>> + Send;
    fn get_artifact_url(&self, builder: GetArtifactUrlInputBuilder) -> impl Future<Output = Result<GetArtifactUrlOutput, SdkError<GetArtifactUrlError>>> + Send;
    fn get_backend_environment(&self, builder: GetBackendEnvironmentInputBuilder) -> impl Future<Output = Result<GetBackendEnvironmentOutput, SdkError<GetBackendEnvironmentError>>> + Send;
    fn get_branch(&self, builder: GetBranchInputBuilder) -> impl Future<Output = Result<GetBranchOutput, SdkError<GetBranchError>>> + Send;
    fn get_domain_association(&self, builder: GetDomainAssociationInputBuilder) -> impl Future<Output = Result<GetDomainAssociationOutput, SdkError<GetDomainAssociationError>>> + Send;
    fn get_job(&self, builder: GetJobInputBuilder) -> impl Future<Output = Result<GetJobOutput, SdkError<GetJobError>>> + Send;
    fn get_webhook(&self, builder: GetWebhookInputBuilder) -> impl Future<Output = Result<GetWebhookOutput, SdkError<GetWebhookError>>> + Send;
    ...
    fn list_backend_environments(&self, builder: ListBackendEnvironmentsInputBuilder) -> impl Future<Output = Result<ListBackendEnvironmentsOutput, SdkError<ListBackendEnvironmentsError>>> + Send;
    ...
    fn list_domain_associations(&self, builder: ListDomainAssociationsInputBuilder) -> impl Future<Output = Result<ListDomainAssociationsOutput, SdkError<ListDomainAssociationsError>>> + Send;
    ...
    fn start_job(&self, builder: StartJobInputBuilder) -> impl Future<Output = Result<StartJobOutput, SdkError<StartJobError>>> + Send;
    fn stop_job(&self, builder: StopJobInputBuilder) -> impl Future<Output = Result<StopJobOutput, SdkError<StopJobError>>> + Send;
    ...
    fn update_app(&self, builder: UpdateAppInputBuilder) -> impl Future<Output = Result<UpdateAppOutput, SdkError<UpdateAppError>>> + Send;
    fn update_branch(&self, builder: UpdateBranchInputBuilder) -> impl Future<Output = Result<UpdateBranchOutput, SdkError<UpdateBranchError>>> + Send;
    fn update_domain_association(&self, builder: UpdateDomainAssociationInputBuilder) -> impl Future<Output = Result<UpdateDomainAssociationOutput, SdkError<UpdateDomainAssociationError>>> + Send;

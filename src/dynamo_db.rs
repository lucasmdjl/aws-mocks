...
pub trait DynamoDBClient {
    fn batch_execute_statement(&self, builder: BatchExecuteStatementInputBuilder) -> impl Future<Output = Result<BatchExecuteStatementOutput, SdkError<BatchExecuteStatementError>>> + Send;
    fn batch_get_item(&self, builder: BatchGetItemInputBuilder) -> impl Future<Output = Result<BatchGetItemOutput, SdkError<BatchGetItemError>>> + Send;
    fn batch_write_item(&self, builder: BatchWriteItemInputBuilder) -> impl Future<Output = Result<BatchWriteItemOutput, SdkError<BatchWriteItemError>>> + Send;
    fn create_backup(&self, builder: CreateBackupInputBuilder) -> impl Future<Output = Result<CreateBackupOutput, SdkError<CreateBackupError>>> + Send;
    fn create_global_table(&self, builder: CreateGlobalTableInputBuilder) -> impl Future<Output = Result<CreateGlobalTableOutput, SdkError<CreateGlobalTableError>>> + Send;
    ...
    fn delete_backup(&self, builder: DeleteBackupInputBuilder) -> impl Future<Output = Result<DeleteBackupOutput, SdkError<DeleteBackupError>>> + Send;
    fn delete_item(&self, builder: DeleteItemInputBuilder) -> impl Future<Output = Result<DeleteItemOutput, SdkError<DeleteItemError>>> + Send;
    ...
    fn describe_backup(&self, builder: DescribeBackupInputBuilder) -> impl Future<Output = Result<DescribeBackupOutput, SdkError<DescribeBackupError>>> + Send;
    fn describe_continuous_backups(&self, builder: DescribeContinuousBackupsInputBuilder) -> impl Future<Output = Result<DescribeContinuousBackupsOutput, SdkError<DescribeContinuousBackupsError>>> + Send;
    fn describe_contributor_insights(&self, builder: DescribeContributorInsightsInputBuilder) -> impl Future<Output = Result<DescribeContributorInsightsOutput, SdkError<DescribeContributorInsightsError>>> + Send;
    fn describe_endpoints(&self, builder: DescribeEndpointsInputBuilder) -> impl Future<Output = Result<DescribeEndpointsOutput, SdkError<DescribeEndpointsError>>> + Send;
    fn describe_export(&self, builder: DescribeExportInputBuilder) -> impl Future<Output = Result<DescribeExportOutput, SdkError<DescribeExportError>>> + Send;
    fn describe_global_table(&self, builder: DescribeGlobalTableInputBuilder) -> impl Future<Output = Result<DescribeGlobalTableOutput, SdkError<DescribeGlobalTableError>>> + Send;
    fn describe_global_table_settings(&self, builder: DescribeGlobalTableSettingsInputBuilder) -> impl Future<Output = Result<DescribeGlobalTableSettingsOutput, SdkError<DescribeGlobalTableSettingsError>>> + Send;
    fn describe_import(&self, builder: DescribeImportInputBuilder) -> impl Future<Output = Result<DescribeImportOutput, SdkError<DescribeImportError>>> + Send;
    fn describe_kinesis_streaming_destination(&self, builder: DescribeKinesisStreamingDestinationInputBuilder) -> impl Future<Output = Result<DescribeKinesisStreamingDestinationOutput, SdkError<DescribeKinesisStreamingDestinationError>>> + Send;
    ...
    fn describe_table(&self, builder: DescribeTableInputBuilder) -> impl Future<Output = Result<DescribeTableOutput, SdkError<DescribeTableError>>> + Send;
    fn describe_table_replica_auto_scaling(&self, builder: DescribeTableReplicaAutoScalingInputBuilder) -> impl Future<Output = Result<DescribeTableReplicaAutoScalingOutput, SdkError<DescribeTableReplicaAutoScalingError>>> + Send;
    fn describe_time_to_live(&self, builder: DescribeTimeToLiveInputBuilder) -> impl Future<Output = Result<DescribeTimeToLiveOutput, SdkError<DescribeTimeToLiveError>>> + Send;
    fn disable_kinesis_streaming_destination(&self, builder: DisableKinesisStreamingDestinationInputBuilder) -> impl Future<Output = Result<DisableKinesisStreamingDestinationOutput, SdkError<DisableKinesisStreamingDestinationError>>> + Send;
    fn enable_kinesis_streaming_destination(&self, builder: EnableKinesisStreamingDestinationInputBuilder) -> impl Future<Output = Result<EnableKinesisStreamingDestinationOutput, SdkError<EnableKinesisStreamingDestinationError>>> + Send;
    fn execute_statement(&self, builder: ExecuteStatementInputBuilder) -> impl Future<Output = Result<ExecuteStatementOutput, SdkError<ExecuteStatementError>>> + Send;
    fn execute_transaction(&self, builder: ExecuteTransactionInputBuilder) -> impl Future<Output = Result<ExecuteTransactionOutput, SdkError<ExecuteTransactionError>>> + Send;
    fn export_table_to_point_in_time(&self, builder: ExportTableToPointInTimeInputBuilder) -> impl Future<Output = Result<ExportTableToPointInTimeOutput, SdkError<ExportTableToPointInTimeError>>> + Send;
    fn get_item(&self, builder: GetItemInputBuilder) -> impl Future<Output = Result<GetItemOutput, SdkError<GetItemError>>> + Send;
    ...
    fn import_table(&self, builder: ImportTableInputBuilder) -> impl Future<Output = Result<ImportTableOutput, SdkError<ImportTableError>>> + Send;
    fn list_backups(&self, builder: ListBackupsInputBuilder) -> impl Future<Output = Result<ListBackupsOutput, SdkError<ListBackupsError>>> + Send;
    fn list_contributor_insights(&self, builder: ListContributorInsightsInputBuilder) -> impl Future<Output = Result<ListContributorInsightsOutput, SdkError<ListContributorInsightsError>>> + Send;
    ...
    fn list_global_tables(&self, builder: ListGlobalTablesInputBuilder) -> impl Future<Output = Result<ListGlobalTablesOutput, SdkError<ListGlobalTablesError>>> + Send;
    ...
    fn list_tables(&self, builder: ListTablesInputBuilder) -> impl Future<Output = Result<ListTablesOutput, SdkError<ListTablesError>>> + Send;
    fn list_tags_of_resource(&self, builder: ListTagsOfResourceInputBuilder) -> impl Future<Output = Result<ListTagsOfResourceOutput, SdkError<ListTagsOfResourceError>>> + Send;
    fn put_item(&self, builder: PutItemInputBuilder) -> impl Future<Output = Result<PutItemOutput, SdkError<PutItemError>>> + Send;
    ...
    fn query(&self, builder: QueryInputBuilder) -> impl Future<Output = Result<QueryOutput, SdkError<QueryError>>> + Send;
    fn restore_table_from_backup(&self, builder: RestoreTableFromBackupInputBuilder) -> impl Future<Output = Result<RestoreTableFromBackupOutput, SdkError<RestoreTableFromBackupError>>> + Send;
    fn restore_table_to_point_in_time(&self, builder: RestoreTableToPointInTimeInputBuilder) -> impl Future<Output = Result<RestoreTableToPointInTimeOutput, SdkError<RestoreTableToPointInTimeError>>> + Send;
    fn scan(&self, builder: ScanInputBuilder) -> impl Future<Output = Result<ScanOutput, SdkError<ScanError>>> + Send;
    ...
    fn transact_get_items(&self, builder: TransactGetItemsInputBuilder) -> impl Future<Output = Result<TransactGetItemsOutput, SdkError<TransactGetItemsError>>> + Send;
    fn transact_write_items(&self, builder: TransactWriteItemsInputBuilder) -> impl Future<Output = Result<TransactWriteItemsOutput, SdkError<TransactWriteItemsError>>> + Send;
    ...
    fn update_continuous_backups(&self, builder: UpdateContinuousBackupsInputBuilder) -> impl Future<Output = Result<UpdateContinuousBackupsOutput, SdkError<UpdateContinuousBackupsError>>> + Send;
    fn update_contributor_insights(&self, builder: UpdateContributorInsightsInputBuilder) -> impl Future<Output = Result<UpdateContributorInsightsOutput, SdkError<UpdateContributorInsightsError>>> + Send;
    fn update_global_table(&self, builder: UpdateGlobalTableInputBuilder) -> impl Future<Output = Result<UpdateGlobalTableOutput, SdkError<UpdateGlobalTableError>>> + Send;
    fn update_global_table_settings(&self, builder: UpdateGlobalTableSettingsInputBuilder) -> impl Future<Output = Result<UpdateGlobalTableSettingsOutput, SdkError<UpdateGlobalTableSettingsError>>> + Send;
    fn update_item(&self, builder: UpdateItemInputBuilder) -> impl Future<Output = Result<UpdateItemOutput, SdkError<UpdateItemError>>> + Send;
    fn update_kinesis_streaming_destination(&self, builder: UpdateKinesisStreamingDestinationInputBuilder) -> impl Future<Output = Result<UpdateKinesisStreamingDestinationOutput, SdkError<UpdateKinesisStreamingDestinationError>>> + Send;
    ...
    fn update_table_replica_auto_scaling(&self, builder: UpdateTableReplicaAutoScalingInputBuilder) -> impl Future<Output = Result<UpdateTableReplicaAutoScalingOutput, SdkError<UpdateTableReplicaAutoScalingError>>> + Send;
    fn update_time_to_live(&self, builder: UpdateTimeToLiveInputBuilder) -> impl Future<Output = Result<UpdateTimeToLiveOutput, SdkError<UpdateTimeToLiveError>>> + Send;
}

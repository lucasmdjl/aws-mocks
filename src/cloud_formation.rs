...
pub trait CloudFormationClient {
    fn activate_organizations_access(&self, builder: ActivateOrganizationsAccessInputBuilder) -> impl Future<Output = Result<ActivateOrganizationsAccessOutput, SdkError<ActivateOrganizationsAccessError>>> + Send;
    fn activate_type(&self, builder: ActivateTypeInputBuilder) -> impl Future<Output = Result<ActivateTypeOutput, SdkError<ActivateTypeError>>> + Send;
    fn batch_describe_type_configurations(&self, builder: BatchDescribeTypeConfigurationsInputBuilder) -> impl Future<Output = Result<BatchDescribeTypeConfigurationsOutput, SdkError<BatchDescribeTypeConfigurationsError>>> + Send;
    fn cancel_update_stack(&self, builder: CancelUpdateStackInputBuilder) -> impl Future<Output = Result<CancelUpdateStackOutput, SdkError<CancelUpdateStackError>>> + Send;
    fn continue_update_rollback(&self, builder: ContinueUpdateRollbackInputBuilder) -> impl Future<Output = Result<ContinueUpdateRollbackOutput, SdkError<ContinueUpdateRollbackError>>> + Send;
    fn create_change_set(&self, builder: CreateChangeSetInputBuilder) -> impl Future<Output = Result<CreateChangeSetOutput, SdkError<CreateChangeSetError>>> + Send;
    fn create_generated_template(&self, builder: CreateGeneratedTemplateInputBuilder) -> impl Future<Output = Result<CreateGeneratedTemplateOutput, SdkError<CreateGeneratedTemplateError>>> + Send;
    fn create_stack(&self, builder: CreateStackInputBuilder) -> impl Future<Output = Result<CreateStackOutput, SdkError<CreateStackError>>> + Send;
    fn create_stack_instances(&self, builder: CreateStackInstancesInputBuilder) -> impl Future<Output = Result<CreateStackInstancesOutput, SdkError<CreateStackInstancesError>>> + Send;
    fn create_stack_set(&self, builder: CreateStackSetInputBuilder) -> impl Future<Output = Result<CreateStackSetOutput, SdkError<CreateStackSetError>>> + Send;
    fn deactivate_organizations_access(&self, builder: DeactivateOrganizationsAccessInputBuilder) -> impl Future<Output = Result<DeactivateOrganizationsAccessOutput, SdkError<DeactivateOrganizationsAccessError>>> + Send;
    fn deactivate_type(&self, builder: DeactivateTypeInputBuilder) -> impl Future<Output = Result<DeactivateTypeOutput, SdkError<DeactivateTypeError>>> + Send;
    fn delete_change_set(&self, builder: DeleteChangeSetInputBuilder) -> impl Future<Output = Result<DeleteChangeSetOutput, SdkError<DeleteChangeSetError>>> + Send;
    fn delete_generated_template(&self, builder: DeleteGeneratedTemplateInputBuilder) -> impl Future<Output = Result<DeleteGeneratedTemplateOutput, SdkError<DeleteGeneratedTemplateError>>> + Send;
    fn delete_stack(&self, builder: DeleteStackInputBuilder) -> impl Future<Output = Result<DeleteStackOutput, SdkError<DeleteStackError>>> + Send;
    fn delete_stack_instances(&self, builder: DeleteStackInstancesInputBuilder) -> impl Future<Output = Result<DeleteStackInstancesOutput, SdkError<DeleteStackInstancesError>>> + Send;
    fn delete_stack_set(&self, builder: DeleteStackSetInputBuilder) -> impl Future<Output = Result<DeleteStackSetOutput, SdkError<DeleteStackSetError>>> + Send;
    fn deregister_type(&self, builder: DeregisterTypeInputBuilder) -> impl Future<Output = Result<DeregisterTypeOutput, SdkError<DeregisterTypeError>>> + Send;
    fn describe_account_limits(&self, builder: DescribeAccountLimitsInputBuilder) -> impl Future<Output = Result<DescribeAccountLimitsOutput, SdkError<DescribeAccountLimitsError>>> + Send;
    fn describe_change_set(&self, builder: DescribeChangeSetInputBuilder) -> impl Future<Output = Result<DescribeChangeSetOutput, SdkError<DescribeChangeSetError>>> + Send;
    fn describe_change_set_hooks(&self, builder: DescribeChangeSetHooksInputBuilder) -> impl Future<Output = Result<DescribeChangeSetHooksOutput, SdkError<DescribeChangeSetHooksError>>> + Send;
    fn describe_generated_template(&self, builder: DescribeGeneratedTemplateInputBuilder) -> impl Future<Output = Result<DescribeGeneratedTemplateOutput, SdkError<DescribeGeneratedTemplateError>>> + Send;
    fn describe_organizations_access(&self, builder: DescribeOrganizationsAccessInputBuilder) -> impl Future<Output = Result<DescribeOrganizationsAccessOutput, SdkError<DescribeOrganizationsAccessError>>> + Send;
    fn describe_publisher(&self, builder: DescribePublisherInputBuilder) -> impl Future<Output = Result<DescribePublisherOutput, SdkError<DescribePublisherError>>> + Send;
    fn describe_resource_scan(&self, builder: DescribeResourceScanInputBuilder) -> impl Future<Output = Result<DescribeResourceScanOutput, SdkError<DescribeResourceScanError>>> + Send;
    fn describe_stack_drift_detection_status(&self, builder: DescribeStackDriftDetectionStatusInputBuilder) -> impl Future<Output = Result<DescribeStackDriftDetectionStatusOutput, SdkError<DescribeStackDriftDetectionStatusError>>> + Send;
    fn describe_stack_events(&self, builder: DescribeStackEventsInputBuilder) -> impl Future<Output = Result<DescribeStackEventsOutput, SdkError<DescribeStackEventsError>>> + Send;
    fn describe_stack_instance(&self, builder: DescribeStackInstanceInputBuilder) -> impl Future<Output = Result<DescribeStackInstanceOutput, SdkError<DescribeStackInstanceError>>> + Send;
    fn describe_stack_resource(&self, builder: DescribeStackResourceInputBuilder) -> impl Future<Output = Result<DescribeStackResourceOutput, SdkError<DescribeStackResourceError>>> + Send;
    fn describe_stack_resource_drifts(&self, builder: DescribeStackResourceDriftsInputBuilder) -> impl Future<Output = Result<DescribeStackResourceDriftsOutput, SdkError<DescribeStackResourceDriftsError>>> + Send;
    fn describe_stack_resources(&self, builder: DescribeStackResourcesInputBuilder) -> impl Future<Output = Result<DescribeStackResourcesOutput, SdkError<DescribeStackResourcesError>>> + Send;
    fn describe_stack_set(&self, builder: DescribeStackSetInputBuilder) -> impl Future<Output = Result<DescribeStackSetOutput, SdkError<DescribeStackSetError>>> + Send;
    fn describe_stack_set_operation(&self, builder: DescribeStackSetOperationInputBuilder) -> impl Future<Output = Result<DescribeStackSetOperationOutput, SdkError<DescribeStackSetOperationError>>> + Send;
    fn describe_stacks(&self, builder: DescribeStacksInputBuilder) -> impl Future<Output = Result<DescribeStacksOutput, SdkError<DescribeStacksError>>> + Send;
    fn describe_type(&self, builder: DescribeTypeInputBuilder) -> impl Future<Output = Result<DescribeTypeOutput, SdkError<DescribeTypeError>>> + Send;
    fn describe_type_registration(&self, builder: DescribeTypeRegistrationInputBuilder) -> impl Future<Output = Result<DescribeTypeRegistrationOutput, SdkError<DescribeTypeRegistrationError>>> + Send;
    fn detect_stack_drift(&self, builder: DetectStackDriftInputBuilder) -> impl Future<Output = Result<DetectStackDriftOutput, SdkError<DetectStackDriftError>>> + Send;
    fn detect_stack_resource_drift(&self, builder: DetectStackResourceDriftInputBuilder) -> impl Future<Output = Result<DetectStackResourceDriftOutput, SdkError<DetectStackResourceDriftError>>> + Send;
    fn detect_stack_set_drift(&self, builder: DetectStackSetDriftInputBuilder) -> impl Future<Output = Result<DetectStackSetDriftOutput, SdkError<DetectStackSetDriftError>>> + Send;
    fn estimate_template_cost(&self, builder: EstimateTemplateCostInputBuilder) -> impl Future<Output = Result<EstimateTemplateCostOutput, SdkError<EstimateTemplateCostError>>> + Send;
    fn execute_change_set(&self, builder: ExecuteChangeSetInputBuilder) -> impl Future<Output = Result<ExecuteChangeSetOutput, SdkError<ExecuteChangeSetError>>> + Send;
    fn get_generated_template(&self, builder: GetGeneratedTemplateInputBuilder) -> impl Future<Output = Result<GetGeneratedTemplateOutput, SdkError<GetGeneratedTemplateError>>> + Send;
    fn get_stack_policy(&self, builder: GetStackPolicyInputBuilder) -> impl Future<Output = Result<GetStackPolicyOutput, SdkError<GetStackPolicyError>>> + Send;
    fn get_template(&self, builder: GetTemplateInputBuilder) -> impl Future<Output = Result<GetTemplateOutput, SdkError<GetTemplateError>>> + Send;
    fn get_template_summary(&self, builder: GetTemplateSummaryInputBuilder) -> impl Future<Output = Result<GetTemplateSummaryOutput, SdkError<GetTemplateSummaryError>>> + Send;
    fn import_stacks_to_stack_set(&self, builder: ImportStacksToStackSetInputBuilder) -> impl Future<Output = Result<ImportStacksToStackSetOutput, SdkError<ImportStacksToStackSetError>>> + Send;
    fn list_change_sets(&self, builder: ListChangeSetsInputBuilder) -> impl Future<Output = Result<ListChangeSetsOutput, SdkError<ListChangeSetsError>>> + Send;
    fn list_exports(&self, builder: ListExportsInputBuilder) -> impl Future<Output = Result<ListExportsOutput, SdkError<ListExportsError>>> + Send;
    fn list_generated_templates(&self, builder: ListGeneratedTemplatesInputBuilder) -> impl Future<Output = Result<ListGeneratedTemplatesOutput, SdkError<ListGeneratedTemplatesError>>> + Send;
    ...
    fn list_resource_scan_related_resources(&self, builder: ListResourceScanRelatedResourcesInputBuilder) -> impl Future<Output = Result<ListResourceScanRelatedResourcesOutput, SdkError<ListResourceScanRelatedResourcesError>>> + Send;
    fn list_resource_scan_resources(&self, builder: ListResourceScanResourcesInputBuilder) -> impl Future<Output = Result<ListResourceScanResourcesOutput, SdkError<ListResourceScanResourcesError>>> + Send;
    fn list_resource_scans(&self, builder: ListResourceScansInputBuilder) -> impl Future<Output = Result<ListResourceScansOutput, SdkError<ListResourceScansError>>> + Send;
    fn list_stack_instance_resource_drifts(&self, builder: ListStackInstanceResourceDriftsInputBuilder) -> impl Future<Output = Result<ListStackInstanceResourceDriftsOutput, SdkError<ListStackInstanceResourceDriftsError>>> + Send;
    fn list_stack_instances(&self, builder: ListStackInstancesInputBuilder) -> impl Future<Output = Result<ListStackInstancesOutput, SdkError<ListStackInstancesError>>> + Send;
    fn list_stack_resources(&self, builder: ListStackResourcesInputBuilder) -> impl Future<Output = Result<ListStackResourcesOutput, SdkError<ListStackResourcesError>>> + Send;
    fn list_stack_set_auto_deployment_targets(&self, builder: ListStackSetAutoDeploymentTargetsInputBuilder) -> impl Future<Output = Result<ListStackSetAutoDeploymentTargetsOutput, SdkError<ListStackSetAutoDeploymentTargetsError>>> + Send;
    fn list_stack_set_operation_results(&self, builder: ListStackSetOperationResultsInputBuilder) -> impl Future<Output = Result<ListStackSetOperationResultsOutput, SdkError<ListStackSetOperationResultsError>>> + Send;
    fn list_stack_set_operations(&self, builder: ListStackSetOperationsInputBuilder) -> impl Future<Output = Result<ListStackSetOperationsOutput, SdkError<ListStackSetOperationsError>>> + Send;
    fn list_stack_sets(&self, builder: ListStackSetsInputBuilder) -> impl Future<Output = Result<ListStackSetsOutput, SdkError<ListStackSetsError>>> + Send;
    fn list_stacks(&self, builder: ListStacksInputBuilder) -> impl Future<Output = Result<ListStacksOutput, SdkError<ListStacksError>>> + Send;
    fn list_type_registrations(&self, builder: ListTypeRegistrationsInputBuilder) -> impl Future<Output = Result<ListTypeRegistrationsOutput, SdkError<ListTypeRegistrationsError>>> + Send;
    fn list_type_versions(&self, builder: ListTypeVersionsInputBuilder) -> impl Future<Output = Result<ListTypeVersionsOutput, SdkError<ListTypeVersionsError>>> + Send;
    fn list_types(&self, builder: ListTypesInputBuilder) -> impl Future<Output = Result<ListTypesOutput, SdkError<ListTypesError>>> + Send;
    fn publish_type(&self, builder: PublishTypeInputBuilder) -> impl Future<Output = Result<PublishTypeOutput, SdkError<PublishTypeError>>> + Send;
    fn record_handler_progress(&self, builder: RecordHandlerProgressInputBuilder) -> impl Future<Output = Result<RecordHandlerProgressOutput, SdkError<RecordHandlerProgressError>>> + Send;
    fn register_publisher(&self, builder: RegisterPublisherInputBuilder) -> impl Future<Output = Result<RegisterPublisherOutput, SdkError<RegisterPublisherError>>> + Send;
    fn register_type(&self, builder: RegisterTypeInputBuilder) -> impl Future<Output = Result<RegisterTypeOutput, SdkError<RegisterTypeError>>> + Send;
    fn rollback_stack(&self, builder: RollbackStackInputBuilder) -> impl Future<Output = Result<RollbackStackOutput, SdkError<RollbackStackError>>> + Send;
    fn set_stack_policy(&self, builder: SetStackPolicyInputBuilder) -> impl Future<Output = Result<SetStackPolicyOutput, SdkError<SetStackPolicyError>>> + Send;
    fn set_type_configuration(&self, builder: SetTypeConfigurationInputBuilder) -> impl Future<Output = Result<SetTypeConfigurationOutput, SdkError<SetTypeConfigurationError>>> + Send;
    fn set_type_default_version(&self, builder: SetTypeDefaultVersionInputBuilder) -> impl Future<Output = Result<SetTypeDefaultVersionOutput, SdkError<SetTypeDefaultVersionError>>> + Send;
    fn signal_resource(&self, builder: SignalResourceInputBuilder) -> impl Future<Output = Result<SignalResourceOutput, SdkError<SignalResourceError>>> + Send;
    ...
    fn stop_stack_set_operation(&self, builder: StopStackSetOperationInputBuilder) -> impl Future<Output = Result<StopStackSetOperationOutput, SdkError<StopStackSetOperationError>>> + Send;
    fn test_type(&self, builder: TestTypeInputBuilder) -> impl Future<Output = Result<TestTypeOutput, SdkError<TestTypeError>>> + Send;
    fn update_generated_template(&self, builder: UpdateGeneratedTemplateInputBuilder) -> impl Future<Output = Result<UpdateGeneratedTemplateOutput, SdkError<UpdateGeneratedTemplateError>>> + Send;
    fn update_stack(&self, builder: UpdateStackInputBuilder) -> impl Future<Output = Result<UpdateStackOutput, SdkError<UpdateStackError>>> + Send;
    fn update_stack_instances(&self, builder: UpdateStackInstancesInputBuilder) -> impl Future<Output = Result<UpdateStackInstancesOutput, SdkError<UpdateStackInstancesError>>> + Send;
    fn update_stack_set(&self, builder: UpdateStackSetInputBuilder) -> impl Future<Output = Result<UpdateStackSetOutput, SdkError<UpdateStackSetError>>> + Send;
    fn update_termination_protection(&self, builder: UpdateTerminationProtectionInputBuilder) -> impl Future<Output = Result<UpdateTerminationProtectionOutput, SdkError<UpdateTerminationProtectionError>>> + Send;
    fn validate_template(&self, builder: ValidateTemplateInputBuilder) -> impl Future<Output = Result<ValidateTemplateOutput, SdkError<ValidateTemplateError>>> + Send;
}

...
pub trait RDSClient {
    fn add_role_to_db_cluster(&self, builder: AddRoleToDbClusterInputBuilder) -> impl Future<Output = Result<AddRoleToDbClusterOutput, SdkError<AddRoleToDBClusterError>>> + Send;
    fn add_role_to_db_instance(&self, builder: AddRoleToDbInstanceInputBuilder) -> impl Future<Output = Result<AddRoleToDbInstanceOutput, SdkError<AddRoleToDBInstanceError>>> + Send;
    fn add_source_identifier_to_subscription(&self, builder: AddSourceIdentifierToSubscriptionInputBuilder) -> impl Future<Output = Result<AddSourceIdentifierToSubscriptionOutput, SdkError<AddSourceIdentifierToSubscriptionError>>> + Send;
    ...
    fn apply_pending_maintenance_action(&self, builder: ApplyPendingMaintenanceActionInputBuilder) -> impl Future<Output = Result<ApplyPendingMaintenanceActionOutput, SdkError<ApplyPendingMaintenanceActionError>>> + Send;
    fn authorize_db_security_group_ingress(&self, builder: AuthorizeDbSecurityGroupIngressInputBuilder) -> impl Future<Output = Result<AuthorizeDbSecurityGroupIngressOutput, SdkError<AuthorizeDBSecurityGroupIngressError>>> + Send;
    fn backtrack_db_cluster(&self, builder: BacktrackDbClusterInputBuilder) -> impl Future<Output = Result<BacktrackDbClusterOutput, SdkError<BacktrackDBClusterError>>> + Send;
    ...
    fn copy_db_cluster_parameter_group(&self, builder: CopyDbClusterParameterGroupInputBuilder) -> impl Future<Output = Result<CopyDbClusterParameterGroupOutput, SdkError<CopyDBClusterParameterGroupError>>> + Send;
    fn copy_db_cluster_snapshot(&self, builder: CopyDbClusterSnapshotInputBuilder) -> impl Future<Output = Result<CopyDbClusterSnapshotOutput, SdkError<CopyDBClusterSnapshotError>>> + Send;
    fn copy_db_parameter_group(&self, builder: CopyDbParameterGroupInputBuilder) -> impl Future<Output = Result<CopyDbParameterGroupOutput, SdkError<CopyDBParameterGroupError>>> + Send;
    fn copy_db_snapshot(&self, builder: CopyDbSnapshotInputBuilder) -> impl Future<Output = Result<CopyDbSnapshotOutput, SdkError<CopyDBSnapshotError>>> + Send;
    fn copy_option_group(&self, builder: CopyOptionGroupInputBuilder) -> impl Future<Output = Result<CopyOptionGroupOutput, SdkError<CopyOptionGroupError>>> + Send;
    fn create_blue_green_deployment(&self, builder: CreateBlueGreenDeploymentInputBuilder) -> impl Future<Output = Result<CreateBlueGreenDeploymentOutput, SdkError<CreateBlueGreenDeploymentError>>> + Send;
    fn create_custom_db_engine_version(&self, builder: CreateCustomDbEngineVersionInputBuilder) -> impl Future<Output = Result<CreateCustomDbEngineVersionOutput, SdkError<CreateCustomDBEngineVersionError>>> + Send;
    fn create_db_cluster(&self, builder: CreateDbClusterInputBuilder) -> impl Future<Output = Result<CreateDbClusterOutput, SdkError<CreateDBClusterError>>> + Send;
    fn create_db_cluster_endpoint(&self, builder: CreateDbClusterEndpointInputBuilder) -> impl Future<Output = Result<CreateDbClusterEndpointOutput, SdkError<CreateDBClusterEndpointError>>> + Send;
    fn create_db_cluster_parameter_group(&self, builder: CreateDbClusterParameterGroupInputBuilder) -> impl Future<Output = Result<CreateDbClusterParameterGroupOutput, SdkError<CreateDBClusterParameterGroupError>>> + Send;
    fn create_db_cluster_snapshot(&self, builder: CreateDbClusterSnapshotInputBuilder) -> impl Future<Output = Result<CreateDbClusterSnapshotOutput, SdkError<CreateDBClusterSnapshotError>>> + Send;
    fn create_db_instance(&self, builder: CreateDbInstanceInputBuilder) -> impl Future<Output = Result<CreateDbInstanceOutput, SdkError<CreateDBInstanceError>>> + Send;
    fn create_db_instance_read_replica(&self, builder: CreateDbInstanceReadReplicaInputBuilder) -> impl Future<Output = Result<CreateDbInstanceReadReplicaOutput, SdkError<CreateDBInstanceReadReplicaError>>> + Send;
    fn create_db_parameter_group(&self, builder: CreateDbParameterGroupInputBuilder) -> impl Future<Output = Result<CreateDbParameterGroupOutput, SdkError<CreateDBParameterGroupError>>> + Send;
    fn create_db_proxy(&self, builder: CreateDbProxyInputBuilder) -> impl Future<Output = Result<CreateDbProxyOutput, SdkError<CreateDBProxyError>>> + Send;
    fn create_db_proxy_endpoint(&self, builder: CreateDbProxyEndpointInputBuilder) -> impl Future<Output = Result<CreateDbProxyEndpointOutput, SdkError<CreateDBProxyEndpointError>>> + Send;
    fn create_db_security_group(&self, builder: CreateDbSecurityGroupInputBuilder) -> impl Future<Output = Result<CreateDbSecurityGroupOutput, SdkError<CreateDBSecurityGroupError>>> + Send;
    fn create_db_shard_group(&self, builder: CreateDbShardGroupInputBuilder) -> impl Future<Output = Result<CreateDbShardGroupOutput, SdkError<CreateDBShardGroupError>>> + Send;
    fn create_db_snapshot(&self, builder: CreateDbSnapshotInputBuilder) -> impl Future<Output = Result<CreateDbSnapshotOutput, SdkError<CreateDBSnapshotError>>> + Send;
    fn create_db_subnet_group(&self, builder: CreateDbSubnetGroupInputBuilder) -> impl Future<Output = Result<CreateDbSubnetGroupOutput, SdkError<CreateDBSubnetGroupError>>> + Send;
    fn create_event_subscription(&self, builder: CreateEventSubscriptionInputBuilder) -> impl Future<Output = Result<CreateEventSubscriptionOutput, SdkError<CreateEventSubscriptionError>>> + Send;
    fn create_global_cluster(&self, builder: CreateGlobalClusterInputBuilder) -> impl Future<Output = Result<CreateGlobalClusterOutput, SdkError<CreateGlobalClusterError>>> + Send;
    ...
    fn create_option_group(&self, builder: CreateOptionGroupInputBuilder) -> impl Future<Output = Result<CreateOptionGroupOutput, SdkError<CreateOptionGroupError>>> + Send;
    fn create_tenant_database(&self, builder: CreateTenantDatabaseInputBuilder) -> impl Future<Output = Result<CreateTenantDatabaseOutput, SdkError<CreateTenantDatabaseError>>> + Send;
    fn delete_blue_green_deployment(&self, builder: DeleteBlueGreenDeploymentInputBuilder) -> impl Future<Output = Result<DeleteBlueGreenDeploymentOutput, SdkError<DeleteBlueGreenDeploymentError>>> + Send;
    fn delete_custom_db_engine_version(&self, builder: DeleteCustomDbEngineVersionInputBuilder) -> impl Future<Output = Result<DeleteCustomDbEngineVersionOutput, SdkError<DeleteCustomDBEngineVersionError>>> + Send;
    fn delete_db_cluster(&self, builder: DeleteDbClusterInputBuilder) -> impl Future<Output = Result<DeleteDbClusterOutput, SdkError<DeleteDBClusterError>>> + Send;
    fn delete_db_cluster_automated_backup(&self, builder: DeleteDbClusterAutomatedBackupInputBuilder) -> impl Future<Output = Result<DeleteDbClusterAutomatedBackupOutput, SdkError<DeleteDBClusterAutomatedBackupError>>> + Send;
    fn delete_db_cluster_endpoint(&self, builder: DeleteDbClusterEndpointInputBuilder) -> impl Future<Output = Result<DeleteDbClusterEndpointOutput, SdkError<DeleteDBClusterEndpointError>>> + Send;
    fn delete_db_cluster_parameter_group(&self, builder: DeleteDbClusterParameterGroupInputBuilder) -> impl Future<Output = Result<DeleteDbClusterParameterGroupOutput, SdkError<DeleteDBClusterParameterGroupError>>> + Send;
    fn delete_db_cluster_snapshot(&self, builder: DeleteDbClusterSnapshotInputBuilder) -> impl Future<Output = Result<DeleteDbClusterSnapshotOutput, SdkError<DeleteDBClusterSnapshotError>>> + Send;
    fn delete_db_instance(&self, builder: DeleteDbInstanceInputBuilder) -> impl Future<Output = Result<DeleteDbInstanceOutput, SdkError<DeleteDBInstanceError>>> + Send;
    fn delete_db_instance_automated_backup(&self, builder: DeleteDbInstanceAutomatedBackupInputBuilder) -> impl Future<Output = Result<DeleteDbInstanceAutomatedBackupOutput, SdkError<DeleteDBInstanceAutomatedBackupError>>> + Send;
    fn delete_db_parameter_group(&self, builder: DeleteDbParameterGroupInputBuilder) -> impl Future<Output = Result<DeleteDbParameterGroupOutput, SdkError<DeleteDBParameterGroupError>>> + Send;
    fn delete_db_proxy(&self, builder: DeleteDbProxyInputBuilder) -> impl Future<Output = Result<DeleteDbProxyOutput, SdkError<DeleteDBProxyError>>> + Send;
    fn delete_db_proxy_endpoint(&self, builder: DeleteDbProxyEndpointInputBuilder) -> impl Future<Output = Result<DeleteDbProxyEndpointOutput, SdkError<DeleteDBProxyEndpointError>>> + Send;
    fn delete_db_security_group(&self, builder: DeleteDbSecurityGroupInputBuilder) -> impl Future<Output = Result<DeleteDbSecurityGroupOutput, SdkError<DeleteDBSecurityGroupError>>> + Send;
    fn delete_db_shard_group(&self, builder: DeleteDbShardGroupInputBuilder) -> impl Future<Output = Result<DeleteDbShardGroupOutput, SdkError<DeleteDBShardGroupError>>> + Send;
    fn delete_db_snapshot(&self, builder: DeleteDbSnapshotInputBuilder) -> impl Future<Output = Result<DeleteDbSnapshotOutput, SdkError<DeleteDBSnapshotError>>> + Send;
    fn delete_db_subnet_group(&self, builder: DeleteDbSubnetGroupInputBuilder) -> impl Future<Output = Result<DeleteDbSubnetGroupOutput, SdkError<DeleteDBSubnetGroupError>>> + Send;
    fn delete_event_subscription(&self, builder: DeleteEventSubscriptionInputBuilder) -> impl Future<Output = Result<DeleteEventSubscriptionOutput, SdkError<DeleteEventSubscriptionError>>> + Send;
    fn delete_global_cluster(&self, builder: DeleteGlobalClusterInputBuilder) -> impl Future<Output = Result<DeleteGlobalClusterOutput, SdkError<DeleteGlobalClusterError>>> + Send;
    ...
    fn delete_option_group(&self, builder: DeleteOptionGroupInputBuilder) -> impl Future<Output = Result<DeleteOptionGroupOutput, SdkError<DeleteOptionGroupError>>> + Send;
    fn delete_tenant_database(&self, builder: DeleteTenantDatabaseInputBuilder) -> impl Future<Output = Result<DeleteTenantDatabaseOutput, SdkError<DeleteTenantDatabaseError>>> + Send;
    fn deregister_db_proxy_targets(&self, builder: DeregisterDbProxyTargetsInputBuilder) -> impl Future<Output = Result<DeregisterDbProxyTargetsOutput, SdkError<DeregisterDBProxyTargetsError>>> + Send;
    ...
    fn describe_blue_green_deployments(&self, builder: DescribeBlueGreenDeploymentsInputBuilder) -> impl Future<Output = Result<DescribeBlueGreenDeploymentsOutput, SdkError<DescribeBlueGreenDeploymentsError>>> + Send;
    fn describe_certificates(&self, builder: DescribeCertificatesInputBuilder) -> impl Future<Output = Result<DescribeCertificatesOutput, SdkError<DescribeCertificatesError>>> + Send;
    fn describe_db_cluster_automated_backups(&self, builder: DescribeDbClusterAutomatedBackupsInputBuilder) -> impl Future<Output = Result<DescribeDbClusterAutomatedBackupsOutput, SdkError<DescribeDBClusterAutomatedBackupsError>>> + Send;
    fn describe_db_cluster_backtracks(&self, builder: DescribeDbClusterBacktracksInputBuilder) -> impl Future<Output = Result<DescribeDbClusterBacktracksOutput, SdkError<DescribeDBClusterBacktracksError>>> + Send;
    fn describe_db_cluster_endpoints(&self, builder: DescribeDbClusterEndpointsInputBuilder) -> impl Future<Output = Result<DescribeDbClusterEndpointsOutput, SdkError<DescribeDBClusterEndpointsError>>> + Send;
    fn describe_db_cluster_parameter_groups(&self, builder: DescribeDbClusterParameterGroupsInputBuilder) -> impl Future<Output = Result<DescribeDbClusterParameterGroupsOutput, SdkError<DescribeDBClusterParameterGroupsError>>> + Send;
    fn describe_db_cluster_parameters(&self, builder: DescribeDbClusterParametersInputBuilder) -> impl Future<Output = Result<DescribeDbClusterParametersOutput, SdkError<DescribeDBClusterParametersError>>> + Send;
    fn describe_db_cluster_snapshot_attributes(&self, builder: DescribeDbClusterSnapshotAttributesInputBuilder) -> impl Future<Output = Result<DescribeDbClusterSnapshotAttributesOutput, SdkError<DescribeDBClusterSnapshotAttributesError>>> + Send;
    fn describe_db_cluster_snapshots(&self, builder: DescribeDbClusterSnapshotsInputBuilder) -> impl Future<Output = Result<DescribeDbClusterSnapshotsOutput, SdkError<DescribeDBClusterSnapshotsError>>> + Send;
    fn describe_db_clusters(&self, builder: DescribeDbClustersInputBuilder) -> impl Future<Output = Result<DescribeDbClustersOutput, SdkError<DescribeDBClustersError>>> + Send;
    fn describe_db_engine_versions(&self, builder: DescribeDbEngineVersionsInputBuilder) -> impl Future<Output = Result<DescribeDbEngineVersionsOutput, SdkError<DescribeDBEngineVersionsError>>> + Send;
    fn describe_db_instance_automated_backups(&self, builder: DescribeDbInstanceAutomatedBackupsInputBuilder) -> impl Future<Output = Result<DescribeDbInstanceAutomatedBackupsOutput, SdkError<DescribeDBInstanceAutomatedBackupsError>>> + Send;
    fn describe_db_instances(&self, builder: DescribeDbInstancesInputBuilder) -> impl Future<Output = Result<DescribeDbInstancesOutput, SdkError<DescribeDBInstancesError>>> + Send;
    fn describe_db_log_files(&self, builder: DescribeDbLogFilesInputBuilder) -> impl Future<Output = Result<DescribeDbLogFilesOutput, SdkError<DescribeDBLogFilesError>>> + Send;
    fn describe_db_parameter_groups(&self, builder: DescribeDbParameterGroupsInputBuilder) -> impl Future<Output = Result<DescribeDbParameterGroupsOutput, SdkError<DescribeDBParameterGroupsError>>> + Send;
    fn describe_db_parameters(&self, builder: DescribeDbParametersInputBuilder) -> impl Future<Output = Result<DescribeDbParametersOutput, SdkError<DescribeDBParametersError>>> + Send;
    fn describe_db_proxies(&self, builder: DescribeDbProxiesInputBuilder) -> impl Future<Output = Result<DescribeDbProxiesOutput, SdkError<DescribeDBProxiesError>>> + Send;
    fn describe_db_proxy_endpoints(&self, builder: DescribeDbProxyEndpointsInputBuilder) -> impl Future<Output = Result<DescribeDbProxyEndpointsOutput, SdkError<DescribeDBProxyEndpointsError>>> + Send;
    fn describe_db_proxy_target_groups(&self, builder: DescribeDbProxyTargetGroupsInputBuilder) -> impl Future<Output = Result<DescribeDbProxyTargetGroupsOutput, SdkError<DescribeDBProxyTargetGroupsError>>> + Send;
    fn describe_db_proxy_targets(&self, builder: DescribeDbProxyTargetsInputBuilder) -> impl Future<Output = Result<DescribeDbProxyTargetsOutput, SdkError<DescribeDBProxyTargetsError>>> + Send;
    fn describe_db_recommendations(&self, builder: DescribeDbRecommendationsInputBuilder) -> impl Future<Output = Result<DescribeDbRecommendationsOutput, SdkError<DescribeDBRecommendationsError>>> + Send;
    fn describe_db_security_groups(&self, builder: DescribeDbSecurityGroupsInputBuilder) -> impl Future<Output = Result<DescribeDbSecurityGroupsOutput, SdkError<DescribeDBSecurityGroupsError>>> + Send;
    fn describe_db_shard_groups(&self, builder: DescribeDbShardGroupsInputBuilder) -> impl Future<Output = Result<DescribeDbShardGroupsOutput, SdkError<DescribeDBShardGroupsError>>> + Send;
    fn describe_db_snapshot_attributes(&self, builder: DescribeDbSnapshotAttributesInputBuilder) -> impl Future<Output = Result<DescribeDbSnapshotAttributesOutput, SdkError<DescribeDBSnapshotAttributesError>>> + Send;
    fn describe_db_snapshot_tenant_databases(&self, builder: DescribeDbSnapshotTenantDatabasesInputBuilder) -> impl Future<Output = Result<DescribeDbSnapshotTenantDatabasesOutput, SdkError<DescribeDBSnapshotTenantDatabasesError>>> + Send;
    fn describe_db_snapshots(&self, builder: DescribeDbSnapshotsInputBuilder) -> impl Future<Output = Result<DescribeDbSnapshotsOutput, SdkError<DescribeDBSnapshotsError>>> + Send;
    fn describe_db_subnet_groups(&self, builder: DescribeDbSubnetGroupsInputBuilder) -> impl Future<Output = Result<DescribeDbSubnetGroupsOutput, SdkError<DescribeDBSubnetGroupsError>>> + Send;
    fn describe_engine_default_cluster_parameters(&self, builder: DescribeEngineDefaultClusterParametersInputBuilder) -> impl Future<Output = Result<DescribeEngineDefaultClusterParametersOutput, SdkError<DescribeEngineDefaultClusterParametersError>>> + Send;
    fn describe_engine_default_parameters(&self, builder: DescribeEngineDefaultParametersInputBuilder) -> impl Future<Output = Result<DescribeEngineDefaultParametersOutput, SdkError<DescribeEngineDefaultParametersError>>> + Send;
    fn describe_event_categories(&self, builder: DescribeEventCategoriesInputBuilder) -> impl Future<Output = Result<DescribeEventCategoriesOutput, SdkError<DescribeEventCategoriesError>>> + Send;
    fn describe_event_subscriptions(&self, builder: DescribeEventSubscriptionsInputBuilder) -> impl Future<Output = Result<DescribeEventSubscriptionsOutput, SdkError<DescribeEventSubscriptionsError>>> + Send;
    ...
    fn describe_global_clusters(&self, builder: DescribeGlobalClustersInputBuilder) -> impl Future<Output = Result<DescribeGlobalClustersOutput, SdkError<DescribeGlobalClustersError>>> + Send;
    fn describe_integrations(&self, builder: DescribeIntegrationsInputBuilder) -> impl Future<Output = Result<DescribeIntegrationsOutput, SdkError<DescribeIntegrationsError>>> + Send;
    fn describe_option_group_options(&self, builder: DescribeOptionGroupOptionsInputBuilder) -> impl Future<Output = Result<DescribeOptionGroupOptionsOutput, SdkError<DescribeOptionGroupOptionsError>>> + Send;
    fn describe_option_groups(&self, builder: DescribeOptionGroupsInputBuilder) -> impl Future<Output = Result<DescribeOptionGroupsOutput, SdkError<DescribeOptionGroupsError>>> + Send;
    fn describe_orderable_db_instance_options(&self, builder: DescribeOrderableDbInstanceOptionsInputBuilder) -> impl Future<Output = Result<DescribeOrderableDbInstanceOptionsOutput, SdkError<DescribeOrderableDBInstanceOptionsError>>> + Send;
    fn describe_pending_maintenance_actions(&self, builder: DescribePendingMaintenanceActionsInputBuilder) -> impl Future<Output = Result<DescribePendingMaintenanceActionsOutput, SdkError<DescribePendingMaintenanceActionsError>>> + Send;
    fn describe_reserved_db_instances(&self, builder: DescribeReservedDbInstancesInputBuilder) -> impl Future<Output = Result<DescribeReservedDbInstancesOutput, SdkError<DescribeReservedDBInstancesError>>> + Send;
    fn describe_reserved_db_instances_offerings(&self, builder: DescribeReservedDbInstancesOfferingsInputBuilder) -> impl Future<Output = Result<DescribeReservedDbInstancesOfferingsOutput, SdkError<DescribeReservedDBInstancesOfferingsError>>> + Send;
    fn describe_source_regions(&self, builder: DescribeSourceRegionsInputBuilder) -> impl Future<Output = Result<DescribeSourceRegionsOutput, SdkError<DescribeSourceRegionsError>>> + Send;
    fn describe_tenant_databases(&self, builder: DescribeTenantDatabasesInputBuilder) -> impl Future<Output = Result<DescribeTenantDatabasesOutput, SdkError<DescribeTenantDatabasesError>>> + Send;
    fn describe_valid_db_instance_modifications(&self, builder: DescribeValidDbInstanceModificationsInputBuilder) -> impl Future<Output = Result<DescribeValidDbInstanceModificationsOutput, SdkError<DescribeValidDBInstanceModificationsError>>> + Send;
    fn disable_http_endpoint(&self, builder: DisableHttpEndpointInputBuilder) -> impl Future<Output = Result<DisableHttpEndpointOutput, SdkError<DisableHttpEndpointError>>> + Send;
    fn download_db_log_file_portion(&self, builder: DownloadDbLogFilePortionInputBuilder) -> impl Future<Output = Result<DownloadDbLogFilePortionOutput, SdkError<DownloadDBLogFilePortionError>>> + Send;
    fn enable_http_endpoint(&self, builder: EnableHttpEndpointInputBuilder) -> impl Future<Output = Result<EnableHttpEndpointOutput, SdkError<EnableHttpEndpointError>>> + Send;
    fn failover_db_cluster(&self, builder: FailoverDbClusterInputBuilder) -> impl Future<Output = Result<FailoverDbClusterOutput, SdkError<FailoverDBClusterError>>> + Send;
    fn failover_global_cluster(&self, builder: FailoverGlobalClusterInputBuilder) -> impl Future<Output = Result<FailoverGlobalClusterOutput, SdkError<FailoverGlobalClusterError>>> + Send;
    ...
    fn modify_activity_stream(&self, builder: ModifyActivityStreamInputBuilder) -> impl Future<Output = Result<ModifyActivityStreamOutput, SdkError<ModifyActivityStreamError>>> + Send;
    fn modify_certificates(&self, builder: ModifyCertificatesInputBuilder) -> impl Future<Output = Result<ModifyCertificatesOutput, SdkError<ModifyCertificatesError>>> + Send;
    fn modify_current_db_cluster_capacity(&self, builder: ModifyCurrentDbClusterCapacityInputBuilder) -> impl Future<Output = Result<ModifyCurrentDbClusterCapacityOutput, SdkError<ModifyCurrentDBClusterCapacityError>>> + Send;
    fn modify_custom_db_engine_version(&self, builder: ModifyCustomDbEngineVersionInputBuilder) -> impl Future<Output = Result<ModifyCustomDbEngineVersionOutput, SdkError<ModifyCustomDBEngineVersionError>>> + Send;
    fn modify_db_cluster(&self, builder: ModifyDbClusterInputBuilder) -> impl Future<Output = Result<ModifyDbClusterOutput, SdkError<ModifyDBClusterError>>> + Send;
    fn modify_db_cluster_endpoint(&self, builder: ModifyDbClusterEndpointInputBuilder) -> impl Future<Output = Result<ModifyDbClusterEndpointOutput, SdkError<ModifyDBClusterEndpointError>>> + Send;
    fn modify_db_cluster_parameter_group(&self, builder: ModifyDbClusterParameterGroupInputBuilder) -> impl Future<Output = Result<ModifyDbClusterParameterGroupOutput, SdkError<ModifyDBClusterParameterGroupError>>> + Send;
    fn modify_db_cluster_snapshot_attribute(&self, builder: ModifyDbClusterSnapshotAttributeInputBuilder) -> impl Future<Output = Result<ModifyDbClusterSnapshotAttributeOutput, SdkError<ModifyDBClusterSnapshotAttributeError>>> + Send;
    fn modify_db_instance(&self, builder: ModifyDbInstanceInputBuilder) -> impl Future<Output = Result<ModifyDbInstanceOutput, SdkError<ModifyDBInstanceError>>> + Send;
    fn modify_db_parameter_group(&self, builder: ModifyDbParameterGroupInputBuilder) -> impl Future<Output = Result<ModifyDbParameterGroupOutput, SdkError<ModifyDBParameterGroupError>>> + Send;
    fn modify_db_proxy(&self, builder: ModifyDbProxyInputBuilder) -> impl Future<Output = Result<ModifyDbProxyOutput, SdkError<ModifyDBProxyError>>> + Send;
    fn modify_db_proxy_endpoint(&self, builder: ModifyDbProxyEndpointInputBuilder) -> impl Future<Output = Result<ModifyDbProxyEndpointOutput, SdkError<ModifyDBProxyEndpointError>>> + Send;
    fn modify_db_proxy_target_group(&self, builder: ModifyDbProxyTargetGroupInputBuilder) -> impl Future<Output = Result<ModifyDbProxyTargetGroupOutput, SdkError<ModifyDBProxyTargetGroupError>>> + Send;
    fn modify_db_recommendation(&self, builder: ModifyDbRecommendationInputBuilder) -> impl Future<Output = Result<ModifyDbRecommendationOutput, SdkError<ModifyDBRecommendationError>>> + Send;
    fn modify_db_shard_group(&self, builder: ModifyDbShardGroupInputBuilder) -> impl Future<Output = Result<ModifyDbShardGroupOutput, SdkError<ModifyDBShardGroupError>>> + Send;
    fn modify_db_snapshot(&self, builder: ModifyDbSnapshotInputBuilder) -> impl Future<Output = Result<ModifyDbSnapshotOutput, SdkError<ModifyDBSnapshotError>>> + Send;
    fn modify_db_snapshot_attribute(&self, builder: ModifyDbSnapshotAttributeInputBuilder) -> impl Future<Output = Result<ModifyDbSnapshotAttributeOutput, SdkError<ModifyDBSnapshotAttributeError>>> + Send;
    fn modify_db_subnet_group(&self, builder: ModifyDbSubnetGroupInputBuilder) -> impl Future<Output = Result<ModifyDbSubnetGroupOutput, SdkError<ModifyDBSubnetGroupError>>> + Send;
    fn modify_event_subscription(&self, builder: ModifyEventSubscriptionInputBuilder) -> impl Future<Output = Result<ModifyEventSubscriptionOutput, SdkError<ModifyEventSubscriptionError>>> + Send;
    fn modify_global_cluster(&self, builder: ModifyGlobalClusterInputBuilder) -> impl Future<Output = Result<ModifyGlobalClusterOutput, SdkError<ModifyGlobalClusterError>>> + Send;
    fn modify_integration(&self, builder: ModifyIntegrationInputBuilder) -> impl Future<Output = Result<ModifyIntegrationOutput, SdkError<ModifyIntegrationError>>> + Send;
    fn modify_tenant_database(&self, builder: ModifyTenantDatabaseInputBuilder) -> impl Future<Output = Result<ModifyTenantDatabaseOutput, SdkError<ModifyTenantDatabaseError>>> + Send;
    fn promote_read_replica(&self, builder: PromoteReadReplicaInputBuilder) -> impl Future<Output = Result<PromoteReadReplicaOutput, SdkError<PromoteReadReplicaError>>> + Send;
    fn promote_read_replica_db_cluster(&self, builder: PromoteReadReplicaDbClusterInputBuilder) -> impl Future<Output = Result<PromoteReadReplicaDbClusterOutput, SdkError<PromoteReadReplicaDBClusterError>>> + Send;
    fn purchase_reserved_db_instances_offering(&self, builder: PurchaseReservedDbInstancesOfferingInputBuilder) -> impl Future<Output = Result<PurchaseReservedDbInstancesOfferingOutput, SdkError<PurchaseReservedDBInstancesOfferingError>>> + Send;
    fn reboot_db_cluster(&self, builder: RebootDbClusterInputBuilder) -> impl Future<Output = Result<RebootDbClusterOutput, SdkError<RebootDBClusterError>>> + Send;
    fn reboot_db_instance(&self, builder: RebootDbInstanceInputBuilder) -> impl Future<Output = Result<RebootDbInstanceOutput, SdkError<RebootDBInstanceError>>> + Send;
    fn reboot_db_shard_group(&self, builder: RebootDbShardGroupInputBuilder) -> impl Future<Output = Result<RebootDbShardGroupOutput, SdkError<RebootDBShardGroupError>>> + Send;
    fn register_db_proxy_targets(&self, builder: RegisterDbProxyTargetsInputBuilder) -> impl Future<Output = Result<RegisterDbProxyTargetsOutput, SdkError<RegisterDBProxyTargetsError>>> + Send;
    fn remove_from_global_cluster(&self, builder: RemoveFromGlobalClusterInputBuilder) -> impl Future<Output = Result<RemoveFromGlobalClusterOutput, SdkError<RemoveFromGlobalClusterError>>> + Send;
    fn remove_role_from_db_cluster(&self, builder: RemoveRoleFromDbClusterInputBuilder) -> impl Future<Output = Result<RemoveRoleFromDbClusterOutput, SdkError<RemoveRoleFromDBClusterError>>> + Send;
    fn remove_role_from_db_instance(&self, builder: RemoveRoleFromDbInstanceInputBuilder) -> impl Future<Output = Result<RemoveRoleFromDbInstanceOutput, SdkError<RemoveRoleFromDBInstanceError>>> + Send;
    fn remove_source_identifier_from_subscription(&self, builder: RemoveSourceIdentifierFromSubscriptionInputBuilder) -> impl Future<Output = Result<RemoveSourceIdentifierFromSubscriptionOutput, SdkError<RemoveSourceIdentifierFromSubscriptionError>>> + Send;
    ...
    fn reset_db_cluster_parameter_group(&self, builder: ResetDbClusterParameterGroupInputBuilder) -> impl Future<Output = Result<ResetDbClusterParameterGroupOutput, SdkError<ResetDBClusterParameterGroupError>>> + Send;
    fn reset_db_parameter_group(&self, builder: ResetDbParameterGroupInputBuilder) -> impl Future<Output = Result<ResetDbParameterGroupOutput, SdkError<ResetDBParameterGroupError>>> + Send;
    fn restore_db_cluster_from_s3(&self, builder: RestoreDbClusterFromS3InputBuilder) -> impl Future<Output = Result<RestoreDbClusterFromS3Output, SdkError<RestoreDBClusterFromS3Error>>> + Send;
    fn restore_db_cluster_from_snapshot(&self, builder: RestoreDbClusterFromSnapshotInputBuilder) -> impl Future<Output = Result<RestoreDbClusterFromSnapshotOutput, SdkError<RestoreDBClusterFromSnapshotError>>> + Send;
    fn restore_db_cluster_to_point_in_time(&self, builder: RestoreDbClusterToPointInTimeInputBuilder) -> impl Future<Output = Result<RestoreDbClusterToPointInTimeOutput, SdkError<RestoreDBClusterToPointInTimeError>>> + Send;
    fn restore_db_instance_from_db_snapshot(&self, builder: RestoreDbInstanceFromDbSnapshotInputBuilder) -> impl Future<Output = Result<RestoreDbInstanceFromDbSnapshotOutput, SdkError<RestoreDBInstanceFromDBSnapshotError>>> + Send;
    fn restore_db_instance_from_s3(&self, builder: RestoreDbInstanceFromS3InputBuilder) -> impl Future<Output = Result<RestoreDbInstanceFromS3Output, SdkError<RestoreDBInstanceFromS3Error>>> + Send;
    fn restore_db_instance_to_point_in_time(&self, builder: RestoreDbInstanceToPointInTimeInputBuilder) -> impl Future<Output = Result<RestoreDbInstanceToPointInTimeOutput, SdkError<RestoreDBInstanceToPointInTimeError>>> + Send;
    fn revoke_db_security_group_ingress(&self, builder: RevokeDbSecurityGroupIngressInputBuilder) -> impl Future<Output = Result<RevokeDbSecurityGroupIngressOutput, SdkError<RevokeDBSecurityGroupIngressError>>> + Send;
    fn start_activity_stream(&self, builder: StartActivityStreamInputBuilder) -> impl Future<Output = Result<StartActivityStreamOutput, SdkError<StartActivityStreamError>>> + Send;
    fn start_db_cluster(&self, builder: StartDbClusterInputBuilder) -> impl Future<Output = Result<StartDbClusterOutput, SdkError<StartDBClusterError>>> + Send;
    fn start_db_instance(&self, builder: StartDbInstanceInputBuilder) -> impl Future<Output = Result<StartDbInstanceOutput, SdkError<StartDBInstanceError>>> + Send;
    fn start_db_instance_automated_backups_replication(&self, builder: StartDbInstanceAutomatedBackupsReplicationInputBuilder) -> impl Future<Output = Result<StartDbInstanceAutomatedBackupsReplicationOutput, SdkError<StartDBInstanceAutomatedBackupsReplicationError>>> + Send;
    fn start_export_task(&self, builder: StartExportTaskInputBuilder) -> impl Future<Output = Result<StartExportTaskOutput, SdkError<StartExportTaskError>>> + Send;
    fn stop_activity_stream(&self, builder: StopActivityStreamInputBuilder) -> impl Future<Output = Result<StopActivityStreamOutput, SdkError<StopActivityStreamError>>> + Send;
    fn stop_db_cluster(&self, builder: StopDbClusterInputBuilder) -> impl Future<Output = Result<StopDbClusterOutput, SdkError<StopDBClusterError>>> + Send;
    fn stop_db_instance(&self, builder: StopDbInstanceInputBuilder) -> impl Future<Output = Result<StopDbInstanceOutput, SdkError<StopDBInstanceError>>> + Send;
    fn stop_db_instance_automated_backups_replication(&self, builder: StopDbInstanceAutomatedBackupsReplicationInputBuilder) -> impl Future<Output = Result<StopDbInstanceAutomatedBackupsReplicationOutput, SdkError<StopDBInstanceAutomatedBackupsReplicationError>>> + Send;
    fn switchover_blue_green_deployment(&self, builder: SwitchoverBlueGreenDeploymentInputBuilder) -> impl Future<Output = Result<SwitchoverBlueGreenDeploymentOutput, SdkError<SwitchoverBlueGreenDeploymentError>>> + Send;
    fn switchover_global_cluster(&self, builder: SwitchoverGlobalClusterInputBuilder) -> impl Future<Output = Result<SwitchoverGlobalClusterOutput, SdkError<SwitchoverGlobalClusterError>>> + Send;
    fn switchover_read_replica(&self, builder: SwitchoverReadReplicaInputBuilder) -> impl Future<Output = Result<SwitchoverReadReplicaOutput, SdkError<SwitchoverReadReplicaError>>> + Send;
}

...
pub trait BackupClient {
    fn cancel_legal_hold(&self, builder: CancelLegalHoldInputBuilder) -> impl Future<Output = Result<CancelLegalHoldOutput, SdkError<CancelLegalHoldError>>> + Send;
    fn create_backup_plan(&self, builder: CreateBackupPlanInputBuilder) -> impl Future<Output = Result<CreateBackupPlanOutput, SdkError<CreateBackupPlanError>>> + Send;
    fn create_backup_selection(&self, builder: CreateBackupSelectionInputBuilder) -> impl Future<Output = Result<CreateBackupSelectionOutput, SdkError<CreateBackupSelectionError>>> + Send;
    fn create_backup_vault(&self, builder: CreateBackupVaultInputBuilder) -> impl Future<Output = Result<CreateBackupVaultOutput, SdkError<CreateBackupVaultError>>> + Send;
    fn create_framework(&self, builder: CreateFrameworkInputBuilder) -> impl Future<Output = Result<CreateFrameworkOutput, SdkError<CreateFrameworkError>>> + Send;
    fn create_legal_hold(&self, builder: CreateLegalHoldInputBuilder) -> impl Future<Output = Result<CreateLegalHoldOutput, SdkError<CreateLegalHoldError>>> + Send;
    fn create_logically_air_gapped_backup_vault(&self, builder: CreateLogicallyAirGappedBackupVaultInputBuilder) -> impl Future<Output = Result<CreateLogicallyAirGappedBackupVaultOutput, SdkError<CreateLogicallyAirGappedBackupVaultError>>> + Send;
    fn create_report_plan(&self, builder: CreateReportPlanInputBuilder) -> impl Future<Output = Result<CreateReportPlanOutput, SdkError<CreateReportPlanError>>> + Send;
    fn create_restore_testing_plan(&self, builder: CreateRestoreTestingPlanInputBuilder) -> impl Future<Output = Result<CreateRestoreTestingPlanOutput, SdkError<CreateRestoreTestingPlanError>>> + Send;
    fn create_restore_testing_selection(&self, builder: CreateRestoreTestingSelectionInputBuilder) -> impl Future<Output = Result<CreateRestoreTestingSelectionOutput, SdkError<CreateRestoreTestingSelectionError>>> + Send;
    fn delete_backup_plan(&self, builder: DeleteBackupPlanInputBuilder) -> impl Future<Output = Result<DeleteBackupPlanOutput, SdkError<DeleteBackupPlanError>>> + Send;
    fn delete_backup_selection(&self, builder: DeleteBackupSelectionInputBuilder) -> impl Future<Output = Result<DeleteBackupSelectionOutput, SdkError<DeleteBackupSelectionError>>> + Send;
    fn delete_backup_vault(&self, builder: DeleteBackupVaultInputBuilder) -> impl Future<Output = Result<DeleteBackupVaultOutput, SdkError<DeleteBackupVaultError>>> + Send;
    fn delete_backup_vault_access_policy(&self, builder: DeleteBackupVaultAccessPolicyInputBuilder) -> impl Future<Output = Result<DeleteBackupVaultAccessPolicyOutput, SdkError<DeleteBackupVaultAccessPolicyError>>> + Send;
    fn delete_backup_vault_lock_configuration(&self, builder: DeleteBackupVaultLockConfigurationInputBuilder) -> impl Future<Output = Result<DeleteBackupVaultLockConfigurationOutput, SdkError<DeleteBackupVaultLockConfigurationError>>> + Send;
    fn delete_backup_vault_notifications(&self, builder: DeleteBackupVaultNotificationsInputBuilder) -> impl Future<Output = Result<DeleteBackupVaultNotificationsOutput, SdkError<DeleteBackupVaultNotificationsError>>> + Send;
    fn delete_framework(&self, builder: DeleteFrameworkInputBuilder) -> impl Future<Output = Result<DeleteFrameworkOutput, SdkError<DeleteFrameworkError>>> + Send;
    fn delete_recovery_point(&self, builder: DeleteRecoveryPointInputBuilder) -> impl Future<Output = Result<DeleteRecoveryPointOutput, SdkError<DeleteRecoveryPointError>>> + Send;
    fn delete_report_plan(&self, builder: DeleteReportPlanInputBuilder) -> impl Future<Output = Result<DeleteReportPlanOutput, SdkError<DeleteReportPlanError>>> + Send;
    fn delete_restore_testing_plan(&self, builder: DeleteRestoreTestingPlanInputBuilder) -> impl Future<Output = Result<DeleteRestoreTestingPlanOutput, SdkError<DeleteRestoreTestingPlanError>>> + Send;
    fn delete_restore_testing_selection(&self, builder: DeleteRestoreTestingSelectionInputBuilder) -> impl Future<Output = Result<DeleteRestoreTestingSelectionOutput, SdkError<DeleteRestoreTestingSelectionError>>> + Send;
    fn describe_backup_job(&self, builder: DescribeBackupJobInputBuilder) -> impl Future<Output = Result<DescribeBackupJobOutput, SdkError<DescribeBackupJobError>>> + Send;
    fn describe_backup_vault(&self, builder: DescribeBackupVaultInputBuilder) -> impl Future<Output = Result<DescribeBackupVaultOutput, SdkError<DescribeBackupVaultError>>> + Send;
    fn describe_copy_job(&self, builder: DescribeCopyJobInputBuilder) -> impl Future<Output = Result<DescribeCopyJobOutput, SdkError<DescribeCopyJobError>>> + Send;
    fn describe_framework(&self, builder: DescribeFrameworkInputBuilder) -> impl Future<Output = Result<DescribeFrameworkOutput, SdkError<DescribeFrameworkError>>> + Send;
    fn describe_global_settings(&self, builder: DescribeGlobalSettingsInputBuilder) -> impl Future<Output = Result<DescribeGlobalSettingsOutput, SdkError<DescribeGlobalSettingsError>>> + Send;
    fn describe_protected_resource(&self, builder: DescribeProtectedResourceInputBuilder) -> impl Future<Output = Result<DescribeProtectedResourceOutput, SdkError<DescribeProtectedResourceError>>> + Send;
    fn describe_recovery_point(&self, builder: DescribeRecoveryPointInputBuilder) -> impl Future<Output = Result<DescribeRecoveryPointOutput, SdkError<DescribeRecoveryPointError>>> + Send;
    fn describe_region_settings(&self, builder: DescribeRegionSettingsInputBuilder) -> impl Future<Output = Result<DescribeRegionSettingsOutput, SdkError<DescribeRegionSettingsError>>> + Send;
    fn describe_report_job(&self, builder: DescribeReportJobInputBuilder) -> impl Future<Output = Result<DescribeReportJobOutput, SdkError<DescribeReportJobError>>> + Send;
    fn describe_report_plan(&self, builder: DescribeReportPlanInputBuilder) -> impl Future<Output = Result<DescribeReportPlanOutput, SdkError<DescribeReportPlanError>>> + Send;
    fn describe_restore_job(&self, builder: DescribeRestoreJobInputBuilder) -> impl Future<Output = Result<DescribeRestoreJobOutput, SdkError<DescribeRestoreJobError>>> + Send;
    fn disassociate_recovery_point(&self, builder: DisassociateRecoveryPointInputBuilder) -> impl Future<Output = Result<DisassociateRecoveryPointOutput, SdkError<DisassociateRecoveryPointError>>> + Send;
    fn disassociate_recovery_point_from_parent(&self, builder: DisassociateRecoveryPointFromParentInputBuilder) -> impl Future<Output = Result<DisassociateRecoveryPointFromParentOutput, SdkError<DisassociateRecoveryPointFromParentError>>> + Send;
    fn export_backup_plan_template(&self, builder: ExportBackupPlanTemplateInputBuilder) -> impl Future<Output = Result<ExportBackupPlanTemplateOutput, SdkError<ExportBackupPlanTemplateError>>> + Send;
    fn get_backup_plan(&self, builder: GetBackupPlanInputBuilder) -> impl Future<Output = Result<GetBackupPlanOutput, SdkError<GetBackupPlanError>>> + Send;
    fn get_backup_plan_from_json(&self, builder: GetBackupPlanFromJsonInputBuilder) -> impl Future<Output = Result<GetBackupPlanFromJsonOutput, SdkError<GetBackupPlanFromJSONError>>> + Send;
    fn get_backup_plan_from_template(&self, builder: GetBackupPlanFromTemplateInputBuilder) -> impl Future<Output = Result<GetBackupPlanFromTemplateOutput, SdkError<GetBackupPlanFromTemplateError>>> + Send;
    fn get_backup_selection(&self, builder: GetBackupSelectionInputBuilder) -> impl Future<Output = Result<GetBackupSelectionOutput, SdkError<GetBackupSelectionError>>> + Send;
    fn get_backup_vault_access_policy(&self, builder: GetBackupVaultAccessPolicyInputBuilder) -> impl Future<Output = Result<GetBackupVaultAccessPolicyOutput, SdkError<GetBackupVaultAccessPolicyError>>> + Send;
    fn get_backup_vault_notifications(&self, builder: GetBackupVaultNotificationsInputBuilder) -> impl Future<Output = Result<GetBackupVaultNotificationsOutput, SdkError<GetBackupVaultNotificationsError>>> + Send;
    fn get_legal_hold(&self, builder: GetLegalHoldInputBuilder) -> impl Future<Output = Result<GetLegalHoldOutput, SdkError<GetLegalHoldError>>> + Send;
    fn get_recovery_point_restore_metadata(&self, builder: GetRecoveryPointRestoreMetadataInputBuilder) -> impl Future<Output = Result<GetRecoveryPointRestoreMetadataOutput, SdkError<GetRecoveryPointRestoreMetadataError>>> + Send;
    fn get_restore_job_metadata(&self, builder: GetRestoreJobMetadataInputBuilder) -> impl Future<Output = Result<GetRestoreJobMetadataOutput, SdkError<GetRestoreJobMetadataError>>> + Send;
    fn get_restore_testing_inferred_metadata(&self, builder: GetRestoreTestingInferredMetadataInputBuilder) -> impl Future<Output = Result<GetRestoreTestingInferredMetadataOutput, SdkError<GetRestoreTestingInferredMetadataError>>> + Send;
    fn get_restore_testing_plan(&self, builder: GetRestoreTestingPlanInputBuilder) -> impl Future<Output = Result<GetRestoreTestingPlanOutput, SdkError<GetRestoreTestingPlanError>>> + Send;
    fn get_restore_testing_selection(&self, builder: GetRestoreTestingSelectionInputBuilder) -> impl Future<Output = Result<GetRestoreTestingSelectionOutput, SdkError<GetRestoreTestingSelectionError>>> + Send;
    fn get_supported_resource_types(&self, builder: GetSupportedResourceTypesInputBuilder) -> impl Future<Output = Result<GetSupportedResourceTypesOutput, SdkError<GetSupportedResourceTypesError>>> + Send;
    fn list_backup_job_summaries(&self, builder: ListBackupJobSummariesInputBuilder) -> impl Future<Output = Result<ListBackupJobSummariesOutput, SdkError<ListBackupJobSummariesError>>> + Send;
    fn list_backup_jobs(&self, builder: ListBackupJobsInputBuilder) -> impl Future<Output = Result<ListBackupJobsOutput, SdkError<ListBackupJobsError>>> + Send;
    fn list_backup_plan_templates(&self, builder: ListBackupPlanTemplatesInputBuilder) -> impl Future<Output = Result<ListBackupPlanTemplatesOutput, SdkError<ListBackupPlanTemplatesError>>> + Send;
    fn list_backup_plan_versions(&self, builder: ListBackupPlanVersionsInputBuilder) -> impl Future<Output = Result<ListBackupPlanVersionsOutput, SdkError<ListBackupPlanVersionsError>>> + Send;
    fn list_backup_plans(&self, builder: ListBackupPlansInputBuilder) -> impl Future<Output = Result<ListBackupPlansOutput, SdkError<ListBackupPlansError>>> + Send;
    fn list_backup_selections(&self, builder: ListBackupSelectionsInputBuilder) -> impl Future<Output = Result<ListBackupSelectionsOutput, SdkError<ListBackupSelectionsError>>> + Send;
    fn list_backup_vaults(&self, builder: ListBackupVaultsInputBuilder) -> impl Future<Output = Result<ListBackupVaultsOutput, SdkError<ListBackupVaultsError>>> + Send;
    fn list_copy_job_summaries(&self, builder: ListCopyJobSummariesInputBuilder) -> impl Future<Output = Result<ListCopyJobSummariesOutput, SdkError<ListCopyJobSummariesError>>> + Send;
    fn list_copy_jobs(&self, builder: ListCopyJobsInputBuilder) -> impl Future<Output = Result<ListCopyJobsOutput, SdkError<ListCopyJobsError>>> + Send;
    fn list_frameworks(&self, builder: ListFrameworksInputBuilder) -> impl Future<Output = Result<ListFrameworksOutput, SdkError<ListFrameworksError>>> + Send;
    fn list_legal_holds(&self, builder: ListLegalHoldsInputBuilder) -> impl Future<Output = Result<ListLegalHoldsOutput, SdkError<ListLegalHoldsError>>> + Send;
    fn list_protected_resources(&self, builder: ListProtectedResourcesInputBuilder) -> impl Future<Output = Result<ListProtectedResourcesOutput, SdkError<ListProtectedResourcesError>>> + Send;
    fn list_protected_resources_by_backup_vault(&self, builder: ListProtectedResourcesByBackupVaultInputBuilder) -> impl Future<Output = Result<ListProtectedResourcesByBackupVaultOutput, SdkError<ListProtectedResourcesByBackupVaultError>>> + Send;
    fn list_recovery_points_by_backup_vault(&self, builder: ListRecoveryPointsByBackupVaultInputBuilder) -> impl Future<Output = Result<ListRecoveryPointsByBackupVaultOutput, SdkError<ListRecoveryPointsByBackupVaultError>>> + Send;
    fn list_recovery_points_by_legal_hold(&self, builder: ListRecoveryPointsByLegalHoldInputBuilder) -> impl Future<Output = Result<ListRecoveryPointsByLegalHoldOutput, SdkError<ListRecoveryPointsByLegalHoldError>>> + Send;
    fn list_recovery_points_by_resource(&self, builder: ListRecoveryPointsByResourceInputBuilder) -> impl Future<Output = Result<ListRecoveryPointsByResourceOutput, SdkError<ListRecoveryPointsByResourceError>>> + Send;
    fn list_report_jobs(&self, builder: ListReportJobsInputBuilder) -> impl Future<Output = Result<ListReportJobsOutput, SdkError<ListReportJobsError>>> + Send;
    fn list_report_plans(&self, builder: ListReportPlansInputBuilder) -> impl Future<Output = Result<ListReportPlansOutput, SdkError<ListReportPlansError>>> + Send;
    fn list_restore_job_summaries(&self, builder: ListRestoreJobSummariesInputBuilder) -> impl Future<Output = Result<ListRestoreJobSummariesOutput, SdkError<ListRestoreJobSummariesError>>> + Send;
    fn list_restore_jobs(&self, builder: ListRestoreJobsInputBuilder) -> impl Future<Output = Result<ListRestoreJobsOutput, SdkError<ListRestoreJobsError>>> + Send;
    fn list_restore_jobs_by_protected_resource(&self, builder: ListRestoreJobsByProtectedResourceInputBuilder) -> impl Future<Output = Result<ListRestoreJobsByProtectedResourceOutput, SdkError<ListRestoreJobsByProtectedResourceError>>> + Send;
    fn list_restore_testing_plans(&self, builder: ListRestoreTestingPlansInputBuilder) -> impl Future<Output = Result<ListRestoreTestingPlansOutput, SdkError<ListRestoreTestingPlansError>>> + Send;
    fn list_restore_testing_selections(&self, builder: ListRestoreTestingSelectionsInputBuilder) -> impl Future<Output = Result<ListRestoreTestingSelectionsOutput, SdkError<ListRestoreTestingSelectionsError>>> + Send;
    fn list_tags(&self, builder: ListTagsInputBuilder) -> impl Future<Output = Result<ListTagsOutput, SdkError<ListTagsError>>> + Send;
    fn put_backup_vault_access_policy(&self, builder: PutBackupVaultAccessPolicyInputBuilder) -> impl Future<Output = Result<PutBackupVaultAccessPolicyOutput, SdkError<PutBackupVaultAccessPolicyError>>> + Send;
    fn put_backup_vault_lock_configuration(&self, builder: PutBackupVaultLockConfigurationInputBuilder) -> impl Future<Output = Result<PutBackupVaultLockConfigurationOutput, SdkError<PutBackupVaultLockConfigurationError>>> + Send;
    fn put_backup_vault_notifications(&self, builder: PutBackupVaultNotificationsInputBuilder) -> impl Future<Output = Result<PutBackupVaultNotificationsOutput, SdkError<PutBackupVaultNotificationsError>>> + Send;
    fn put_restore_validation_result(&self, builder: PutRestoreValidationResultInputBuilder) -> impl Future<Output = Result<PutRestoreValidationResultOutput, SdkError<PutRestoreValidationResultError>>> + Send;
    fn start_backup_job(&self, builder: StartBackupJobInputBuilder) -> impl Future<Output = Result<StartBackupJobOutput, SdkError<StartBackupJobError>>> + Send;
    fn start_copy_job(&self, builder: StartCopyJobInputBuilder) -> impl Future<Output = Result<StartCopyJobOutput, SdkError<StartCopyJobError>>> + Send;
    fn start_report_job(&self, builder: StartReportJobInputBuilder) -> impl Future<Output = Result<StartReportJobOutput, SdkError<StartReportJobError>>> + Send;
    fn start_restore_job(&self, builder: StartRestoreJobInputBuilder) -> impl Future<Output = Result<StartRestoreJobOutput, SdkError<StartRestoreJobError>>> + Send;
    fn stop_backup_job(&self, builder: StopBackupJobInputBuilder) -> impl Future<Output = Result<StopBackupJobOutput, SdkError<StopBackupJobError>>> + Send;
    ...
    fn update_backup_plan(&self, builder: UpdateBackupPlanInputBuilder) -> impl Future<Output = Result<UpdateBackupPlanOutput, SdkError<UpdateBackupPlanError>>> + Send;
    fn update_framework(&self, builder: UpdateFrameworkInputBuilder) -> impl Future<Output = Result<UpdateFrameworkOutput, SdkError<UpdateFrameworkError>>> + Send;
    fn update_global_settings(&self, builder: UpdateGlobalSettingsInputBuilder) -> impl Future<Output = Result<UpdateGlobalSettingsOutput, SdkError<UpdateGlobalSettingsError>>> + Send;
    fn update_recovery_point_lifecycle(&self, builder: UpdateRecoveryPointLifecycleInputBuilder) -> impl Future<Output = Result<UpdateRecoveryPointLifecycleOutput, SdkError<UpdateRecoveryPointLifecycleError>>> + Send;
    fn update_region_settings(&self, builder: UpdateRegionSettingsInputBuilder) -> impl Future<Output = Result<UpdateRegionSettingsOutput, SdkError<UpdateRegionSettingsError>>> + Send;
    fn update_report_plan(&self, builder: UpdateReportPlanInputBuilder) -> impl Future<Output = Result<UpdateReportPlanOutput, SdkError<UpdateReportPlanError>>> + Send;
    fn update_restore_testing_plan(&self, builder: UpdateRestoreTestingPlanInputBuilder) -> impl Future<Output = Result<UpdateRestoreTestingPlanOutput, SdkError<UpdateRestoreTestingPlanError>>> + Send;
    fn update_restore_testing_selection(&self, builder: UpdateRestoreTestingSelectionInputBuilder) -> impl Future<Output = Result<UpdateRestoreTestingSelectionOutput, SdkError<UpdateRestoreTestingSelectionError>>> + Send;
}

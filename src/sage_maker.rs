...
pub trait SageMakerClient {
    fn add_association(&self, builder: AddAssociationInputBuilder) -> impl Future<Output = Result<AddAssociationOutput, SdkError<AddAssociationError>>> + Send;
    fn add_tags(&self, builder: AddTagsInputBuilder) -> impl Future<Output = Result<AddTagsOutput, SdkError<AddTagsError>>> + Send;
    fn associate_trial_component(&self, builder: AssociateTrialComponentInputBuilder) -> impl Future<Output = Result<AssociateTrialComponentOutput, SdkError<AssociateTrialComponentError>>> + Send;
    fn batch_describe_model_package(&self, builder: BatchDescribeModelPackageInputBuilder) -> impl Future<Output = Result<BatchDescribeModelPackageOutput, SdkError<BatchDescribeModelPackageError>>> + Send;
    fn create_action(&self, builder: CreateActionInputBuilder) -> impl Future<Output = Result<CreateActionOutput, SdkError<CreateActionError>>> + Send;
    fn create_algorithm(&self, builder: CreateAlgorithmInputBuilder) -> impl Future<Output = Result<CreateAlgorithmOutput, SdkError<CreateAlgorithmError>>> + Send;
    fn create_app(&self, builder: CreateAppInputBuilder) -> impl Future<Output = Result<CreateAppOutput, SdkError<CreateAppError>>> + Send;
    fn create_app_image_config(&self, builder: CreateAppImageConfigInputBuilder) -> impl Future<Output = Result<CreateAppImageConfigOutput, SdkError<CreateAppImageConfigError>>> + Send;
    fn create_artifact(&self, builder: CreateArtifactInputBuilder) -> impl Future<Output = Result<CreateArtifactOutput, SdkError<CreateArtifactError>>> + Send;
    fn create_auto_ml_job(&self, builder: CreateAutoMlJobInputBuilder) -> impl Future<Output = Result<CreateAutoMlJobOutput, SdkError<CreateAutoMLJobError>>> + Send;
    fn create_auto_ml_job_v2(&self, builder: CreateAutoMlJobV2InputBuilder) -> impl Future<Output = Result<CreateAutoMlJobV2Output, SdkError<CreateAutoMLJobV2Error>>> + Send;
    ...
    fn create_code_repository(&self, builder: CreateCodeRepositoryInputBuilder) -> impl Future<Output = Result<CreateCodeRepositoryOutput, SdkError<CreateCodeRepositoryError>>> + Send;
    fn create_compilation_job(&self, builder: CreateCompilationJobInputBuilder) -> impl Future<Output = Result<CreateCompilationJobOutput, SdkError<CreateCompilationJobError>>> + Send;
    fn create_context(&self, builder: CreateContextInputBuilder) -> impl Future<Output = Result<CreateContextOutput, SdkError<CreateContextError>>> + Send;
    fn create_data_quality_job_definition(&self, builder: CreateDataQualityJobDefinitionInputBuilder) -> impl Future<Output = Result<CreateDataQualityJobDefinitionOutput, SdkError<CreateDataQualityJobDefinitionError>>> + Send;
    fn create_device_fleet(&self, builder: CreateDeviceFleetInputBuilder) -> impl Future<Output = Result<CreateDeviceFleetOutput, SdkError<CreateDeviceFleetError>>> + Send;
    ...
    fn create_edge_deployment_plan(&self, builder: CreateEdgeDeploymentPlanInputBuilder) -> impl Future<Output = Result<CreateEdgeDeploymentPlanOutput, SdkError<CreateEdgeDeploymentPlanError>>> + Send;
    fn create_edge_deployment_stage(&self, builder: CreateEdgeDeploymentStageInputBuilder) -> impl Future<Output = Result<CreateEdgeDeploymentStageOutput, SdkError<CreateEdgeDeploymentStageError>>> + Send;
    fn create_edge_packaging_job(&self, builder: CreateEdgePackagingJobInputBuilder) -> impl Future<Output = Result<CreateEdgePackagingJobOutput, SdkError<CreateEdgePackagingJobError>>> + Send;
    fn create_endpoint(&self, builder: CreateEndpointInputBuilder) -> impl Future<Output = Result<CreateEndpointOutput, SdkError<CreateEndpointError>>> + Send;
    fn create_endpoint_config(&self, builder: CreateEndpointConfigInputBuilder) -> impl Future<Output = Result<CreateEndpointConfigOutput, SdkError<CreateEndpointConfigError>>> + Send;
    fn create_experiment(&self, builder: CreateExperimentInputBuilder) -> impl Future<Output = Result<CreateExperimentOutput, SdkError<CreateExperimentError>>> + Send;
    fn create_feature_group(&self, builder: CreateFeatureGroupInputBuilder) -> impl Future<Output = Result<CreateFeatureGroupOutput, SdkError<CreateFeatureGroupError>>> + Send;
    fn create_flow_definition(&self, builder: CreateFlowDefinitionInputBuilder) -> impl Future<Output = Result<CreateFlowDefinitionOutput, SdkError<CreateFlowDefinitionError>>> + Send;
    fn create_hub(&self, builder: CreateHubInputBuilder) -> impl Future<Output = Result<CreateHubOutput, SdkError<CreateHubError>>> + Send;
    fn create_hub_content_reference(&self, builder: CreateHubContentReferenceInputBuilder) -> impl Future<Output = Result<CreateHubContentReferenceOutput, SdkError<CreateHubContentReferenceError>>> + Send;
    fn create_human_task_ui(&self, builder: CreateHumanTaskUiInputBuilder) -> impl Future<Output = Result<CreateHumanTaskUiOutput, SdkError<CreateHumanTaskUiError>>> + Send;
    fn create_hyper_parameter_tuning_job(&self, builder: CreateHyperParameterTuningJobInputBuilder) -> impl Future<Output = Result<CreateHyperParameterTuningJobOutput, SdkError<CreateHyperParameterTuningJobError>>> + Send;
    ...
    fn create_image_version(&self, builder: CreateImageVersionInputBuilder) -> impl Future<Output = Result<CreateImageVersionOutput, SdkError<CreateImageVersionError>>> + Send;
    fn create_inference_component(&self, builder: CreateInferenceComponentInputBuilder) -> impl Future<Output = Result<CreateInferenceComponentOutput, SdkError<CreateInferenceComponentError>>> + Send;
    fn create_inference_experiment(&self, builder: CreateInferenceExperimentInputBuilder) -> impl Future<Output = Result<CreateInferenceExperimentOutput, SdkError<CreateInferenceExperimentError>>> + Send;
    fn create_inference_recommendations_job(&self, builder: CreateInferenceRecommendationsJobInputBuilder) -> impl Future<Output = Result<CreateInferenceRecommendationsJobOutput, SdkError<CreateInferenceRecommendationsJobError>>> + Send;
    fn create_labeling_job(&self, builder: CreateLabelingJobInputBuilder) -> impl Future<Output = Result<CreateLabelingJobOutput, SdkError<CreateLabelingJobError>>> + Send;
    fn create_mlflow_tracking_server(&self, builder: CreateMlflowTrackingServerInputBuilder) -> impl Future<Output = Result<CreateMlflowTrackingServerOutput, SdkError<CreateMlflowTrackingServerError>>> + Send;
    ...
    fn create_model_bias_job_definition(&self, builder: CreateModelBiasJobDefinitionInputBuilder) -> impl Future<Output = Result<CreateModelBiasJobDefinitionOutput, SdkError<CreateModelBiasJobDefinitionError>>> + Send;
    fn create_model_card(&self, builder: CreateModelCardInputBuilder) -> impl Future<Output = Result<CreateModelCardOutput, SdkError<CreateModelCardError>>> + Send;
    fn create_model_card_export_job(&self, builder: CreateModelCardExportJobInputBuilder) -> impl Future<Output = Result<CreateModelCardExportJobOutput, SdkError<CreateModelCardExportJobError>>> + Send;
    fn create_model_explainability_job_definition(&self, builder: CreateModelExplainabilityJobDefinitionInputBuilder) -> impl Future<Output = Result<CreateModelExplainabilityJobDefinitionOutput, SdkError<CreateModelExplainabilityJobDefinitionError>>> + Send;
    fn create_model_package(&self, builder: CreateModelPackageInputBuilder) -> impl Future<Output = Result<CreateModelPackageOutput, SdkError<CreateModelPackageError>>> + Send;
    fn create_model_package_group(&self, builder: CreateModelPackageGroupInputBuilder) -> impl Future<Output = Result<CreateModelPackageGroupOutput, SdkError<CreateModelPackageGroupError>>> + Send;
    fn create_model_quality_job_definition(&self, builder: CreateModelQualityJobDefinitionInputBuilder) -> impl Future<Output = Result<CreateModelQualityJobDefinitionOutput, SdkError<CreateModelQualityJobDefinitionError>>> + Send;
    fn create_monitoring_schedule(&self, builder: CreateMonitoringScheduleInputBuilder) -> impl Future<Output = Result<CreateMonitoringScheduleOutput, SdkError<CreateMonitoringScheduleError>>> + Send;
    fn create_notebook_instance(&self, builder: CreateNotebookInstanceInputBuilder) -> impl Future<Output = Result<CreateNotebookInstanceOutput, SdkError<CreateNotebookInstanceError>>> + Send;
    fn create_notebook_instance_lifecycle_config(&self, builder: CreateNotebookInstanceLifecycleConfigInputBuilder) -> impl Future<Output = Result<CreateNotebookInstanceLifecycleConfigOutput, SdkError<CreateNotebookInstanceLifecycleConfigError>>> + Send;
    fn create_optimization_job(&self, builder: CreateOptimizationJobInputBuilder) -> impl Future<Output = Result<CreateOptimizationJobOutput, SdkError<CreateOptimizationJobError>>> + Send;
    ...
    fn create_presigned_domain_url(&self, builder: CreatePresignedDomainUrlInputBuilder) -> impl Future<Output = Result<CreatePresignedDomainUrlOutput, SdkError<CreatePresignedDomainUrlError>>> + Send;
    fn create_presigned_mlflow_tracking_server_url(&self, builder: CreatePresignedMlflowTrackingServerUrlInputBuilder) -> impl Future<Output = Result<CreatePresignedMlflowTrackingServerUrlOutput, SdkError<CreatePresignedMlflowTrackingServerUrlError>>> + Send;
    fn create_presigned_notebook_instance_url(&self, builder: CreatePresignedNotebookInstanceUrlInputBuilder) -> impl Future<Output = Result<CreatePresignedNotebookInstanceUrlOutput, SdkError<CreatePresignedNotebookInstanceUrlError>>> + Send;
    fn create_processing_job(&self, builder: CreateProcessingJobInputBuilder) -> impl Future<Output = Result<CreateProcessingJobOutput, SdkError<CreateProcessingJobError>>> + Send;
    ...
    fn create_space(&self, builder: CreateSpaceInputBuilder) -> impl Future<Output = Result<CreateSpaceOutput, SdkError<CreateSpaceError>>> + Send;
    fn create_studio_lifecycle_config(&self, builder: CreateStudioLifecycleConfigInputBuilder) -> impl Future<Output = Result<CreateStudioLifecycleConfigOutput, SdkError<CreateStudioLifecycleConfigError>>> + Send;
    fn create_training_job(&self, builder: CreateTrainingJobInputBuilder) -> impl Future<Output = Result<CreateTrainingJobOutput, SdkError<CreateTrainingJobError>>> + Send;
    fn create_transform_job(&self, builder: CreateTransformJobInputBuilder) -> impl Future<Output = Result<CreateTransformJobOutput, SdkError<CreateTransformJobError>>> + Send;
    fn create_trial(&self, builder: CreateTrialInputBuilder) -> impl Future<Output = Result<CreateTrialOutput, SdkError<CreateTrialError>>> + Send;
    fn create_trial_component(&self, builder: CreateTrialComponentInputBuilder) -> impl Future<Output = Result<CreateTrialComponentOutput, SdkError<CreateTrialComponentError>>> + Send;
    fn create_user_profile(&self, builder: CreateUserProfileInputBuilder) -> impl Future<Output = Result<CreateUserProfileOutput, SdkError<CreateUserProfileError>>> + Send;
    fn create_workforce(&self, builder: CreateWorkforceInputBuilder) -> impl Future<Output = Result<CreateWorkforceOutput, SdkError<CreateWorkforceError>>> + Send;
    fn create_workteam(&self, builder: CreateWorkteamInputBuilder) -> impl Future<Output = Result<CreateWorkteamOutput, SdkError<CreateWorkteamError>>> + Send;
    fn delete_action(&self, builder: DeleteActionInputBuilder) -> impl Future<Output = Result<DeleteActionOutput, SdkError<DeleteActionError>>> + Send;
    fn delete_algorithm(&self, builder: DeleteAlgorithmInputBuilder) -> impl Future<Output = Result<DeleteAlgorithmOutput, SdkError<DeleteAlgorithmError>>> + Send;
    fn delete_app(&self, builder: DeleteAppInputBuilder) -> impl Future<Output = Result<DeleteAppOutput, SdkError<DeleteAppError>>> + Send;
    fn delete_app_image_config(&self, builder: DeleteAppImageConfigInputBuilder) -> impl Future<Output = Result<DeleteAppImageConfigOutput, SdkError<DeleteAppImageConfigError>>> + Send;
    fn delete_artifact(&self, builder: DeleteArtifactInputBuilder) -> impl Future<Output = Result<DeleteArtifactOutput, SdkError<DeleteArtifactError>>> + Send;
    ...
    fn delete_code_repository(&self, builder: DeleteCodeRepositoryInputBuilder) -> impl Future<Output = Result<DeleteCodeRepositoryOutput, SdkError<DeleteCodeRepositoryError>>> + Send;
    fn delete_compilation_job(&self, builder: DeleteCompilationJobInputBuilder) -> impl Future<Output = Result<DeleteCompilationJobOutput, SdkError<DeleteCompilationJobError>>> + Send;
    fn delete_context(&self, builder: DeleteContextInputBuilder) -> impl Future<Output = Result<DeleteContextOutput, SdkError<DeleteContextError>>> + Send;
    fn delete_data_quality_job_definition(&self, builder: DeleteDataQualityJobDefinitionInputBuilder) -> impl Future<Output = Result<DeleteDataQualityJobDefinitionOutput, SdkError<DeleteDataQualityJobDefinitionError>>> + Send;
    fn delete_device_fleet(&self, builder: DeleteDeviceFleetInputBuilder) -> impl Future<Output = Result<DeleteDeviceFleetOutput, SdkError<DeleteDeviceFleetError>>> + Send;
    ...
    fn delete_edge_deployment_plan(&self, builder: DeleteEdgeDeploymentPlanInputBuilder) -> impl Future<Output = Result<DeleteEdgeDeploymentPlanOutput, SdkError<DeleteEdgeDeploymentPlanError>>> + Send;
    fn delete_edge_deployment_stage(&self, builder: DeleteEdgeDeploymentStageInputBuilder) -> impl Future<Output = Result<DeleteEdgeDeploymentStageOutput, SdkError<DeleteEdgeDeploymentStageError>>> + Send;
    ...
    fn delete_endpoint_config(&self, builder: DeleteEndpointConfigInputBuilder) -> impl Future<Output = Result<DeleteEndpointConfigOutput, SdkError<DeleteEndpointConfigError>>> + Send;
    fn delete_experiment(&self, builder: DeleteExperimentInputBuilder) -> impl Future<Output = Result<DeleteExperimentOutput, SdkError<DeleteExperimentError>>> + Send;
    fn delete_feature_group(&self, builder: DeleteFeatureGroupInputBuilder) -> impl Future<Output = Result<DeleteFeatureGroupOutput, SdkError<DeleteFeatureGroupError>>> + Send;
    fn delete_flow_definition(&self, builder: DeleteFlowDefinitionInputBuilder) -> impl Future<Output = Result<DeleteFlowDefinitionOutput, SdkError<DeleteFlowDefinitionError>>> + Send;
    fn delete_hub(&self, builder: DeleteHubInputBuilder) -> impl Future<Output = Result<DeleteHubOutput, SdkError<DeleteHubError>>> + Send;
    fn delete_hub_content(&self, builder: DeleteHubContentInputBuilder) -> impl Future<Output = Result<DeleteHubContentOutput, SdkError<DeleteHubContentError>>> + Send;
    fn delete_hub_content_reference(&self, builder: DeleteHubContentReferenceInputBuilder) -> impl Future<Output = Result<DeleteHubContentReferenceOutput, SdkError<DeleteHubContentReferenceError>>> + Send;
    fn delete_human_task_ui(&self, builder: DeleteHumanTaskUiInputBuilder) -> impl Future<Output = Result<DeleteHumanTaskUiOutput, SdkError<DeleteHumanTaskUiError>>> + Send;
    fn delete_hyper_parameter_tuning_job(&self, builder: DeleteHyperParameterTuningJobInputBuilder) -> impl Future<Output = Result<DeleteHyperParameterTuningJobOutput, SdkError<DeleteHyperParameterTuningJobError>>> + Send;
    fn delete_image(&self, builder: DeleteImageInputBuilder) -> impl Future<Output = Result<DeleteImageOutput, SdkError<DeleteImageError>>> + Send;
    fn delete_image_version(&self, builder: DeleteImageVersionInputBuilder) -> impl Future<Output = Result<DeleteImageVersionOutput, SdkError<DeleteImageVersionError>>> + Send;
    fn delete_inference_component(&self, builder: DeleteInferenceComponentInputBuilder) -> impl Future<Output = Result<DeleteInferenceComponentOutput, SdkError<DeleteInferenceComponentError>>> + Send;
    fn delete_inference_experiment(&self, builder: DeleteInferenceExperimentInputBuilder) -> impl Future<Output = Result<DeleteInferenceExperimentOutput, SdkError<DeleteInferenceExperimentError>>> + Send;
    fn delete_mlflow_tracking_server(&self, builder: DeleteMlflowTrackingServerInputBuilder) -> impl Future<Output = Result<DeleteMlflowTrackingServerOutput, SdkError<DeleteMlflowTrackingServerError>>> + Send;
    ...
    fn delete_model_bias_job_definition(&self, builder: DeleteModelBiasJobDefinitionInputBuilder) -> impl Future<Output = Result<DeleteModelBiasJobDefinitionOutput, SdkError<DeleteModelBiasJobDefinitionError>>> + Send;
    fn delete_model_card(&self, builder: DeleteModelCardInputBuilder) -> impl Future<Output = Result<DeleteModelCardOutput, SdkError<DeleteModelCardError>>> + Send;
    fn delete_model_explainability_job_definition(&self, builder: DeleteModelExplainabilityJobDefinitionInputBuilder) -> impl Future<Output = Result<DeleteModelExplainabilityJobDefinitionOutput, SdkError<DeleteModelExplainabilityJobDefinitionError>>> + Send;
    fn delete_model_package(&self, builder: DeleteModelPackageInputBuilder) -> impl Future<Output = Result<DeleteModelPackageOutput, SdkError<DeleteModelPackageError>>> + Send;
    fn delete_model_package_group(&self, builder: DeleteModelPackageGroupInputBuilder) -> impl Future<Output = Result<DeleteModelPackageGroupOutput, SdkError<DeleteModelPackageGroupError>>> + Send;
    fn delete_model_package_group_policy(&self, builder: DeleteModelPackageGroupPolicyInputBuilder) -> impl Future<Output = Result<DeleteModelPackageGroupPolicyOutput, SdkError<DeleteModelPackageGroupPolicyError>>> + Send;
    fn delete_model_quality_job_definition(&self, builder: DeleteModelQualityJobDefinitionInputBuilder) -> impl Future<Output = Result<DeleteModelQualityJobDefinitionOutput, SdkError<DeleteModelQualityJobDefinitionError>>> + Send;
    fn delete_monitoring_schedule(&self, builder: DeleteMonitoringScheduleInputBuilder) -> impl Future<Output = Result<DeleteMonitoringScheduleOutput, SdkError<DeleteMonitoringScheduleError>>> + Send;
    fn delete_notebook_instance(&self, builder: DeleteNotebookInstanceInputBuilder) -> impl Future<Output = Result<DeleteNotebookInstanceOutput, SdkError<DeleteNotebookInstanceError>>> + Send;
    fn delete_notebook_instance_lifecycle_config(&self, builder: DeleteNotebookInstanceLifecycleConfigInputBuilder) -> impl Future<Output = Result<DeleteNotebookInstanceLifecycleConfigOutput, SdkError<DeleteNotebookInstanceLifecycleConfigError>>> + Send;
    fn delete_optimization_job(&self, builder: DeleteOptimizationJobInputBuilder) -> impl Future<Output = Result<DeleteOptimizationJobOutput, SdkError<DeleteOptimizationJobError>>> + Send;
    ...
    fn delete_space(&self, builder: DeleteSpaceInputBuilder) -> impl Future<Output = Result<DeleteSpaceOutput, SdkError<DeleteSpaceError>>> + Send;
    fn delete_studio_lifecycle_config(&self, builder: DeleteStudioLifecycleConfigInputBuilder) -> impl Future<Output = Result<DeleteStudioLifecycleConfigOutput, SdkError<DeleteStudioLifecycleConfigError>>> + Send;
    ...
    fn delete_trial(&self, builder: DeleteTrialInputBuilder) -> impl Future<Output = Result<DeleteTrialOutput, SdkError<DeleteTrialError>>> + Send;
    fn delete_trial_component(&self, builder: DeleteTrialComponentInputBuilder) -> impl Future<Output = Result<DeleteTrialComponentOutput, SdkError<DeleteTrialComponentError>>> + Send;
    fn delete_user_profile(&self, builder: DeleteUserProfileInputBuilder) -> impl Future<Output = Result<DeleteUserProfileOutput, SdkError<DeleteUserProfileError>>> + Send;
    fn delete_workforce(&self, builder: DeleteWorkforceInputBuilder) -> impl Future<Output = Result<DeleteWorkforceOutput, SdkError<DeleteWorkforceError>>> + Send;
    fn delete_workteam(&self, builder: DeleteWorkteamInputBuilder) -> impl Future<Output = Result<DeleteWorkteamOutput, SdkError<DeleteWorkteamError>>> + Send;
    fn deregister_devices(&self, builder: DeregisterDevicesInputBuilder) -> impl Future<Output = Result<DeregisterDevicesOutput, SdkError<DeregisterDevicesError>>> + Send;
    fn describe_action(&self, builder: DescribeActionInputBuilder) -> impl Future<Output = Result<DescribeActionOutput, SdkError<DescribeActionError>>> + Send;
    fn describe_algorithm(&self, builder: DescribeAlgorithmInputBuilder) -> impl Future<Output = Result<DescribeAlgorithmOutput, SdkError<DescribeAlgorithmError>>> + Send;
    fn describe_app(&self, builder: DescribeAppInputBuilder) -> impl Future<Output = Result<DescribeAppOutput, SdkError<DescribeAppError>>> + Send;
    fn describe_app_image_config(&self, builder: DescribeAppImageConfigInputBuilder) -> impl Future<Output = Result<DescribeAppImageConfigOutput, SdkError<DescribeAppImageConfigError>>> + Send;
    fn describe_artifact(&self, builder: DescribeArtifactInputBuilder) -> impl Future<Output = Result<DescribeArtifactOutput, SdkError<DescribeArtifactError>>> + Send;
    fn describe_auto_ml_job(&self, builder: DescribeAutoMlJobInputBuilder) -> impl Future<Output = Result<DescribeAutoMlJobOutput, SdkError<DescribeAutoMLJobError>>> + Send;
    fn describe_auto_ml_job_v2(&self, builder: DescribeAutoMlJobV2InputBuilder) -> impl Future<Output = Result<DescribeAutoMlJobV2Output, SdkError<DescribeAutoMLJobV2Error>>> + Send;
    ...
    fn describe_cluster_node(&self, builder: DescribeClusterNodeInputBuilder) -> impl Future<Output = Result<DescribeClusterNodeOutput, SdkError<DescribeClusterNodeError>>> + Send;
    fn describe_code_repository(&self, builder: DescribeCodeRepositoryInputBuilder) -> impl Future<Output = Result<DescribeCodeRepositoryOutput, SdkError<DescribeCodeRepositoryError>>> + Send;
    fn describe_compilation_job(&self, builder: DescribeCompilationJobInputBuilder) -> impl Future<Output = Result<DescribeCompilationJobOutput, SdkError<DescribeCompilationJobError>>> + Send;
    fn describe_context(&self, builder: DescribeContextInputBuilder) -> impl Future<Output = Result<DescribeContextOutput, SdkError<DescribeContextError>>> + Send;
    fn describe_data_quality_job_definition(&self, builder: DescribeDataQualityJobDefinitionInputBuilder) -> impl Future<Output = Result<DescribeDataQualityJobDefinitionOutput, SdkError<DescribeDataQualityJobDefinitionError>>> + Send;
    fn describe_device(&self, builder: DescribeDeviceInputBuilder) -> impl Future<Output = Result<DescribeDeviceOutput, SdkError<DescribeDeviceError>>> + Send;
    fn describe_device_fleet(&self, builder: DescribeDeviceFleetInputBuilder) -> impl Future<Output = Result<DescribeDeviceFleetOutput, SdkError<DescribeDeviceFleetError>>> + Send;
    ...
    fn describe_edge_deployment_plan(&self, builder: DescribeEdgeDeploymentPlanInputBuilder) -> impl Future<Output = Result<DescribeEdgeDeploymentPlanOutput, SdkError<DescribeEdgeDeploymentPlanError>>> + Send;
    fn describe_edge_packaging_job(&self, builder: DescribeEdgePackagingJobInputBuilder) -> impl Future<Output = Result<DescribeEdgePackagingJobOutput, SdkError<DescribeEdgePackagingJobError>>> + Send;
    fn describe_endpoint(&self, builder: DescribeEndpointInputBuilder) -> impl Future<Output = Result<DescribeEndpointOutput, SdkError<DescribeEndpointError>>> + Send;
    fn describe_endpoint_config(&self, builder: DescribeEndpointConfigInputBuilder) -> impl Future<Output = Result<DescribeEndpointConfigOutput, SdkError<DescribeEndpointConfigError>>> + Send;
    fn describe_experiment(&self, builder: DescribeExperimentInputBuilder) -> impl Future<Output = Result<DescribeExperimentOutput, SdkError<DescribeExperimentError>>> + Send;
    fn describe_feature_group(&self, builder: DescribeFeatureGroupInputBuilder) -> impl Future<Output = Result<DescribeFeatureGroupOutput, SdkError<DescribeFeatureGroupError>>> + Send;
    fn describe_feature_metadata(&self, builder: DescribeFeatureMetadataInputBuilder) -> impl Future<Output = Result<DescribeFeatureMetadataOutput, SdkError<DescribeFeatureMetadataError>>> + Send;
    fn describe_flow_definition(&self, builder: DescribeFlowDefinitionInputBuilder) -> impl Future<Output = Result<DescribeFlowDefinitionOutput, SdkError<DescribeFlowDefinitionError>>> + Send;
    fn describe_hub(&self, builder: DescribeHubInputBuilder) -> impl Future<Output = Result<DescribeHubOutput, SdkError<DescribeHubError>>> + Send;
    fn describe_hub_content(&self, builder: DescribeHubContentInputBuilder) -> impl Future<Output = Result<DescribeHubContentOutput, SdkError<DescribeHubContentError>>> + Send;
    fn describe_human_task_ui(&self, builder: DescribeHumanTaskUiInputBuilder) -> impl Future<Output = Result<DescribeHumanTaskUiOutput, SdkError<DescribeHumanTaskUiError>>> + Send;
    fn describe_hyper_parameter_tuning_job(&self, builder: DescribeHyperParameterTuningJobInputBuilder) -> impl Future<Output = Result<DescribeHyperParameterTuningJobOutput, SdkError<DescribeHyperParameterTuningJobError>>> + Send;
    fn describe_image(&self, builder: DescribeImageInputBuilder) -> impl Future<Output = Result<DescribeImageOutput, SdkError<DescribeImageError>>> + Send;
    fn describe_image_version(&self, builder: DescribeImageVersionInputBuilder) -> impl Future<Output = Result<DescribeImageVersionOutput, SdkError<DescribeImageVersionError>>> + Send;
    fn describe_inference_component(&self, builder: DescribeInferenceComponentInputBuilder) -> impl Future<Output = Result<DescribeInferenceComponentOutput, SdkError<DescribeInferenceComponentError>>> + Send;
    fn describe_inference_experiment(&self, builder: DescribeInferenceExperimentInputBuilder) -> impl Future<Output = Result<DescribeInferenceExperimentOutput, SdkError<DescribeInferenceExperimentError>>> + Send;
    fn describe_inference_recommendations_job(&self, builder: DescribeInferenceRecommendationsJobInputBuilder) -> impl Future<Output = Result<DescribeInferenceRecommendationsJobOutput, SdkError<DescribeInferenceRecommendationsJobError>>> + Send;
    fn describe_labeling_job(&self, builder: DescribeLabelingJobInputBuilder) -> impl Future<Output = Result<DescribeLabelingJobOutput, SdkError<DescribeLabelingJobError>>> + Send;
    fn describe_lineage_group(&self, builder: DescribeLineageGroupInputBuilder) -> impl Future<Output = Result<DescribeLineageGroupOutput, SdkError<DescribeLineageGroupError>>> + Send;
    fn describe_mlflow_tracking_server(&self, builder: DescribeMlflowTrackingServerInputBuilder) -> impl Future<Output = Result<DescribeMlflowTrackingServerOutput, SdkError<DescribeMlflowTrackingServerError>>> + Send;
    fn describe_model(&self, builder: DescribeModelInputBuilder) -> impl Future<Output = Result<DescribeModelOutput, SdkError<DescribeModelError>>> + Send;
    fn describe_model_bias_job_definition(&self, builder: DescribeModelBiasJobDefinitionInputBuilder) -> impl Future<Output = Result<DescribeModelBiasJobDefinitionOutput, SdkError<DescribeModelBiasJobDefinitionError>>> + Send;
    fn describe_model_card(&self, builder: DescribeModelCardInputBuilder) -> impl Future<Output = Result<DescribeModelCardOutput, SdkError<DescribeModelCardError>>> + Send;
    fn describe_model_card_export_job(&self, builder: DescribeModelCardExportJobInputBuilder) -> impl Future<Output = Result<DescribeModelCardExportJobOutput, SdkError<DescribeModelCardExportJobError>>> + Send;
    fn describe_model_explainability_job_definition(&self, builder: DescribeModelExplainabilityJobDefinitionInputBuilder) -> impl Future<Output = Result<DescribeModelExplainabilityJobDefinitionOutput, SdkError<DescribeModelExplainabilityJobDefinitionError>>> + Send;
    fn describe_model_package(&self, builder: DescribeModelPackageInputBuilder) -> impl Future<Output = Result<DescribeModelPackageOutput, SdkError<DescribeModelPackageError>>> + Send;
    fn describe_model_package_group(&self, builder: DescribeModelPackageGroupInputBuilder) -> impl Future<Output = Result<DescribeModelPackageGroupOutput, SdkError<DescribeModelPackageGroupError>>> + Send;
    fn describe_model_quality_job_definition(&self, builder: DescribeModelQualityJobDefinitionInputBuilder) -> impl Future<Output = Result<DescribeModelQualityJobDefinitionOutput, SdkError<DescribeModelQualityJobDefinitionError>>> + Send;
    fn describe_monitoring_schedule(&self, builder: DescribeMonitoringScheduleInputBuilder) -> impl Future<Output = Result<DescribeMonitoringScheduleOutput, SdkError<DescribeMonitoringScheduleError>>> + Send;
    fn describe_notebook_instance(&self, builder: DescribeNotebookInstanceInputBuilder) -> impl Future<Output = Result<DescribeNotebookInstanceOutput, SdkError<DescribeNotebookInstanceError>>> + Send;
    fn describe_notebook_instance_lifecycle_config(&self, builder: DescribeNotebookInstanceLifecycleConfigInputBuilder) -> impl Future<Output = Result<DescribeNotebookInstanceLifecycleConfigOutput, SdkError<DescribeNotebookInstanceLifecycleConfigError>>> + Send;
    fn describe_optimization_job(&self, builder: DescribeOptimizationJobInputBuilder) -> impl Future<Output = Result<DescribeOptimizationJobOutput, SdkError<DescribeOptimizationJobError>>> + Send;
    fn describe_pipeline(&self, builder: DescribePipelineInputBuilder) -> impl Future<Output = Result<DescribePipelineOutput, SdkError<DescribePipelineError>>> + Send;
    fn describe_pipeline_definition_for_execution(&self, builder: DescribePipelineDefinitionForExecutionInputBuilder) -> impl Future<Output = Result<DescribePipelineDefinitionForExecutionOutput, SdkError<DescribePipelineDefinitionForExecutionError>>> + Send;
    fn describe_pipeline_execution(&self, builder: DescribePipelineExecutionInputBuilder) -> impl Future<Output = Result<DescribePipelineExecutionOutput, SdkError<DescribePipelineExecutionError>>> + Send;
    fn describe_processing_job(&self, builder: DescribeProcessingJobInputBuilder) -> impl Future<Output = Result<DescribeProcessingJobOutput, SdkError<DescribeProcessingJobError>>> + Send;
    fn describe_project(&self, builder: DescribeProjectInputBuilder) -> impl Future<Output = Result<DescribeProjectOutput, SdkError<DescribeProjectError>>> + Send;
    fn describe_space(&self, builder: DescribeSpaceInputBuilder) -> impl Future<Output = Result<DescribeSpaceOutput, SdkError<DescribeSpaceError>>> + Send;
    fn describe_studio_lifecycle_config(&self, builder: DescribeStudioLifecycleConfigInputBuilder) -> impl Future<Output = Result<DescribeStudioLifecycleConfigOutput, SdkError<DescribeStudioLifecycleConfigError>>> + Send;
    fn describe_subscribed_workteam(&self, builder: DescribeSubscribedWorkteamInputBuilder) -> impl Future<Output = Result<DescribeSubscribedWorkteamOutput, SdkError<DescribeSubscribedWorkteamError>>> + Send;
    fn describe_training_job(&self, builder: DescribeTrainingJobInputBuilder) -> impl Future<Output = Result<DescribeTrainingJobOutput, SdkError<DescribeTrainingJobError>>> + Send;
    fn describe_transform_job(&self, builder: DescribeTransformJobInputBuilder) -> impl Future<Output = Result<DescribeTransformJobOutput, SdkError<DescribeTransformJobError>>> + Send;
    fn describe_trial(&self, builder: DescribeTrialInputBuilder) -> impl Future<Output = Result<DescribeTrialOutput, SdkError<DescribeTrialError>>> + Send;
    fn describe_trial_component(&self, builder: DescribeTrialComponentInputBuilder) -> impl Future<Output = Result<DescribeTrialComponentOutput, SdkError<DescribeTrialComponentError>>> + Send;
    fn describe_user_profile(&self, builder: DescribeUserProfileInputBuilder) -> impl Future<Output = Result<DescribeUserProfileOutput, SdkError<DescribeUserProfileError>>> + Send;
    fn describe_workforce(&self, builder: DescribeWorkforceInputBuilder) -> impl Future<Output = Result<DescribeWorkforceOutput, SdkError<DescribeWorkforceError>>> + Send;
    fn describe_workteam(&self, builder: DescribeWorkteamInputBuilder) -> impl Future<Output = Result<DescribeWorkteamOutput, SdkError<DescribeWorkteamError>>> + Send;
    fn disable_sagemaker_servicecatalog_portfolio(&self, builder: DisableSagemakerServicecatalogPortfolioInputBuilder) -> impl Future<Output = Result<DisableSagemakerServicecatalogPortfolioOutput, SdkError<DisableSagemakerServicecatalogPortfolioError>>> + Send;
    fn disassociate_trial_component(&self, builder: DisassociateTrialComponentInputBuilder) -> impl Future<Output = Result<DisassociateTrialComponentOutput, SdkError<DisassociateTrialComponentError>>> + Send;
    fn enable_sagemaker_servicecatalog_portfolio(&self, builder: EnableSagemakerServicecatalogPortfolioInputBuilder) -> impl Future<Output = Result<EnableSagemakerServicecatalogPortfolioOutput, SdkError<EnableSagemakerServicecatalogPortfolioError>>> + Send;
    fn get_device_fleet_report(&self, builder: GetDeviceFleetReportInputBuilder) -> impl Future<Output = Result<GetDeviceFleetReportOutput, SdkError<GetDeviceFleetReportError>>> + Send;
    fn get_lineage_group_policy(&self, builder: GetLineageGroupPolicyInputBuilder) -> impl Future<Output = Result<GetLineageGroupPolicyOutput, SdkError<GetLineageGroupPolicyError>>> + Send;
    fn get_model_package_group_policy(&self, builder: GetModelPackageGroupPolicyInputBuilder) -> impl Future<Output = Result<GetModelPackageGroupPolicyOutput, SdkError<GetModelPackageGroupPolicyError>>> + Send;
    fn get_sagemaker_servicecatalog_portfolio_status(&self, builder: GetSagemakerServicecatalogPortfolioStatusInputBuilder) -> impl Future<Output = Result<GetSagemakerServicecatalogPortfolioStatusOutput, SdkError<GetSagemakerServicecatalogPortfolioStatusError>>> + Send;
    fn get_scaling_configuration_recommendation(&self, builder: GetScalingConfigurationRecommendationInputBuilder) -> impl Future<Output = Result<GetScalingConfigurationRecommendationOutput, SdkError<GetScalingConfigurationRecommendationError>>> + Send;
    fn get_search_suggestions(&self, builder: GetSearchSuggestionsInputBuilder) -> impl Future<Output = Result<GetSearchSuggestionsOutput, SdkError<GetSearchSuggestionsError>>> + Send;
    fn import_hub_content(&self, builder: ImportHubContentInputBuilder) -> impl Future<Output = Result<ImportHubContentOutput, SdkError<ImportHubContentError>>> + Send;
    fn list_actions(&self, builder: ListActionsInputBuilder) -> impl Future<Output = Result<ListActionsOutput, SdkError<ListActionsError>>> + Send;
    fn list_algorithms(&self, builder: ListAlgorithmsInputBuilder) -> impl Future<Output = Result<ListAlgorithmsOutput, SdkError<ListAlgorithmsError>>> + Send;
    ...
    fn list_app_image_configs(&self, builder: ListAppImageConfigsInputBuilder) -> impl Future<Output = Result<ListAppImageConfigsOutput, SdkError<ListAppImageConfigsError>>> + Send;
    fn list_apps(&self, builder: ListAppsInputBuilder) -> impl Future<Output = Result<ListAppsOutput, SdkError<ListAppsError>>> + Send;
    fn list_artifacts(&self, builder: ListArtifactsInputBuilder) -> impl Future<Output = Result<ListArtifactsOutput, SdkError<ListArtifactsError>>> + Send;
    ...
    fn list_auto_ml_jobs(&self, builder: ListAutoMlJobsInputBuilder) -> impl Future<Output = Result<ListAutoMlJobsOutput, SdkError<ListAutoMLJobsError>>> + Send;
    fn list_candidates_for_auto_ml_job(&self, builder: ListCandidatesForAutoMlJobInputBuilder) -> impl Future<Output = Result<ListCandidatesForAutoMlJobOutput, SdkError<ListCandidatesForAutoMLJobError>>> + Send;
    fn list_cluster_nodes(&self, builder: ListClusterNodesInputBuilder) -> impl Future<Output = Result<ListClusterNodesOutput, SdkError<ListClusterNodesError>>> + Send;
    ...
    fn list_code_repositories(&self, builder: ListCodeRepositoriesInputBuilder) -> impl Future<Output = Result<ListCodeRepositoriesOutput, SdkError<ListCodeRepositoriesError>>> + Send;
    fn list_compilation_jobs(&self, builder: ListCompilationJobsInputBuilder) -> impl Future<Output = Result<ListCompilationJobsOutput, SdkError<ListCompilationJobsError>>> + Send;
    fn list_contexts(&self, builder: ListContextsInputBuilder) -> impl Future<Output = Result<ListContextsOutput, SdkError<ListContextsError>>> + Send;
    fn list_data_quality_job_definitions(&self, builder: ListDataQualityJobDefinitionsInputBuilder) -> impl Future<Output = Result<ListDataQualityJobDefinitionsOutput, SdkError<ListDataQualityJobDefinitionsError>>> + Send;
    fn list_device_fleets(&self, builder: ListDeviceFleetsInputBuilder) -> impl Future<Output = Result<ListDeviceFleetsOutput, SdkError<ListDeviceFleetsError>>> + Send;
    ...
    fn list_domains(&self, builder: ListDomainsInputBuilder) -> impl Future<Output = Result<ListDomainsOutput, SdkError<ListDomainsError>>> + Send;
    fn list_edge_deployment_plans(&self, builder: ListEdgeDeploymentPlansInputBuilder) -> impl Future<Output = Result<ListEdgeDeploymentPlansOutput, SdkError<ListEdgeDeploymentPlansError>>> + Send;
    fn list_edge_packaging_jobs(&self, builder: ListEdgePackagingJobsInputBuilder) -> impl Future<Output = Result<ListEdgePackagingJobsOutput, SdkError<ListEdgePackagingJobsError>>> + Send;
    fn list_endpoint_configs(&self, builder: ListEndpointConfigsInputBuilder) -> impl Future<Output = Result<ListEndpointConfigsOutput, SdkError<ListEndpointConfigsError>>> + Send;
    fn list_endpoints(&self, builder: ListEndpointsInputBuilder) -> impl Future<Output = Result<ListEndpointsOutput, SdkError<ListEndpointsError>>> + Send;
    fn list_experiments(&self, builder: ListExperimentsInputBuilder) -> impl Future<Output = Result<ListExperimentsOutput, SdkError<ListExperimentsError>>> + Send;
    fn list_feature_groups(&self, builder: ListFeatureGroupsInputBuilder) -> impl Future<Output = Result<ListFeatureGroupsOutput, SdkError<ListFeatureGroupsError>>> + Send;
    fn list_flow_definitions(&self, builder: ListFlowDefinitionsInputBuilder) -> impl Future<Output = Result<ListFlowDefinitionsOutput, SdkError<ListFlowDefinitionsError>>> + Send;
    fn list_hub_content_versions(&self, builder: ListHubContentVersionsInputBuilder) -> impl Future<Output = Result<ListHubContentVersionsOutput, SdkError<ListHubContentVersionsError>>> + Send;
    fn list_hub_contents(&self, builder: ListHubContentsInputBuilder) -> impl Future<Output = Result<ListHubContentsOutput, SdkError<ListHubContentsError>>> + Send;
    fn list_hubs(&self, builder: ListHubsInputBuilder) -> impl Future<Output = Result<ListHubsOutput, SdkError<ListHubsError>>> + Send;
    fn list_human_task_uis(&self, builder: ListHumanTaskUisInputBuilder) -> impl Future<Output = Result<ListHumanTaskUisOutput, SdkError<ListHumanTaskUisError>>> + Send;
    fn list_hyper_parameter_tuning_jobs(&self, builder: ListHyperParameterTuningJobsInputBuilder) -> impl Future<Output = Result<ListHyperParameterTuningJobsOutput, SdkError<ListHyperParameterTuningJobsError>>> + Send;
    fn list_image_versions(&self, builder: ListImageVersionsInputBuilder) -> impl Future<Output = Result<ListImageVersionsOutput, SdkError<ListImageVersionsError>>> + Send;
    fn list_images(&self, builder: ListImagesInputBuilder) -> impl Future<Output = Result<ListImagesOutput, SdkError<ListImagesError>>> + Send;
    fn list_inference_components(&self, builder: ListInferenceComponentsInputBuilder) -> impl Future<Output = Result<ListInferenceComponentsOutput, SdkError<ListInferenceComponentsError>>> + Send;
    fn list_inference_experiments(&self, builder: ListInferenceExperimentsInputBuilder) -> impl Future<Output = Result<ListInferenceExperimentsOutput, SdkError<ListInferenceExperimentsError>>> + Send;
    fn list_inference_recommendations_job_steps(&self, builder: ListInferenceRecommendationsJobStepsInputBuilder) -> impl Future<Output = Result<ListInferenceRecommendationsJobStepsOutput, SdkError<ListInferenceRecommendationsJobStepsError>>> + Send;
    fn list_inference_recommendations_jobs(&self, builder: ListInferenceRecommendationsJobsInputBuilder) -> impl Future<Output = Result<ListInferenceRecommendationsJobsOutput, SdkError<ListInferenceRecommendationsJobsError>>> + Send;
    fn list_labeling_jobs(&self, builder: ListLabelingJobsInputBuilder) -> impl Future<Output = Result<ListLabelingJobsOutput, SdkError<ListLabelingJobsError>>> + Send;
    fn list_labeling_jobs_for_workteam(&self, builder: ListLabelingJobsForWorkteamInputBuilder) -> impl Future<Output = Result<ListLabelingJobsForWorkteamOutput, SdkError<ListLabelingJobsForWorkteamError>>> + Send;
    fn list_lineage_groups(&self, builder: ListLineageGroupsInputBuilder) -> impl Future<Output = Result<ListLineageGroupsOutput, SdkError<ListLineageGroupsError>>> + Send;
    fn list_mlflow_tracking_servers(&self, builder: ListMlflowTrackingServersInputBuilder) -> impl Future<Output = Result<ListMlflowTrackingServersOutput, SdkError<ListMlflowTrackingServersError>>> + Send;
    fn list_model_bias_job_definitions(&self, builder: ListModelBiasJobDefinitionsInputBuilder) -> impl Future<Output = Result<ListModelBiasJobDefinitionsOutput, SdkError<ListModelBiasJobDefinitionsError>>> + Send;
    fn list_model_card_export_jobs(&self, builder: ListModelCardExportJobsInputBuilder) -> impl Future<Output = Result<ListModelCardExportJobsOutput, SdkError<ListModelCardExportJobsError>>> + Send;
    fn list_model_card_versions(&self, builder: ListModelCardVersionsInputBuilder) -> impl Future<Output = Result<ListModelCardVersionsOutput, SdkError<ListModelCardVersionsError>>> + Send;
    fn list_model_cards(&self, builder: ListModelCardsInputBuilder) -> impl Future<Output = Result<ListModelCardsOutput, SdkError<ListModelCardsError>>> + Send;
    fn list_model_explainability_job_definitions(&self, builder: ListModelExplainabilityJobDefinitionsInputBuilder) -> impl Future<Output = Result<ListModelExplainabilityJobDefinitionsOutput, SdkError<ListModelExplainabilityJobDefinitionsError>>> + Send;
    fn list_model_metadata(&self, builder: ListModelMetadataInputBuilder) -> impl Future<Output = Result<ListModelMetadataOutput, SdkError<ListModelMetadataError>>> + Send;
    fn list_model_package_groups(&self, builder: ListModelPackageGroupsInputBuilder) -> impl Future<Output = Result<ListModelPackageGroupsOutput, SdkError<ListModelPackageGroupsError>>> + Send;
    fn list_model_packages(&self, builder: ListModelPackagesInputBuilder) -> impl Future<Output = Result<ListModelPackagesOutput, SdkError<ListModelPackagesError>>> + Send;
    fn list_model_quality_job_definitions(&self, builder: ListModelQualityJobDefinitionsInputBuilder) -> impl Future<Output = Result<ListModelQualityJobDefinitionsOutput, SdkError<ListModelQualityJobDefinitionsError>>> + Send;
    fn list_models(&self, builder: ListModelsInputBuilder) -> impl Future<Output = Result<ListModelsOutput, SdkError<ListModelsError>>> + Send;
    fn list_monitoring_alert_history(&self, builder: ListMonitoringAlertHistoryInputBuilder) -> impl Future<Output = Result<ListMonitoringAlertHistoryOutput, SdkError<ListMonitoringAlertHistoryError>>> + Send;
    fn list_monitoring_alerts(&self, builder: ListMonitoringAlertsInputBuilder) -> impl Future<Output = Result<ListMonitoringAlertsOutput, SdkError<ListMonitoringAlertsError>>> + Send;
    fn list_monitoring_executions(&self, builder: ListMonitoringExecutionsInputBuilder) -> impl Future<Output = Result<ListMonitoringExecutionsOutput, SdkError<ListMonitoringExecutionsError>>> + Send;
    fn list_monitoring_schedules(&self, builder: ListMonitoringSchedulesInputBuilder) -> impl Future<Output = Result<ListMonitoringSchedulesOutput, SdkError<ListMonitoringSchedulesError>>> + Send;
    fn list_notebook_instance_lifecycle_configs(&self, builder: ListNotebookInstanceLifecycleConfigsInputBuilder) -> impl Future<Output = Result<ListNotebookInstanceLifecycleConfigsOutput, SdkError<ListNotebookInstanceLifecycleConfigsError>>> + Send;
    fn list_notebook_instances(&self, builder: ListNotebookInstancesInputBuilder) -> impl Future<Output = Result<ListNotebookInstancesOutput, SdkError<ListNotebookInstancesError>>> + Send;
    fn list_optimization_jobs(&self, builder: ListOptimizationJobsInputBuilder) -> impl Future<Output = Result<ListOptimizationJobsOutput, SdkError<ListOptimizationJobsError>>> + Send;
    fn list_pipeline_execution_steps(&self, builder: ListPipelineExecutionStepsInputBuilder) -> impl Future<Output = Result<ListPipelineExecutionStepsOutput, SdkError<ListPipelineExecutionStepsError>>> + Send;
    ...
    fn list_pipeline_parameters_for_execution(&self, builder: ListPipelineParametersForExecutionInputBuilder) -> impl Future<Output = Result<ListPipelineParametersForExecutionOutput, SdkError<ListPipelineParametersForExecutionError>>> + Send;
    ...
    fn list_processing_jobs(&self, builder: ListProcessingJobsInputBuilder) -> impl Future<Output = Result<ListProcessingJobsOutput, SdkError<ListProcessingJobsError>>> + Send;
    fn list_projects(&self, builder: ListProjectsInputBuilder) -> impl Future<Output = Result<ListProjectsOutput, SdkError<ListProjectsError>>> + Send;
    fn list_resource_catalogs(&self, builder: ListResourceCatalogsInputBuilder) -> impl Future<Output = Result<ListResourceCatalogsOutput, SdkError<ListResourceCatalogsError>>> + Send;
    fn list_spaces(&self, builder: ListSpacesInputBuilder) -> impl Future<Output = Result<ListSpacesOutput, SdkError<ListSpacesError>>> + Send;
    fn list_stage_devices(&self, builder: ListStageDevicesInputBuilder) -> impl Future<Output = Result<ListStageDevicesOutput, SdkError<ListStageDevicesError>>> + Send;
    fn list_studio_lifecycle_configs(&self, builder: ListStudioLifecycleConfigsInputBuilder) -> impl Future<Output = Result<ListStudioLifecycleConfigsOutput, SdkError<ListStudioLifecycleConfigsError>>> + Send;
    fn list_subscribed_workteams(&self, builder: ListSubscribedWorkteamsInputBuilder) -> impl Future<Output = Result<ListSubscribedWorkteamsOutput, SdkError<ListSubscribedWorkteamsError>>> + Send;
    fn list_tags(&self, builder: ListTagsInputBuilder) -> impl Future<Output = Result<ListTagsOutput, SdkError<ListTagsError>>> + Send;
    fn list_training_jobs(&self, builder: ListTrainingJobsInputBuilder) -> impl Future<Output = Result<ListTrainingJobsOutput, SdkError<ListTrainingJobsError>>> + Send;
    fn list_training_jobs_for_hyper_parameter_tuning_job(&self, builder: ListTrainingJobsForHyperParameterTuningJobInputBuilder) -> impl Future<Output = Result<ListTrainingJobsForHyperParameterTuningJobOutput, SdkError<ListTrainingJobsForHyperParameterTuningJobError>>> + Send;
    fn list_transform_jobs(&self, builder: ListTransformJobsInputBuilder) -> impl Future<Output = Result<ListTransformJobsOutput, SdkError<ListTransformJobsError>>> + Send;
    fn list_trial_components(&self, builder: ListTrialComponentsInputBuilder) -> impl Future<Output = Result<ListTrialComponentsOutput, SdkError<ListTrialComponentsError>>> + Send;
    fn list_trials(&self, builder: ListTrialsInputBuilder) -> impl Future<Output = Result<ListTrialsOutput, SdkError<ListTrialsError>>> + Send;
    fn list_user_profiles(&self, builder: ListUserProfilesInputBuilder) -> impl Future<Output = Result<ListUserProfilesOutput, SdkError<ListUserProfilesError>>> + Send;
    fn list_workforces(&self, builder: ListWorkforcesInputBuilder) -> impl Future<Output = Result<ListWorkforcesOutput, SdkError<ListWorkforcesError>>> + Send;
    fn list_workteams(&self, builder: ListWorkteamsInputBuilder) -> impl Future<Output = Result<ListWorkteamsOutput, SdkError<ListWorkteamsError>>> + Send;
    fn put_model_package_group_policy(&self, builder: PutModelPackageGroupPolicyInputBuilder) -> impl Future<Output = Result<PutModelPackageGroupPolicyOutput, SdkError<PutModelPackageGroupPolicyError>>> + Send;
    fn query_lineage(&self, builder: QueryLineageInputBuilder) -> impl Future<Output = Result<QueryLineageOutput, SdkError<QueryLineageError>>> + Send;
    fn register_devices(&self, builder: RegisterDevicesInputBuilder) -> impl Future<Output = Result<RegisterDevicesOutput, SdkError<RegisterDevicesError>>> + Send;
    fn render_ui_template(&self, builder: RenderUiTemplateInputBuilder) -> impl Future<Output = Result<RenderUiTemplateOutput, SdkError<RenderUiTemplateError>>> + Send;
    fn retry_pipeline_execution(&self, builder: RetryPipelineExecutionInputBuilder) -> impl Future<Output = Result<RetryPipelineExecutionOutput, SdkError<RetryPipelineExecutionError>>> + Send;
    fn search(&self, builder: SearchInputBuilder) -> impl Future<Output = Result<SearchOutput, SdkError<SearchError>>> + Send;
    fn send_pipeline_execution_step_failure(&self, builder: SendPipelineExecutionStepFailureInputBuilder) -> impl Future<Output = Result<SendPipelineExecutionStepFailureOutput, SdkError<SendPipelineExecutionStepFailureError>>> + Send;
    fn send_pipeline_execution_step_success(&self, builder: SendPipelineExecutionStepSuccessInputBuilder) -> impl Future<Output = Result<SendPipelineExecutionStepSuccessOutput, SdkError<SendPipelineExecutionStepSuccessError>>> + Send;
    fn start_edge_deployment_stage(&self, builder: StartEdgeDeploymentStageInputBuilder) -> impl Future<Output = Result<StartEdgeDeploymentStageOutput, SdkError<StartEdgeDeploymentStageError>>> + Send;
    fn start_inference_experiment(&self, builder: StartInferenceExperimentInputBuilder) -> impl Future<Output = Result<StartInferenceExperimentOutput, SdkError<StartInferenceExperimentError>>> + Send;
    fn start_mlflow_tracking_server(&self, builder: StartMlflowTrackingServerInputBuilder) -> impl Future<Output = Result<StartMlflowTrackingServerOutput, SdkError<StartMlflowTrackingServerError>>> + Send;
    fn start_monitoring_schedule(&self, builder: StartMonitoringScheduleInputBuilder) -> impl Future<Output = Result<StartMonitoringScheduleOutput, SdkError<StartMonitoringScheduleError>>> + Send;
    fn start_notebook_instance(&self, builder: StartNotebookInstanceInputBuilder) -> impl Future<Output = Result<StartNotebookInstanceOutput, SdkError<StartNotebookInstanceError>>> + Send;
    ...
    fn stop_auto_ml_job(&self, builder: StopAutoMlJobInputBuilder) -> impl Future<Output = Result<StopAutoMlJobOutput, SdkError<StopAutoMLJobError>>> + Send;
    fn stop_compilation_job(&self, builder: StopCompilationJobInputBuilder) -> impl Future<Output = Result<StopCompilationJobOutput, SdkError<StopCompilationJobError>>> + Send;
    fn stop_edge_deployment_stage(&self, builder: StopEdgeDeploymentStageInputBuilder) -> impl Future<Output = Result<StopEdgeDeploymentStageOutput, SdkError<StopEdgeDeploymentStageError>>> + Send;
    fn stop_edge_packaging_job(&self, builder: StopEdgePackagingJobInputBuilder) -> impl Future<Output = Result<StopEdgePackagingJobOutput, SdkError<StopEdgePackagingJobError>>> + Send;
    fn stop_hyper_parameter_tuning_job(&self, builder: StopHyperParameterTuningJobInputBuilder) -> impl Future<Output = Result<StopHyperParameterTuningJobOutput, SdkError<StopHyperParameterTuningJobError>>> + Send;
    fn stop_inference_experiment(&self, builder: StopInferenceExperimentInputBuilder) -> impl Future<Output = Result<StopInferenceExperimentOutput, SdkError<StopInferenceExperimentError>>> + Send;
    fn stop_inference_recommendations_job(&self, builder: StopInferenceRecommendationsJobInputBuilder) -> impl Future<Output = Result<StopInferenceRecommendationsJobOutput, SdkError<StopInferenceRecommendationsJobError>>> + Send;
    fn stop_labeling_job(&self, builder: StopLabelingJobInputBuilder) -> impl Future<Output = Result<StopLabelingJobOutput, SdkError<StopLabelingJobError>>> + Send;
    fn stop_mlflow_tracking_server(&self, builder: StopMlflowTrackingServerInputBuilder) -> impl Future<Output = Result<StopMlflowTrackingServerOutput, SdkError<StopMlflowTrackingServerError>>> + Send;
    fn stop_monitoring_schedule(&self, builder: StopMonitoringScheduleInputBuilder) -> impl Future<Output = Result<StopMonitoringScheduleOutput, SdkError<StopMonitoringScheduleError>>> + Send;
    fn stop_notebook_instance(&self, builder: StopNotebookInstanceInputBuilder) -> impl Future<Output = Result<StopNotebookInstanceOutput, SdkError<StopNotebookInstanceError>>> + Send;
    fn stop_optimization_job(&self, builder: StopOptimizationJobInputBuilder) -> impl Future<Output = Result<StopOptimizationJobOutput, SdkError<StopOptimizationJobError>>> + Send;
    ...
    fn stop_processing_job(&self, builder: StopProcessingJobInputBuilder) -> impl Future<Output = Result<StopProcessingJobOutput, SdkError<StopProcessingJobError>>> + Send;
    fn stop_training_job(&self, builder: StopTrainingJobInputBuilder) -> impl Future<Output = Result<StopTrainingJobOutput, SdkError<StopTrainingJobError>>> + Send;
    fn stop_transform_job(&self, builder: StopTransformJobInputBuilder) -> impl Future<Output = Result<StopTransformJobOutput, SdkError<StopTransformJobError>>> + Send;
    fn update_action(&self, builder: UpdateActionInputBuilder) -> impl Future<Output = Result<UpdateActionOutput, SdkError<UpdateActionError>>> + Send;
    fn update_app_image_config(&self, builder: UpdateAppImageConfigInputBuilder) -> impl Future<Output = Result<UpdateAppImageConfigOutput, SdkError<UpdateAppImageConfigError>>> + Send;
    fn update_artifact(&self, builder: UpdateArtifactInputBuilder) -> impl Future<Output = Result<UpdateArtifactOutput, SdkError<UpdateArtifactError>>> + Send;
    fn update_cluster(&self, builder: UpdateClusterInputBuilder) -> impl Future<Output = Result<UpdateClusterOutput, SdkError<UpdateClusterError>>> + Send;
    fn update_cluster_software(&self, builder: UpdateClusterSoftwareInputBuilder) -> impl Future<Output = Result<UpdateClusterSoftwareOutput, SdkError<UpdateClusterSoftwareError>>> + Send;
    fn update_code_repository(&self, builder: UpdateCodeRepositoryInputBuilder) -> impl Future<Output = Result<UpdateCodeRepositoryOutput, SdkError<UpdateCodeRepositoryError>>> + Send;
    fn update_context(&self, builder: UpdateContextInputBuilder) -> impl Future<Output = Result<UpdateContextOutput, SdkError<UpdateContextError>>> + Send;
    fn update_device_fleet(&self, builder: UpdateDeviceFleetInputBuilder) -> impl Future<Output = Result<UpdateDeviceFleetOutput, SdkError<UpdateDeviceFleetError>>> + Send;
    fn update_devices(&self, builder: UpdateDevicesInputBuilder) -> impl Future<Output = Result<UpdateDevicesOutput, SdkError<UpdateDevicesError>>> + Send;
    fn update_domain(&self, builder: UpdateDomainInputBuilder) -> impl Future<Output = Result<UpdateDomainOutput, SdkError<UpdateDomainError>>> + Send;
    fn update_endpoint(&self, builder: UpdateEndpointInputBuilder) -> impl Future<Output = Result<UpdateEndpointOutput, SdkError<UpdateEndpointError>>> + Send;
    fn update_endpoint_weights_and_capacities(&self, builder: UpdateEndpointWeightsAndCapacitiesInputBuilder) -> impl Future<Output = Result<UpdateEndpointWeightsAndCapacitiesOutput, SdkError<UpdateEndpointWeightsAndCapacitiesError>>> + Send;
    fn update_experiment(&self, builder: UpdateExperimentInputBuilder) -> impl Future<Output = Result<UpdateExperimentOutput, SdkError<UpdateExperimentError>>> + Send;
    fn update_feature_group(&self, builder: UpdateFeatureGroupInputBuilder) -> impl Future<Output = Result<UpdateFeatureGroupOutput, SdkError<UpdateFeatureGroupError>>> + Send;
    fn update_feature_metadata(&self, builder: UpdateFeatureMetadataInputBuilder) -> impl Future<Output = Result<UpdateFeatureMetadataOutput, SdkError<UpdateFeatureMetadataError>>> + Send;
    fn update_hub(&self, builder: UpdateHubInputBuilder) -> impl Future<Output = Result<UpdateHubOutput, SdkError<UpdateHubError>>> + Send;
    fn update_image(&self, builder: UpdateImageInputBuilder) -> impl Future<Output = Result<UpdateImageOutput, SdkError<UpdateImageError>>> + Send;
    fn update_image_version(&self, builder: UpdateImageVersionInputBuilder) -> impl Future<Output = Result<UpdateImageVersionOutput, SdkError<UpdateImageVersionError>>> + Send;
    fn update_inference_component(&self, builder: UpdateInferenceComponentInputBuilder) -> impl Future<Output = Result<UpdateInferenceComponentOutput, SdkError<UpdateInferenceComponentError>>> + Send;
    fn update_inference_component_runtime_config(&self, builder: UpdateInferenceComponentRuntimeConfigInputBuilder) -> impl Future<Output = Result<UpdateInferenceComponentRuntimeConfigOutput, SdkError<UpdateInferenceComponentRuntimeConfigError>>> + Send;
    fn update_inference_experiment(&self, builder: UpdateInferenceExperimentInputBuilder) -> impl Future<Output = Result<UpdateInferenceExperimentOutput, SdkError<UpdateInferenceExperimentError>>> + Send;
    fn update_mlflow_tracking_server(&self, builder: UpdateMlflowTrackingServerInputBuilder) -> impl Future<Output = Result<UpdateMlflowTrackingServerOutput, SdkError<UpdateMlflowTrackingServerError>>> + Send;
    fn update_model_card(&self, builder: UpdateModelCardInputBuilder) -> impl Future<Output = Result<UpdateModelCardOutput, SdkError<UpdateModelCardError>>> + Send;
    fn update_model_package(&self, builder: UpdateModelPackageInputBuilder) -> impl Future<Output = Result<UpdateModelPackageOutput, SdkError<UpdateModelPackageError>>> + Send;
    fn update_monitoring_alert(&self, builder: UpdateMonitoringAlertInputBuilder) -> impl Future<Output = Result<UpdateMonitoringAlertOutput, SdkError<UpdateMonitoringAlertError>>> + Send;
    fn update_monitoring_schedule(&self, builder: UpdateMonitoringScheduleInputBuilder) -> impl Future<Output = Result<UpdateMonitoringScheduleOutput, SdkError<UpdateMonitoringScheduleError>>> + Send;
    fn update_notebook_instance(&self, builder: UpdateNotebookInstanceInputBuilder) -> impl Future<Output = Result<UpdateNotebookInstanceOutput, SdkError<UpdateNotebookInstanceError>>> + Send;
    fn update_notebook_instance_lifecycle_config(&self, builder: UpdateNotebookInstanceLifecycleConfigInputBuilder) -> impl Future<Output = Result<UpdateNotebookInstanceLifecycleConfigOutput, SdkError<UpdateNotebookInstanceLifecycleConfigError>>> + Send;
    ...
    fn update_pipeline_execution(&self, builder: UpdatePipelineExecutionInputBuilder) -> impl Future<Output = Result<UpdatePipelineExecutionOutput, SdkError<UpdatePipelineExecutionError>>> + Send;
    fn update_project(&self, builder: UpdateProjectInputBuilder) -> impl Future<Output = Result<UpdateProjectOutput, SdkError<UpdateProjectError>>> + Send;
    fn update_space(&self, builder: UpdateSpaceInputBuilder) -> impl Future<Output = Result<UpdateSpaceOutput, SdkError<UpdateSpaceError>>> + Send;
    fn update_training_job(&self, builder: UpdateTrainingJobInputBuilder) -> impl Future<Output = Result<UpdateTrainingJobOutput, SdkError<UpdateTrainingJobError>>> + Send;
    fn update_trial(&self, builder: UpdateTrialInputBuilder) -> impl Future<Output = Result<UpdateTrialOutput, SdkError<UpdateTrialError>>> + Send;
    fn update_trial_component(&self, builder: UpdateTrialComponentInputBuilder) -> impl Future<Output = Result<UpdateTrialComponentOutput, SdkError<UpdateTrialComponentError>>> + Send;
    fn update_user_profile(&self, builder: UpdateUserProfileInputBuilder) -> impl Future<Output = Result<UpdateUserProfileOutput, SdkError<UpdateUserProfileError>>> + Send;
    fn update_workforce(&self, builder: UpdateWorkforceInputBuilder) -> impl Future<Output = Result<UpdateWorkforceOutput, SdkError<UpdateWorkforceError>>> + Send;
    fn update_workteam(&self, builder: UpdateWorkteamInputBuilder) -> impl Future<Output = Result<UpdateWorkteamOutput, SdkError<UpdateWorkteamError>>> + Send;
}
